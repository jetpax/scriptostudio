...
`,5e3,!1),addLog("Certificates installed!")}function FirmwarePanel(n,i){appState=n;const o=panelState.view;return html$1`
  ...
  `,y=w=>{if(w.iconSvg)try{const T=new DOMParser().parseFromString(w.iconSvg,"image/svg+xml").querySelector("svg");if(T){const E=T.getAttribute("viewBox")||"0 0 24 24",k=Array.from(T.querySelectorAll("path"));return html$1`
            ...
            >
              ${k.map(I=>{const N=I.getAttribute("d")||"",O=I.getAttribute("fill")||"none",D=I.getAttribute("stroke");return N==="M0 0h24v24H0z"||D==="none"?html$1`<path d="${N}" stroke="none" fill="none" />`:html$1`<path d="${N}" stroke="currentColor" fill="${O}" />`})}
            </svg>
