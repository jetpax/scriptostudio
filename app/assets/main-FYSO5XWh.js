const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/tree-sitter-B1rUHbVc.js","assets/vendor-CN-w08oq.js","assets/vendor-CeCKEaxg.js","assets/vendor-DrWus_5g.css","assets/index-BalQ1Nwo.js","assets/index-DXz9816u.js","assets/index-C67KyK7a.js","assets/index-BlIhKDWf.js","assets/index-DdUpN0Lu.js","assets/index-ByjkoLU-.js","assets/xterm-DOrYoP_4.css"])))=>i.map(i=>d[i]);
import{PANEL_TOO_SMALL as bt,PANEL_CLOSED as ie,PANEL_DEFAULT as Ge}from"./vendor-CN-w08oq.js";import{c as me,C as Ct,h as C,a as xt,b as St}from"./vendor-CeCKEaxg.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();function ce(e){const n="# === START_CONFIG_PARAMETERS ===",t="# === END_CONFIG_PARAMETERS ===",o=e.indexOf(n),i=e.indexOf(t);if(o===-1||i===-1)return console.warn("[ScriptOs Parser] Config markers not found"),null;const s=e.substring(o+n.length,i).trim();try{return Et(s)}catch(c){return console.error("[ScriptOs Parser] Failed to parse config:",c),null}}function Et(e){let n=e.trim();n.startsWith("dict(")&&n.endsWith(")")&&(n=n.substring(5,n.length-1).trim()),n=n.split(`
...
`;this.term.write(f),this.state.logs?.autoScroll!==!1&&this.term.scrollToBottom()}cleanup(){this.writeHandler&&(window.removeEventListener("log-terminal-write",this.writeHandler),this.writeHandler=null),this.clearHandler&&(window.removeEventListener("log-terminal-clear",this.clearHandler),this.clearHandler=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this.term&&(this.term.dispose(),this.term=null),this.fitAddon=null}}let we=null;function Oi(e,n){if(!e.logs.isOpen)return we=null,null;we||(we=new Ii("log-terminal",e,n));const t=we.render(e),o=e.logSidebarWidth||350;return html`
  ...
  ..
    ...
    `;return new MutationObserver(u=>{const f=d.querySelector("input");f&&f.focus()}).observe(d,{childList:!0,subtree:!0}),d}}function Ri(e,n){const t=()=>{e.panelHeight>ie?n("close-panel"):n("open-panel")};e.isPanelOpen;const o=e.panelHeight>bt?"visible":"hidden";let i="terminal-enabled";return(!e.isConnected||e.isNewFileDialogOpen)&&(i="terminal-disabled"),C`
...
print('KEY_OK')
`,5e3,!1),b("Certificates installed!")}function Lo(e,n){ge=e;const t=m.view;return C`
  ...
  `}function he(e="Connected",n="fw-status-success"){const t=m.deviceInfo;return t?C`
  ...
  `}function Bo(e,n){const t=y(te?"firmware.readyToFlash":"firmware.pyDirectDetected");return C`
    <div class="fw-view active">
      ${he(t,te?"fw-status-warning":"fw-status-success")}
  ...
  `}function zo(e,n){const t=m.deviceInfo,o=m.flashStep,i=m.flashProgress,s=m.selectedFirmware;if(o==="complete")return C`
    ...
    <div class="fw-view active">
      ...
      ${he(y("firmware.readyToFlash"),"fw-status-warning")}
...
`,c.write(u),c.write(G),c.scrollToBottom(),e.bannerDisplayed=!0,console.log("[Connection] Welcome banner displayed")}}catch(r){console.debug("[Connection] Failed to fetch banner:",r.message)}})}function fs(e,n,t,o,i,s,c){n.on("save",async()=>{if(console.log("save"),ut({isConnected:e.isConnected,openFiles:e.openFiles,editingFile:e.editingFile})==!1){console.log("can't save");return}e.isSaving=!0,I(e);let a=e.openFiles.find(g=>g.id===e.editingFile),l=!1;const d=a.parentFolder,p=d===null;p&&(a.source=="board"?a.parentFolder=e.boardNavigationPath:a.source=="disk"&&(a.parentFolder=e.diskNavigationPath));let u=!1;if(a.source=="board"?u=await ne(B,$(e.boardNavigationRoot,a.parentFolder,a.fileName)):a.source=="disk"&&(u=await o.fileExists(o.getFullPath(e.diskNavigationRoot,a.parentFolder,a.fileName))),(p||!u)&&(a.source=="board"?(a.parentFolder=e.boardNavigationPath,l=await ne(B,$(e.boardNavigationRoot,a.parentFolder,a.fileName))):a.source=="disk"&&(a.parentFolder=e.diskNavigationPath,l=await o.fileExists(o.getFullPath(e.diskNavigationRoot,a.parentFolder,a.fileName)))),l&&await M(`You are about to overwrite the file ${a.fileName} on your ${a.source}.
...
`,d+="Are you sure you want to proceed?",await M(d)!==0){e.isSaving=!1,e.renamingFile=null,I(e),n.emit("render");return}a.type=="folder"?await o.removeFolder(o.getFullPath(e.diskNavigationRoot,e.diskNavigationPath,r)):a.type=="file"&&await o.removeFile(o.getFullPath(e.diskNavigationRoot,e.diskNavigationPath,r))}try{e.renamingFile=="board"?await bn(t,$(e.boardNavigationRoot,e.boardNavigationPath,a.fileName),$(e.boardNavigationRoot,e.boardNavigationPath,r)):await o.renameFile(o.getFullPath(e.diskNavigationRoot,e.diskNavigationPath,a.fileName),o.getFullPath(e.diskNavigationRoot,e.diskNavigationPath,r));const l=e.openFiles.findIndex(d=>d.fileName===a.fileName&&d.source===a.source&&d.parentFolder===a.parentFolder);l>-1&&(e.openFiles[l].fileName=r,n.emit("render"))}catch{alert(`The file ${a.fileName} could not be renamed to ${r}`)}e.isSaving=!1,e.renamingFile=null,I(e),n.emit("refresh-files"),n.emit("render")}),n.on("rename-tab",r=>{console.log("rename-tab",r),e.renamingTab=r,n.emit("render")}),n.on("finish-renaming-tab",async r=>{console.log("finish-renaming-tab",r);const a=e.openFiles.find(g=>g.id===e.renamingTab);if(!r||a.fileName==r){e.renamingTab=null,e.isSaving=!1,I(e),n.emit("render");return}e.isSaving=!0,I(e);const l=a.parentFolder,d=a.fileName;a.fileName=r;const p=l===null;let u=!1;p||(a.source=="board"?u=await ne(B,$(e.boardNavigationRoot,a.parentFolder,d)):a.source=="disk"&&(u=await o.fileExists(o.getFullPath(e.diskNavigationRoot,a.parentFolder,d)))),(p||!u)&&(a.source=="board"?a.parentFolder=e.boardNavigationPath:a.source=="disk"&&(a.parentFolder=e.diskNavigationPath));let f=!1;if(a.source=="board"?f=await ne(B,$(e.boardNavigationRoot,a.parentFolder,a.fileName)):a.source=="disk"&&(f=await o.fileExists(o.getFullPath(e.diskNavigationRoot,a.parentFolder,a.fileName))),f&&await M(`You are about to overwrite the file ${a.fileName} on your ${a.source}.
