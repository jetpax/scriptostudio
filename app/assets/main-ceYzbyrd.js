const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/tree-sitter-BEQjyMIX.js","assets/vendor-DroDGTcs.js","assets/vendor-CeCKEaxg.js","assets/vendor-fVFpXqQT.css","assets/index-BalQ1Nwo.js","assets/index-DXz9816u.js","assets/index-C67KyK7a.js","assets/index-BlIhKDWf.js","assets/index-DdUpN0Lu.js","assets/index-ByjkoLU-.js","assets/xterm-DOrYoP_4.css"])))=>i.map(i=>d[i]);
...
`),T&&console.log(`[Debugger] Generated instrumentation for row ${O+1} (${R})`),a.set(O,P)}let b=[];for(let O=0;O<r.length;O++)a.has(O)&&b.push(a.get(O)),b.push(r[O]);const S=b.join(`
`),N=`${Rt}
...
`)).match(/CREDS:(\{.*\})/);if(n){const t=JSON.parse(n[1]);m.credentials={hostname:t.h+".local",password:t.p,ssid:t.s},x(`Found: ${t.h}.local`,"success")}else throw new Error("Could not read settings - device may need firmware");k()}catch(e){x(`Error: ${e.message}`,"error"),k()}}async function ft(){en();try{x("Connecting to REPL..."),await nn(),x("Scanning for WiFi networks..."),m.isScanning=!0,k();const n=(await j(E,`
import network
import json
...
settings.save()
print("SAVED")
`,5e3,!1),x("Credentials saved");const t=await j(E,`
import network
import time
wlan = network.WLAN(network.STA_IF)
wlan.active(True)
...
if wlan.isconnected():
    ...
    print("FAILED")
`,2e4,!1);if(t.includes("CONNECTED:")){const o=t.match(/CONNECTED:([0-9.]+)/)?.[1];x(`Connected! IP: ${o}`,"success")}else x("Connection failed","error");k()}catch(t){x(`Error: ${t.message}`,"error"),k()}}async function To(){try{x("Starting re-provisioning..."),await nn(),x("Reading device settings...");const n=(await j(E,`
from lib.sys import settings
print("HOST:" + settings.get("device.hostname", "pydirect-xxxx"))
`)).match(/HOST:(.+)/),t=n?n[1].trim():"pydirect-new";x(`Generating new certificate for ${t}.local...`),window.forge||await new Promise((c,r)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/node-forge@1.3.1/dist/forge.min.js",a.onload=c,a.onerror=r,document.head.appendChild(a)});const o=t+".local",{certPem:i,keyPem:s}=No(o);x("Installing new certificate..."),await Po(E,i,s),x("Enabling setup mode..."),await j(E,`
from lib.sys import settings
settings.set("setup_mode", True)
settings.save()
print("SETUP_MODE_SET")
`,5e3,!1),x("Restarting device..."),await j(E,`
import machine
machine.reset()
...
`,5e3,!1),x("Certificates installed!")}function Io(e,n){ge=e;const t=m.view;return w`
  ...
  `}function Do(e,n){const t=m.deviceInfo,o=m.flashStep,i=m.flashProgress,s=m.selectedFirmware;if(o==="complete")return w`
      <div class="fw-view active">
        <div class="fw-device-card">
          ...
          <button class="fw-btn fw-btn-secondary" onclick=${()=>{m.view="connect",m.flashStep="select",m.flashComplete=!1,E=null,k()}}>
  ...
  `}function Lo(e,n){const t=()=>{const i=`https://${m.reblessHostname}`;window.open(i,"_blank")},o=()=>{m.reblessComplete=!1,m.reblessHostname=null,m.view="connect",E=null,L=null,k()};return m.reblessComplete?w`
      <div class="fw-view active">
        <div class="fw-device-card">
          <div class="fw-device-card-header">
            <h3>
