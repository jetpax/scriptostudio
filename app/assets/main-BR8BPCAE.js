...
`,E=performance.now()-a;return console.log(`[Debugger] Instrumentation complete in ${E.toFixed(0)}ms`),C}console.log("[Libs] ES modules loaded");function renderIcon(n,i={}){const{className:o="",size:r=24,color:s="currentColor"}=i;return html$1`
  ...
  `}const IconSprite={renderIcon};await __vitePreload(()=>import("./vendor-BG8R_FbZ.js"),__vite__mapDeps([1,2,3]));console.log("[Views] Vendor loaded, Component available:",!!window.Component);function Button(n){const{first:i=!1,size:o="",square:r=!1,icon:s="link",onClick:a=$=>{},disabled:c=!1,active:l=!1,tooltip:d,label:u,background:p}=n;let f=html``;d&&(f=html`<div class="tooltip">${d}</div>`),f=html``;let h=l?"active":"",m=l?"selected":"",v=p?"inverted":"",y=i?"first":"",w=r?"square":"",b=c?"inactive":"active",C=o==="small"?"":html`<div class="label ${b} ${m}">${u}</div>`;const E=IconSprite.renderIcon(s,{className:""});return html`
     <div class="button ${y}">
...
`)}}n.write(TERMINAL_PROMPT)}else if(r==="	"){if(i.isConnected&&o&&typeof o.requestCompletion=="function")try{const s=await o.requestCompletion(i.currentLine);if(!s||s.length===0){n.write("\x07");return}const a=u=>u&&u.length>=2&&/^[A-Z][A-Z0-9_]*$/.test(u),c=s.filter(u=>!a(u));if(c.length===0){n.write("\x07");return}let l="",d=[];if(c.length===1)l=c[0];else{const u=i.currentLine;let p=c[0];for(let f=1;f<c.length;f++){let h=0;for(;h<p.length&&h<c[f].length&&p[h]===c[f][h];)h++;p=p.slice(0,h)}p.length>u.length&&(l=p.slice(u.length)),d=c}if(l&&(i.currentLine=i.currentLine.slice(0,i.cursorPos)+l+i.currentLine.slice(i.cursorPos),i.cursorPos+=l.length,redrawLine(n,i.currentLine,i.cursorPos,o)),d.length>0){n.write(`\r
`);const u=80;let p="";for(const f of d){const h=p.length+f.length+(p?4:0);p&&h>u?(n.write(p+`\r
...
`),i.currentLine="",i.cursorPos=0,i.historyIndex=-1,n.write(TERMINAL_PROMPT);else if(r===""||r==="\b")i.cursorPos>0&&(o.isCommandRunning&&o.isCommandRunning()?(i.currentLine=i.currentLine.slice(0,-1),i.cursorPos--,n.write("\b \b")):(i.currentLine=i.currentLine.slice(0,i.cursorPos-1)+i.currentLine.slice(i.cursorPos),i.cursorPos--,redrawLine(n,i.currentLine,i.cursorPos,o)));else if(r.length>=1){const s=r.split("").filter(a=>{const c=a.charCodeAt(0);return c>=32&&c<127}).join("");s.length>0&&(o.isCommandRunning&&o.isCommandRunning()?(i.currentLine+=s,i.cursorPos+=s.length,n.write(s)):(i.currentLine=i.currentLine.slice(0,i.cursorPos)+s+i.currentLine.slice(i.cursorPos),i.cursorPos+=s.length,redrawLine(n,i.currentLine,i.cursorPos,o)))}n.scrollToBottom()})}let TerminalClass=null,FitAddonClass=null,xtermLoaded=!1;async function loadXterm(){if(xtermLoaded)return{Terminal:TerminalClass,FitAddon:FitAddonClass};try{const[n,i]=await Promise.all([__vitePreload(()=>import("./xterm-CASmyfyk.js"),[]),__vitePreload(()=>import("./addon-fit-DOCEibfw.js"),[]),__vitePreload(()=>Promise.resolve({}),__vite__mapDeps([11]))]);return TerminalClass=n.Terminal,FitAddonClass=i.FitAddon,xtermLoaded=!0,console.debug("[XTerm] Lazy loaded xterm modules"),{Terminal:TerminalClass,FitAddon:FitAddonClass}}catch(n){throw console.error("[XTerm] Failed to load xterm:",n),n}}loadXterm();class XTerm extends Component$1{constructor(i,o,r){super(i),this.term=null,this.fitAddon=null,this.resizeObserver=null,this.inputBound=!1,this._emit=r}load(i){if(this.term){console.debug("[XTerm] Reusing existing terminal instance (no re-open needed)");const o=this.term.element?.parentElement;o&&i.appendChild(o),this.resizeObserver&&this.resizeObserver.disconnect(),this.resizeObserver=new ResizeObserver(()=>{setTimeout(()=>this.fitTerminal(),50)}),this.resizeObserver.observe(i),setTimeout(()=>this.fitTerminal(),50),setTimeout(()=>this.fitTerminal(),150);return}loadXterm().then(()=>this.ensureFontsLoaded()).then(()=>this.createAndOpenTerminal(i)).catch(o=>{console.error("[XTerm] Failed to initialize terminal:",o),i.innerHTML='<div style="color:red;padding:10px;">Terminal failed to load. Check console for errors.</div>'})}async ensureFontsLoaded(){if(document.fonts&&document.fonts.ready)try{return await document.fonts.ready,document.fonts.check&&await new Promise(i=>setTimeout(i,50)),Promise.resolve()}catch{return new Promise(o=>setTimeout(o,200))}else return new Promise(i=>setTimeout(i,200))}createAndOpenTerminal(i){this.term=new TerminalClass({fontFamily:"monospace",fontSize:12,letterSpacing:0,cursorBlink:!0,cursorStyle:"block",scrollback:1e3,theme:{foreground:"#33ff33",background:"#000000",cursor:"#FFFFFF",cursorAccent:"#000000"}}),this.term.open(i),this.fitAddon=new FitAddonClass,this.term.loadAddon(this.fitAddon),setTimeout(()=>this.fitTerminal(),50),setTimeout(()=>this.fitTerminal(),150),setTimeout(()=>this.fitTerminal(),300),setTimeout(()=>this.fitTerminal(),600);let o=null;const r=()=>{o&&clearTimeout(o),o=setTimeout(()=>this.fitTerminal(),100)};this.resizeObserver=new ResizeObserver(r),this.resizeObserver.observe(i);const s=i.closest(".repl-panel-main");s&&this.resizeObserver.observe(s)}createElement(){return html$1`<div class="terminal-wrapper"></div>`}update(){return this.fitAddon&&setTimeout(()=>this.fitTerminal(),50),!1}unload(){this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null)}fitTerminal(){if(!(!this.term||!this.fitAddon))try{this.fitAddon.fit(),this.term.refresh&&this.term.refresh(0,this.term.rows-1)}catch(i){console.warn("[XTerm] Fit failed:",i)}}resizeTerm(){this.fitTerminal()}bindInput(i,o){return this.inputBound||!this.term?!1:(console.debug("[XTerm] Binding input handler"),this.inputBound=!0,this.term.textarea&&this.term.textarea.addEventListener("focus",()=>{this._emit&&this._emit("terminal-focus")}),setupTerminalInputHandler(this.term,i,o),!0)}isInputBound(){return this.inputBound}}function CodeEditor(n,i){if(n.editingFile){const o=n.openFiles.find(r=>r.id==n.editingFile);return o?o.editor.render():(console.error("[CodeEditor] File not found for id:",n.editingFile),html$1`<div id="code-editor">File not found</div>`)}else return html$1`
    ...
    `}function ConnectionDialog(n,i){const o=n.isConnectionDialogOpen?"open":"closed",r=localStorage.getItem("webrepl-url")||"",s=localStorage.getItem("webrepl-password")||"";let a=!1;function c(f){a=f.target.closest(".dialog-content")!==null}function l(f){f.target.id=="dialog-connection"&&!a&&i("close-connection-dialog"),a=!1}function d(f){if(f.preventDefault(),f.stopPropagation(),n.isConnecting)return;const h=document.getElementById("webrepl-url").value,m=document.getElementById("webrepl-password").value;i("connect-webrepl",{wsUrl:h,password:m})}function u(f){f.stopPropagation(),f.key==="Enter"&&!n.isConnecting&&d(f)}n.isConnectionDialogOpen&&!window._connectionDialogEnterHandler?(window._connectionDialogEmit=i,window._connectionDialogEnterHandler=f=>{const h=document.getElementById("dialog-connection");if(!h||!h.classList.contains("open"))return;const m=h.querySelector(".connect-button");if(!(m&&m.disabled)&&f.key==="Enter"){const v=f.target;if(v.tagName!=="INPUT"&&v.tagName!=="TEXTAREA"){f.preventDefault(),f.stopPropagation();const y=document.getElementById("webrepl-url")?.value,w=document.getElementById("webrepl-password")?.value;y&&w&&window._connectionDialogEmit&&window._connectionDialogEmit("connect-webrepl",{wsUrl:y,password:w})}}},document.addEventListener("keydown",window._connectionDialogEnterHandler)):!n.isConnectionDialogOpen&&window._connectionDialogEnterHandler&&(document.removeEventListener("keydown",window._connectionDialogEnterHandler),window._connectionDialogEnterHandler=null,window._connectionDialogEmit=null);const p=html`
  <div id="dialog-connection" class="dialog ${o}" tabindex="-1" onmousedown=${c} onclick=${l} onkeydown=${f=>{f.key==="Enter"&&!n.isConnecting&&(f.preventDefault(),f.stopPropagation(),d(f))}} oncreate=${()=>{const f=document.getElementById("webrepl-url"),h=document.getElementById("webrepl-password");f&&r&&(f.value=r),h&&s&&(h.value=s)}}>
...
`;if(n.isNewFileDialogOpen){const h=f.querySelector("#dialog-new-file .dialog-content > input");return h&&h.focus(),f}}function ScriptOsModal(n,i){return n.isScriptOsModalOpen?html`
          ...
          <div class="scriptos-categories">
            ${p.map(w=>{const b=n.scriptOsCategoryCollapse[w]===!0;return html`
                <div class="scriptos-category ${b?"collapsed":""}">
                  ...
                  ${b?"":y==="list"?html`
                    <div class="scriptos-list">
                      ${d[w].map(C=>ScriptOsListRow(C,i))}
                    </div>
                  `:html`
                    <div class="scriptos-grid">
                      ${d[w].map(C=>ScriptOsCard(C,i,!1))}
                    </div>
                  `}
                </div>
              `})}
            ${u.length>0?html`
              <div class="scriptos-category ${n.scriptOsCategoryCollapse.Other?"collapsed":""}">
                ...
                ${n.scriptOsCategoryCollapse.Other?"":y==="list"?html`
                  <div class="scriptos-list">
                    ${u.map(w=>ScriptOsListRow(w,i))}
                  </div>
                `:html`
                  <div class="scriptos-grid">
                    ${u.map(w=>ScriptOsCard(w,i,!1))}
                  </div>
                `}
              </div>
            `:""}
  ...
  `}function ScriptOsCard(n,i,o=!1){let r,s,a,c,l;if(n.slug)r=n.displayName||n.slug,s=n.summary||"",c=n.tags?Object.keys(n.tags):[],a=n.latestVersion?.version?`v${n.latestVersion.version}`:"v1.0.0",l="";else if(n.config&&n.config.info){const d=n.config.info;r=d.name||n.filename,s=d.description||"",c=d.category?[d.category]:[],l=d.author||"",d.version?a=Array.isArray(d.version)?`v${d.version.join(".")}`:`v${d.version}`:a="v1.0.0"}else r=n.filename||"Unknown",s="",c=[],a="v1.0.0",l="";return html`
    <div 
      class="scriptos-card"
  ...
  `}function ExtensionsLibraryView(n,i){const o=n.availableExtensions||[],r=n.installedExtensions||[],s=new Set(r.map(l=>l.id)),a=o.filter(l=>!s.has(l.id)),c=(l,d)=>{for(let u=0;u<3;u++){const p=l[u]||0,f=d[u]||0;if(p>f)return!0;if(p<f)return!1}return!1};return o.length===0?html`
      <div class="scriptos-library">
        <div class="scriptos-header-sticky">
           <div class="scriptos-header">
            <h2>Extensions</h2>
...
`;this.term.write(m),this.state.logs?.autoScroll!==!1&&this.term.scrollToBottom()}cleanup(){this.writeHandler&&(window.removeEventListener("log-terminal-write",this.writeHandler),this.writeHandler=null),this.clearHandler&&(window.removeEventListener("log-terminal-clear",this.clearHandler),this.clearHandler=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this.term&&(this.term.dispose(),this.term=null),this.fitAddon=null}}let logTerminalComponent=null;function LogSidebar(n,i){if(!n.logs.isOpen)return logTerminalComponent=null,null;logTerminalComponent||(logTerminalComponent=new LogTerminalComponent("log-terminal",n,i));const o=logTerminalComponent.render(n),r=n.logSidebarWidth||350;return html`
  ...
  `}const DiskFileList=generateFileList("disk"),BoardFileList=generateFileList("board");function generateFileList(n){return function(o,r){function s(h){h.key.toLowerCase()==="enter"&&h.target.blur(),h.key.toLowerCase()==="escape"&&(h.target.value=null,h.target.blur())}const a=html`
    ...
    `;function l(h,m){const v=html`
      ...
      `,y=o.selectedFiles.find(x=>x.fileName===h.fileName&&x.source===n);function w(x){return x.preventDefault(),r("rename-file",n,h),!1}function b(){o.renamingFile||r(`navigate-${n}-folder`,h.fileName)}function C(){o.renamingFile||r("open-file",n,h)}let E=h.fileName;const $=o.selectedFiles.find(x=>x.fileName===E);o.renamingFile==n&&$&&(E=v);function S(x){if(x==null)return"";if(x===0)return"0 B";const I=1024,P=["B","KB","MB","GB"],k=Math.floor(Math.log(x)/Math.log(I));return parseFloat((x/Math.pow(I,k)).toFixed(1))+" "+P[k]}const _=h.type==="file"?S(h.size):"";return h.type==="folder"?html`
        ...
        `}const d=o[`${n}Files`].sort((h,m)=>{const v=h.fileName.toUpperCase(),y=m.fileName.toUpperCase();if(h.type==="folder"&&m.type==="file")return-1;if(h.type===m.type){if(v<y)return-1;if(v>y)return 1}return 0}),u=html`<div class="item"
    ...
    <div class="panel-section">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <span class="info-value info-mono">${"5f172aa"}</span>
        </div>
        <div class="info-item">
  ...
  `:""}function EthernetPanel(n,i){if(!n.networksInfo&&n.isConnected&&!n.isLoadingNetworks&&i("refresh-networks"),n.isConnected&&!n.ethConfigLoaded&&!n.isLoadingEthConfig&&i("load-eth-config"),n.isConnected&&!n.networkInterfacesConfig&&!n.isLoadingNetworkInterfacesConfig&&i("load-network-interfaces-config"),!n.networksInfo)return html`
    ...
    `;const o=n.networksInfo.eth,r=n.ethStatus,s=r&&r.initialized?r:o&&o.mac?o:r||o,a=n.ethConfig||{},c=o!==null,l=n.networkInterfacesConfig?.ethernet===!1,d=s&&(s.mac||s.enabled||s.enable||s.initialized),u=s&&s.ip&&s.ip!=="0.0.0.0",p=s&&s.linkup===!0,f=u;if(!c)return html`
      <div class="panel-container">
        <div class="panel-header">
          <h2>Ethernet Configuration</h2>
        </div>
    ...
    `;const h=l?"status-disabled":f?"status-active":p?"status-warning":"status-inactive",m=l?"Disabled":f?"Connected":p?"Link Up (No IP)":d?"No Link":"Not Initialized";return html`
    <div class="panel-container">
      <div class="panel-header">
        <h2>Ethernet Configuration</h2>
      </div>
  ...
  `}function VPNPanel(n,i){n.isConnected&&!n.vpnConfigLoaded&&!n.isLoadingVpnConfig&&i("load-vpn-config");const o=n.vpnConfig||{hostname:"",join_code:"",auto_connect:!1},r=n.networksInfo?.vpn,s=n.isConnected,a=n.networksInfo&&r!==void 0;!a||r.available;const c=a&&r.active;return html`
    <div class="panel-container">
      ...
      <div class="panel-section">
        ...
        <form class="config-form" onsubmit=${l=>{l.preventDefault();const d=new FormData(l.target),u=d.get("hostname")||"",p=d.get("join_code")||"",f=d.get("auto_connect")==="on";if(!u.trim()){alert("Please enter a hostname for this device");return}if(!p.trim()){alert("Please enter a Husarnet join code");return}i("vpn-connect",{hostname:u.trim(),join_code:p.trim(),auto_connect:f})}}>
          <div class="form-group">
          ...
          <div class="signal-display">
            <div class="signal-bars">
              ${[1,2,3,4,5].map(h=>html`
                <div class="signal-bar ${h<=l?"active":""}" style="--bar-color: ${u}"></div>
              `)}
            </div>
...
`)).match(/CREDS:(\{.*\})/);if(o){const r=JSON.parse(o[1]);panelState.credentials={hostname:r.h+".local",password:r.p,ssid:r.s},addLog(`Found: ${r.h}.local`,"success")}else throw new Error("Could not read settings - device may need firmware");triggerRerender()}catch(n){addLog(`Error: ${n.message}`,"error"),triggerRerender()}}async function performWifiSetup(){clearLog();try{let l=function(d){return new Promise((u,p)=>{const f=document.createElement("div");f.className="fw-modal-overlay active",f.innerHTML=`
        ...
        `,document.body.appendChild(f);const h=y=>{const w=y.target.closest(".fw-modal-network-item");if(w){const b=parseInt(w.dataset.index);v(),u(b)}},m=()=>{v(),p(new Error("Setup cancelled"))},v=()=>{f.remove()};f.querySelector(".fw-network-modal-list").addEventListener("click",h),f.querySelector(".fw-modal-cancel").addEventListener("click",m)})};addLog("Connecting to REPL...");const n=await transitionToREPL();if(!n.success){await handleBootFailure(n.error);return}addLog("Scanning for WiFi networks...");const o=(await sendREPLCommand(currentPort,`
import network
import json
...
`,5e3,!1),addLog("Resetting device...");try{const c=currentPort.writable.getWriter(),d=new TextEncoder().encode("import machine; machine.reset()"),u=new Uint8Array(d.length+1);u.set(d),u[d.length]=4,await c.write(u),c.releaseLock()}catch{}await new Promise(c=>setTimeout(c,500));try{await currentPort.close()}catch{}currentPort=null,addLog("Device is restarting and connecting to WiFi...","success");const a=`https://${i}/setup`;showSecurityWarningModal(i,a)}catch(i){addLog(`Error: ${i.message}`,"error"),triggerRerender()}}async function startRebless(){try{addLog("Starting re-provisioning...");const n=await transitionToREPL();if(!n.success){await handleBootFailure(n.error);return}addLog("Reading device settings...");const o=(await sendREPLCommand(currentPort,`
from lib.sys import settings
print("HOST:" + settings.get("device.hostname", "pybot-xxxx"))
`)).match(/HOST:(.+)/),r=o?o[1].trim():"pybot-new";addLog(`Generating new certificate for ${r}.local...`),window.forge||await new Promise((d,u)=>{const p=document.createElement("script");p.src="https://cdn.jsdelivr.net/npm/node-forge@1.3.1/dist/forge.min.js",p.onload=d,p.onerror=u,document.head.appendChild(p)});const s=r+".local",{certPem:a,keyPem:c}=generateSelfSignedCert(s);addLog("Installing new certificate..."),await uploadCertsToDevice(currentPort,a,c),addLog("Enabling setup mode..."),await sendREPLCommand(currentPort,`
from lib.sys import settings
settings.set("setup_mode", True)
settings.save()
print("SETUP_MODE_SET")
`,5e3,!1),addLog("Resetting device...");try{const d=currentPort.writable.getWriter(),p=new TextEncoder().encode("import machine; machine.reset()"),f=new Uint8Array(p.length+1);f.set(p),f[p.length]=4,await d.write(f),d.releaseLock()}catch{}await new Promise(d=>setTimeout(d,500));try{await currentPort.close()}catch{}currentPort=null,addLog("Device is restarting and connecting to WiFi...","success");const l=`https://${s}/setup`;showSecurityWarningModal(s,l)}catch(n){addLog(`Error: ${n.message}`,"error"),triggerRerender()}}async function showSecurityWarningModal(n,i){const o=await showStyledModal({icon:'<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 8v4"/><path d="M12 16h.01"/></svg>',title:"Accept Security Warning",subtitle:"Your device has new certificates",body:'<p>Your device is <strong>restarting</strong> and connecting to WiFi.</p><p>When you connect, click <strong>"Advanced"</strong> → <strong>"Proceed"</strong> to trust your device.</p>',buttons:[{id:"connect",class:"fw-styled-modal-btn-primary",icon:'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" style="margin-right:0.5rem"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>',label:`Connect to ${n}`},{id:"cancel",class:"fw-styled-modal-btn-cancel",label:"Cancel"}]});panelState.view="scenarios",panelState.reblessComplete=!1,triggerRerender(),o==="connect"&&(window.location.href=i)}function generateSelfSignedCert(n,i=10){const o=forge.pki.rsa.generateKeyPair(2048),r=forge.pki.createCertificate();r.publicKey=o.publicKey,r.serialNumber="01",r.validity.notBefore=new Date,r.validity.notAfter=new Date,r.validity.notAfter.setFullYear(r.validity.notBefore.getFullYear()+i);const s=[{name:"commonName",value:n}];return r.setSubject(s),r.setIssuer(s),r.setExtensions([{name:"subjectAltName",altNames:[{type:2,value:n}]}]),r.sign(o.privateKey,forge.md.sha256.create()),{certPem:forge.pki.certificateToPem(r),keyPem:forge.pki.privateKeyToPem(o.privateKey)}}async function uploadCertsToDevice(n,i,o){addLog("Creating /certs directory..."),await sendREPLCommand(n,`
import os
try:
    os.mkdir('/certs')
except OSError:
...
`,5e3,!1),addLog("Certificates installed!")}function FirmwarePanel(n,i){appState=n;const o=panelState.view;return html$1`
  ...
  `}function renderChangeWifiView(n,i){return panelState.setupComplete?html$1`
      <div class="fw-view active">
        <div class="fw-device-card">
          ...
          <button class="fw-btn fw-btn-primary" onclick=${()=>window.location.href=panelState.setupUrl}>
  ...
  `}function renderReProvisionView(n,i){const o=()=>{const s=`https://${panelState.reblessHostname}`;window.location.href=s},r=async()=>{await resetAndClosePort(),panelState.reblessComplete=!1,panelState.reblessHostname=null,panelState.view="connect",triggerRerender()};return panelState.reblessComplete?html$1`
      <div class="fw-view active">
        <div class="fw-device-card">
          <div class="fw-device-card-header">
            <h3>
...
Are you sure you want to proceed?`)!==0){n.creatingFolder=null,i.emit("render");return}await r.removeFolder(r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,l))}await r.createFolder(r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,l))}setTimeout(()=>{n.creatingFolder=null,i.emit("refresh-files"),i.emit("render")},200)}}),i.on("remove-files",async()=>{console.log("remove-files");let l=n.selectedFiles.filter(m=>m.source==="board").map(m=>m.fileName),d=n.selectedFiles.filter(m=>m.source==="disk").map(m=>m.fileName),u=`You are about to delete the following files:
...
`,p+="Are you sure you want to proceed?",await confirmDialog(p)!==0){n.isSaving=!1,n.renamingFile=null,updateOverlayDirectly(n),i.emit("render");return}d.type=="folder"?await r.removeFolder(r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,l)):d.type=="file"&&await r.removeFile(r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,l))}try{n.renamingFile=="board"?await renameFile(o,getFullPath(n.boardNavigationRoot,n.boardNavigationPath,d.fileName),getFullPath(n.boardNavigationRoot,n.boardNavigationPath,l)):await r.renameFile(r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,d.fileName),r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,l));const u=n.openFiles.findIndex(p=>p.fileName===d.fileName&&p.source===d.source&&p.parentFolder===d.parentFolder);u>-1&&(n.openFiles[u].fileName=l,i.emit("render"))}catch{alert(`The file ${d.fileName} could not be renamed to ${l}`)}n.isSaving=!1,n.renamingFile=null,updateOverlayDirectly(n),i.emit("refresh-files"),i.emit("render")}),i.on("rename-tab",l=>{console.log("rename-tab",l),n.renamingTab=l,i.emit("render")}),i.on("finish-renaming-tab",async l=>{console.log("finish-renaming-tab",l);const d=n.openFiles.find(v=>v.id===n.renamingTab);if(!l||d.fileName==l){n.renamingTab=null,n.isSaving=!1,updateOverlayDirectly(n),i.emit("render");return}n.isSaving=!0,updateOverlayDirectly(n);const u=d.parentFolder,p=d.fileName;d.fileName=l;const f=u===null;let h=!1;f||(d.source=="board"?h=await fileExists(BridgeDevice,getFullPath(n.boardNavigationRoot,d.parentFolder,p)):d.source=="disk"&&(h=await r.fileExists(r.getFullPath(n.diskNavigationRoot,d.parentFolder,p)))),(f||!h)&&(d.source=="board"?d.parentFolder=n.boardNavigationPath:d.source=="disk"&&(d.parentFolder=n.diskNavigationPath));let m=!1;if(d.source=="board"?m=await fileExists(BridgeDevice,getFullPath(n.boardNavigationRoot,d.parentFolder,d.fileName)):d.source=="disk"&&(m=await r.fileExists(r.getFullPath(n.diskNavigationRoot,d.parentFolder,d.fileName))),m&&await confirmDialog(`You are about to overwrite the file ${d.fileName} on your ${d.source}.

 Are you sure you want to proceed?`)!==0){n.renamingTab=null,n.isSaving=!1,d.fileName=p,i.emit("render");return}if(h){if(d.hasChanges){const v=d.editor.content||"";try{if(d.source=="board"){if(["main.py","boot.py"].includes(p)&&await confirmDialog(`⚠️ Warning: Saving '${p}' to device may cause disconnection.

This file is running on the device. Overwriting it may crash the connection.

Recommended: Save locally instead (to disk), then reconnect.

Continue saving to device?`,"Cancel","OK")!==0){n.renamingTab=null,n.isSaving=!1,d.fileName=p,updateOverlayDirectly(n),i.emit("render");return}await o.saveFile(getFullPath(n.boardNavigationRoot,d.parentFolder,p),v,{progressCallback:w=>{n.savingProgress=w,i.emit("render")}})}else d.source=="disk"&&await r.saveFileContent(r.getFullPath(n.diskNavigationRoot,d.parentFolder,p),v)}catch(y){console.log("error",y)}}try{d.source=="board"?await renameFile(o,getFullPath(n.boardNavigationRoot,d.parentFolder,p),getFullPath(n.boardNavigationRoot,d.parentFolder,d.fileName)):d.source=="disk"&&await r.renameFile(r.getFullPath(n.diskNavigationRoot,d.parentFolder,p),r.getFullPath(n.diskNavigationRoot,d.parentFolder,d.fileName))}catch(v){console.log("error",v)}}else if(!h){const v=d.editor.content||"";try{if(d.source=="board"){if(["main.py","boot.py"].includes(d.fileName)&&await confirmDialog(`⚠️ Warning: Saving '${d.fileName}' to device may cause disconnection.

This file is running on the device. Overwriting it may crash the connection.

Recommended: Save locally instead (to disk), then reconnect.

Continue saving to device?`,"Cancel","OK")!==0){n.renamingTab=null,n.isSaving=!1,d.fileName=p,updateOverlayDirectly(n),i.emit("render");return}await o.saveFile(getFullPath(n.boardNavigationRoot,d.parentFolder,d.fileName),v,{progressCallback:w=>{n.savingProgress=w,i.emit("render")}})}else d.source=="disk"&&await r.saveFileContent(r.getFullPath(n.diskNavigationRoot,d.parentFolder,d.fileName),v)}catch(y){console.log("error",y)}}d.hasChanges=!1,n.renamingTab=null,n.isSaving=!1,n.savingProgress=0,updateOverlayDirectly(n),i.emit("refresh-files"),i.emit("render")}),i.on("toggle-file-selection",(l,d,u)=>{console.log("toggle-file-selection",l,d,u);let p=d=="board"?n.boardNavigationPath:n.diskNavigationPath;if(u&&!u.ctrlKey&&!u.metaKey){n.selectedFiles=[{fileName:l.fileName,type:l.type,source:d,parentFolder:p}],i.emit("render");return}n.selectedFiles.find(h=>h.fileName===l.fileName&&h.source===d)?n.selectedFiles=n.selectedFiles.filter(h=>!(h.fileName===l.fileName&&h.source===d)):n.selectedFiles.push({fileName:l.fileName,type:l.type,source:d,parentFolder:p}),i.emit("render")}),i.on("open-selected-files",async()=>{console.log("open-selected-files");let l=[],d=[];if(!n.isLoadingFiles){n.isLoadingFiles=!0,i.emit("render");for(let u in n.selectedFiles){let p=n.selectedFiles[u];if(p.type=="folder")continue;const f=n.openFiles.find(h=>h.fileName==p.fileName&&h.source==p.source&&h.parentFolder==p.parentFolder);if(f)d.push(f);else{let h=null;if(p.source=="board"){const m=await o.loadFile(getFullPath(n.boardNavigationRoot,n.boardNavigationPath,p.fileName)),v=new Uint8Array(m),y=new TextDecoder("utf-8").decode(v);h=await s({parentFolder:n.boardNavigationPath,fileName:p.fileName,source:p.source,content:y}),h.editor.onChange=function(){h.hasChanges=!0,i.emit("render")}}else if(p.source=="disk"){const m=await r.loadFile(r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,p.fileName)),v=new Uint8Array(m),y=new TextDecoder("utf-8").decode(v);h=await s({parentFolder:n.diskNavigationPath,fileName:p.fileName,source:p.source,content:y}),h.editor.onChange=function(){h.hasChanges=!0,i.emit("render")}}l.push(h)}}d.length>0&&(n.editingFile=d[0].id),l.length>0&&(n.editingFile=l[0].id),n.openFiles=n.openFiles.concat(l),n.selectedFiles=[],n.isLoadingFiles=!1,i.emit("change-view","editor"),i.emit("render")}}),i.on("open-file",(l,d)=>{console.log("open-file",l,d),n.selectedFiles=[{fileName:d.fileName,type:d.type,source:l,parentFolder:n[`${l}NavigationPath`]}],i.emit("open-selected-files")}),i.on("upload-files",async()=>{console.log("upload-files"),n.isTransferring=!0,i.emit("render");const l=await checkOverwrite({source:"board",fileNames:n.selectedFiles.map(d=>d.fileName),parentPath:getFullPath(n.boardNavigationRoot,n.boardNavigationPath,"")});if(l.length>0){let d=`You are about to overwrite the following files/folders on your board:

`;if(l.forEach(p=>d+=`${p.fileName}
`),d+=`
`,d+="Are you sure you want to proceed?",await confirmDialog(d)!==0){n.isTransferring=!1,i.emit("render");return}}try{for(let d in n.selectedFiles){const u=n.selectedFiles[d],p=r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,u.fileName),f=getFullPath(n.boardNavigationRoot,n.boardNavigationPath,u.fileName);if(u.type=="folder")await uploadFolder(p,f,(h,m)=>{n.transferringProgress=`${m}: ${h}`,i.emit("render")}),n.transferringProgress="";else{const h=await BridgeDisk.loadFile(p),m=new Uint8Array(h);await o.saveFile(f,m,{progressCallback:v=>{n.transferringProgress=`${u.fileName}: ${v}%`,i.emit("render")}}),n.transferringProgress=""}}n.selectedFiles=[],n.isTransferring=!1,n.transferringProgress="",updateOverlayDirectly(n),i.emit("refresh-files"),i.emit("render")}catch(d){console.error("[Upload] Transfer failed:",d),n.isTransferring=!1,n.transferringProgress="",updateOverlayDirectly(n),i.emit("render");let u=d.message;u&&u.includes("Transfer already in progress")&&(u="Transfer already in progress. The device may have stale TFTP state from a previous disconnected transfer. Please wait a moment and try again, or disconnect and reconnect."),alert(`Upload failed: ${u}`)}}),i.on("download-files",async()=>{console.log("download-files"),n.isTransferring=!0,updateOverlayDirectly(n),i.emit("render");const l=await checkOverwrite({source:"disk",fileNames:n.selectedFiles.map(d=>d.fileName),parentPath:r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,"")});if(l.length>0){let d=`You are about to overwrite the following files/folders on your disk:

`;if(l.forEach(p=>d+=`${p.fileName}
`),d+=`
`,d+="Are you sure you want to proceed?",await confirmDialog(d)!==0){n.isTransferring=!1,i.emit("render");return}}try{for(let d in n.selectedFiles){const u=n.selectedFiles[d],p=getFullPath(n.boardNavigationRoot,n.boardNavigationPath,u.fileName),f=r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,u.fileName);if(u.type=="folder")await downloadFolder(p,f,h=>{n.transferringProgress=h,i.emit("render")});else{const h=await o.loadFile(p,{progressCallback:m=>{n.transferringProgress=`${u.fileName}: ${m}%`,i.emit("render")}});await BridgeDisk.saveFileContent(f,h.buffer)}}n.isTransferring=!1,n.selectedFiles=[],updateOverlayDirectly(n),i.emit("refresh-files"),i.emit("render")}catch(d){console.error("[Download] Transfer failed:",d),n.isTransferring=!1,n.transferringProgress="",updateOverlayDirectly(n),i.emit("render");let u=d.message;u&&u.includes("Transfer already in progress")&&(u="Transfer already in progress. The device may have stale TFTP state from a previous disconnected transfer. Please wait a moment and try again, or disconnect and reconnect."),alert(`Download failed: ${u}`)}}),i.on("export-files",async()=>{console.log("export-files");for(const l of n.selectedFiles)if(l.type!=="folder")try{let d;if(l.source==="board"){const v=getFullPath(n.boardNavigationRoot,n.boardNavigationPath,l.fileName),y=await o.loadFile(v);d=new Uint8Array(y)}else{const v=r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,l.fileName),y=await r.loadFile(v);d=new Uint8Array(y)}const u=l.fileName.split(".").pop().toLowerCase(),p={png:"image/png",jpg:"image/jpeg",jpeg:"image/jpeg",webp:"image/webp",gif:"image/gif",py:"text/plain",txt:"text/plain",json:"application/json",md:"text/markdown"},f=new Blob([d],{type:p[u]||"application/octet-stream"}),h=URL.createObjectURL(f),m=document.createElement("a");m.href=h,m.download=l.fileName,document.body.appendChild(m),m.click(),document.body.removeChild(m),URL.revokeObjectURL(h)}catch(d){console.error(`[Export] Failed to export ${l.fileName}:`,d),alert(`Failed to export ${l.fileName}: ${d.message}`)}}),i.on("navigate-board-folder",l=>{console.log("navigate-board-folder",l),n.boardNavigationPath=getNavigationPath(n.boardNavigationPath,l),i.emit("refresh-files"),i.emit("render")}),i.on("navigate-board-parent",()=>{console.log("navigate-board-parent"),n.boardNavigationPath=getNavigationPath(n.boardNavigationPath,".."),i.emit("refresh-files"),i.emit("render")}),i.on("navigate-disk-folder",l=>{console.log("navigate-disk-folder",l),n.diskNavigationPath=r.getNavigationPath(n.diskNavigationPath,l),i.emit("refresh-files"),i.emit("render")}),i.on("navigate-disk-parent",()=>{console.log("navigate-disk-parent"),n.diskNavigationPath=r.getNavigationPath(n.diskNavigationPath,".."),i.emit("refresh-files"),i.emit("render")})}function debuggerStore(n,i){let o=null;console.log("[Debugger Store] Registering event handlers"),i.on("debugger:open-config",()=>{console.log("[Debugger] Opening config modal"),n.debugger.configOpen=!0,i.emit("render")}),i.on("debugger:close-config",()=>{n.debugger.configOpen=!1,i.emit("render")}),i.on("debugger:toggle-file",r=>{const s=n.debugger.debugFiles.indexOf(r);s>=0?n.debugger.debugFiles.splice(s,1):n.debugger.debugFiles.push(r),i.emit("render")}),i.on("debugger:set-watches",r=>{const s=r.split(`
...
${l.message}`)}});async function a(c,l,d,u,p){const f=c.id,h=Array.isArray(c.version)?c.version.join("."):String(c.version);s(`[Extensions] Running onInstall for ${c.name}...`),showStyledModal({variant:"",icon:"packages",title:"Installing Extension",subtitle:c.name,body:`<p>Installing extension files to device...</p>
             <div style="margin-top: 16px; color: var(--text-secondary);">
               <span class="install-spinner">◐</span> Preparing...
             </div>`,buttons:[]});try{stopStatusInfoPolling();const m=(y,...w)=>y.reduce((b,C,E)=>b+C+(w[E]||""),""),v=instantiateExtension(l.content,d,u.emit.bind(u),m);if(typeof v.onInstall=="function"){updateModalBody(`<p>Writing files to device...</p>
          <div style="margin-top: 16px; color: var(--text-secondary);">
          ...
          <div style="margin-top: 16px; color: var(--text-secondary);">
            <span class="install-spinner">◐</span> Finalizing...
               ...
               </p>`,buttons:[{id:"close",class:"fw-styled-modal-btn-cancel",label:"Close"}]})}finally{d.isConnected&&p&&startStatusInfoPolling(p,d,u)}}i.on("update-extension",async({extension:c,newVersion:l})=>{s("update-extension:",c.id,`v${c.version.join(".")} → v${l.version.join(".")}`);try{delete n.loadedExtensions[c.id];const d=`extension-styles-${c.id}`,u=document.getElementById(d);u&&(u.remove(),console.log(`[Extensions] Removed old styles for ${c.id}`)),await n.extensionRegistry.uninstallExtension(c.id),await n.extensionRegistry.installExtension(l),n.installedExtensions=await n.extensionRegistry.getInstalledExtensions(),n.allCachedExtensions=[...n.installedExtensions],n.activeExtension===c.id&&i.emit("change-extension-panel",{extensionId:c.id,panelId:n.activeExtensionPanel||l.menu[0].id}),s(`[Extensions] Updated ${c.name} to v${l.version.join(".")}`),l.mipPackage&&i.emit("prompt-upload-dependencies",{extensionId:c.id,extensionName:c.name}),i.emit("render")}catch(d){console.error("[Extensions] Update failed:",d),alert(`Failed to update extension:
