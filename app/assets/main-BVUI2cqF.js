const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/tree-sitter-BAVIUkG8.js","assets/vendor-DroDGTcs.js","assets/vendor-CeCKEaxg.js","assets/vendor-fVFpXqQT.css","assets/index-BalQ1Nwo.js","assets/index-DXz9816u.js","assets/index-C67KyK7a.js","assets/index-BlIhKDWf.js","assets/index-DdUpN0Lu.js","assets/index-ByjkoLU-.js","assets/xterm-DOrYoP_4.css"])))=>i.map(i=>d[i]);
import{PANEL_TOO_SMALL as mt,PANEL_CLOSED as Y,PANEL_DEFAULT as qe}from"./vendor-DroDGTcs.js";import{c as he,C as vt,h as w,a as yt,b as bt}from"./vendor-CeCKEaxg.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();function ce(e){const n="# === START_CONFIG_PARAMETERS ===",t="# === END_CONFIG_PARAMETERS ===",o=e.indexOf(n),i=e.indexOf(t);if(o===-1||i===-1)return console.warn("[ScriptOs Parser] Config markers not found"),null;const s=e.substring(o+n.length,i).trim();try{return wt(s)}catch(c){return console.error("[ScriptOs Parser] Failed to parse config:",c),null}}function wt(e){let n=e.trim();n.startsWith("dict(")&&n.endsWith(")")&&(n=n.substring(5,n.length-1).trim()),n=n.split(`
...
`}),r+=`${e}_ds.st()
`,r}async function pn(e,n={}){const{watches:t={},conditionalBP:o={},fileName:i="main.py"}=n,s=performance.now(),c=await Mt(e);console.log(`[Debugger] Identified ${c.size} code rows in ${performance.now()-s}ms`);let r=e.split(/\r?\n/);const a=new Map,l=t[""]||[],d=t[i]||[],p=[...new Set([...l,...d])],u=o[""]||[],f=o[i]||[],g=[...new Set([...u,...f])],h=Array.from(c.keys()).sort((O,C)=>O-C);for(const O of h){const C=r[O],R=c.get(O);if(C===void 0)continue;const T=/# ●/.test(C),W=n.breakpoints&&n.breakpoints[i]?n.breakpoints[i][O+1]:null;(T||W)&&console.log(`[Debugger] Breakpoint detected at line ${O+1}: ${C}`);const z=C.match(/^(\s*)/)[1];let P=Bt(z,T,i,O+1,p,g,W);R==="function_definition"?P+=`${z}@_ds.wrap
`:R==="async_function_definition"&&(P+=`${z}@_ds.awrap
`),T&&console.log(`[Debugger] Generated instrumentation for row ${O+1} (${R})`),a.set(O,P)}let b=[];for(let O=0;O<r.length;O++)a.has(O)&&b.push(a.get(O)),b.push(r[O]);const E=b.join(`
`),N=`${Rt}

# Execute isolated code
_ds.exec("""${E.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/'/g,"\\'")}""")
`,_=performance.now()-s;return console.log(`[Debugger] Instrumentation complete in ${_.toFixed(0)}ms`),N}console.log("[Libs] ES modules loaded");const zt="/app/";function Ut(e,n={}){const{className:t="",size:o=24,color:i="currentColor"}=n;return w`
  ...
  `}const y={renderIcon:Ut};await A(()=>import("./vendor-DroDGTcs.js"),__vite__mapDeps([1,2,3]));console.log("[Views] Vendor loaded, Component available:",!!window.Component);function F(e){const{first:n=!1,size:t="",square:o=!1,icon:i="link",onClick:s=O=>{},disabled:c=!1,active:r=!1,tooltip:a,label:l,background:d}=e;let p=html``;a&&(p=html`<div class="tooltip">${a}</div>`),p=html``;let u=r?"active":"",f=r?"selected":"",g=d?"inverted":"",h=n?"first":"",b=o?"square":"",E=c?"inactive":"active",N=t==="small"?"":html`<div class="label ${E} ${f}">${l}</div>`;const _=y.renderIcon(i,{className:""});return html`
     <div class="button ${h}">
...
`),n.currentLine="",n.cursorPos=0,n.historyIndex=-1,e.write(G);else if(o===""||o==="\b")n.cursorPos>0&&(t.isCommandRunning&&t.isCommandRunning()?(n.currentLine=n.currentLine.slice(0,-1),n.cursorPos--,e.write("\b \b")):(n.currentLine=n.currentLine.slice(0,n.cursorPos-1)+n.currentLine.slice(n.cursorPos),n.cursorPos--,Q(e,n.currentLine,n.cursorPos,t)));else if(o.length>=1){const i=o.split("").filter(s=>{const c=s.charCodeAt(0);return c>=32&&c<127}).join("");i.length>0&&(t.isCommandRunning&&t.isCommandRunning()?(n.currentLine+=i,n.cursorPos+=i.length,e.write(i)):(n.currentLine=n.currentLine.slice(0,n.cursorPos)+i+n.currentLine.slice(n.cursorPos),n.cursorPos+=i.length,Q(e,n.currentLine,n.cursorPos,t)))}e.scrollToBottom()})}async function Vt(e,n=null){const t=()=>`\x1B[3m${e}\x1B[0m`;return typeof figlet<"u"&&typeof figlet=="function"?ve(e,figlet,n).catch(()=>t()):document.querySelector('script[src*="figlet"]')?typeof figlet<"u"&&typeof figlet=="function"?ve(e,figlet,n).catch(()=>t()):new Promise(i=>{let s=0;const c=setInterval(()=>{s++,typeof figlet<"u"&&typeof figlet=="function"?(clearInterval(c),ve(e,figlet,n).then(i).catch(()=>i(t()))):s>50&&(clearInterval(c),i(t()))},100)}):new Promise(i=>{const s=document.createElement("script");s.src="https://cdn.jsdelivr.net/npm/figlet@1.7.0/lib/figlet.js",s.onload=()=>{setTimeout(()=>{typeof figlet<"u"&&typeof figlet=="function"?ve(e,figlet,n).then(i).catch(()=>i(t())):i(t())},100)},s.onerror=()=>{i(t())},document.head.appendChild(s)})}function ve(e,n,t=null){return new Promise(o=>{n.defaults&&n.defaults({fontPath:"https://cdn.jsdelivr.net/npm/figlet@1.7.0/fonts"});const i=["Slant","Standard","Block","Small","Big"],s=t?[t,...i.filter(a=>a!==t)]:i;let c=0;const r=()=>{if(c>=s.length){o(`\x1B[3m${e}\x1B[0m`);return}const a=s[c++];n(e,a,(l,d)=>{l||!d||d.length<=e.length*3?r():o(d)})};r()})}let $e=null,ke=null,hn=!1;async function it(){if(hn)return{Terminal:$e,FitAddon:ke};try{const[e,n]=await Promise.all([A(()=>import("./xterm-CASmyfyk.js"),[]),A(()=>import("./addon-fit-DOCEibfw.js"),[]),A(()=>Promise.resolve({}),__vite__mapDeps([10]))]);return $e=e.Terminal,ke=n.FitAddon,hn=!0,console.debug("[XTerm] Lazy loaded xterm modules"),{Terminal:$e,FitAddon:ke}}catch(e){throw console.error("[XTerm] Failed to load xterm:",e),e}}it();class H extends yt{constructor(n,t,o){super(n),this.term=null,this.fitAddon=null,this.resizeObserver=null,this.inputBound=!1,this._emit=o}load(n){if(this.term){console.debug("[XTerm] Reusing existing terminal instance (no re-open needed)");const t=this.term.element?.parentElement;t&&n.appendChild(t),this.resizeObserver&&this.resizeObserver.disconnect(),this.resizeObserver=new ResizeObserver(()=>{setTimeout(()=>this.fitTerminal(),50)}),this.resizeObserver.observe(n),setTimeout(()=>this.fitTerminal(),50),setTimeout(()=>this.fitTerminal(),150);return}it().then(()=>this.ensureFontsLoaded()).then(()=>this.createAndOpenTerminal(n)).catch(t=>{console.error("[XTerm] Failed to initialize terminal:",t),n.innerHTML='<div style="color:red;padding:10px;">Terminal failed to load. Check console for errors.</div>'})}async ensureFontsLoaded(){if(document.fonts&&document.fonts.ready)try{return await document.fonts.ready,document.fonts.check&&await new Promise(n=>setTimeout(n,50)),Promise.resolve()}catch{return new Promise(t=>setTimeout(t,200))}else return new Promise(n=>setTimeout(n,200))}createAndOpenTerminal(n){this.term=new $e({fontFamily:"CodeFont, Cascadia Code, Menlo, Monaco, Consolas, monospace",fontSize:14,letterSpacing:0,cursorBlink:!0,cursorStyle:"block",scrollback:1e3,theme:{foreground:"#33ff33",background:"#000000",cursor:"#FFFFFF",cursorAccent:"#000000"}}),this.term.open(n),this.fitAddon=new ke,this.term.loadAddon(this.fitAddon),setTimeout(()=>this.fitTerminal(),50),setTimeout(()=>this.fitTerminal(),150),setTimeout(()=>this.fitTerminal(),300),setTimeout(()=>this.fitTerminal(),600);let t=null;const o=()=>{t&&clearTimeout(t),t=setTimeout(()=>this.fitTerminal(),100)};this.resizeObserver=new ResizeObserver(o),this.resizeObserver.observe(n);const i=n.closest(".repl-panel-main");i&&this.resizeObserver.observe(i)}createElement(){return w`<div class="terminal-wrapper"></div>`}update(){return this.fitAddon&&setTimeout(()=>this.fitTerminal(),50),!1}unload(){this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null)}fitTerminal(){if(!(!this.term||!this.fitAddon))try{this.fitAddon.fit(),this.term.refresh&&this.term.refresh(0,this.term.rows-1)}catch(n){console.warn("[XTerm] Fit failed:",n)}}resizeTerm(){this.fitTerminal()}bindInput(n,t){return this.inputBound||!this.term?!1:(console.debug("[XTerm] Binding input handler"),this.inputBound=!0,this.term.textarea&&this.term.textarea.addEventListener("focus",()=>{this._emit&&this._emit("terminal-focus")}),Gt(this.term,n,t),!0)}isInputBound(){return this.inputBound}}function Kt(e,n){if(e.editingFile){const t=e.openFiles.find(o=>o.id==e.editingFile);return t?t.editor.render():(console.error("[CodeEditor] File not found for id:",e.editingFile),w`<div id="code-editor">File not found</div>`)}else return w`
  ...
  `;if(e.isConnectionDialogOpen)return d}function Xt(e="/"){return`
import os, json
S_IFDIR = 0x4000
S_IFREG = 0x8000
...
print(json.dumps({'path': dir_path, 'entries': entries_dict}))`.trim()}function Yt(e){return`
import os
S_IFDIR = 0x4000
def S_ISDIR(m): return (m & 0xF000) == S_IFDIR
def _join(p1, p2):
...
`.trim()}async function Qt(e){const n=await e.exec("getSysInfo()");return typeof n=="string"?JSON.parse(n):n}async function Zt(e){const n=await e.exec("getNetworksInfo()");return typeof n=="string"?JSON.parse(n):n}async function ot(e,n="/"){const o=(await e.exec(Xt(n))).entries||{};return Object.entries(o).map(([i,s])=>({fileName:i,size:s,type:s===null?"folder":"file"}))}async function ei(e,n){const t=`import os, json; print(json.dumps(os.stat('${n}')))`,o=await e.exec(t);return typeof o=="string"?JSON.parse(o):o}async function mn(e,n){const t=`import os; os.remove('${n}')`;await e.exec(t)}async function vn(e,n,t){const o=`import os; os.rename('${n}', '${t}')`;await e.exec(o)}async function ni(e,n){const t=`import os; os.mkdir('${n}')`;await e.exec(t)}async function te(e,n){try{return await ei(e,n),!0}catch{return!1}}async function ti(e,n){await e.exec(Yt(n))}function st(e,n,t){let o=e||"";return n&&n!=="/"&&(o+=n),t&&(o+="/"+t),o.replace(/\/+/g,"/")}function yn(e,n){if(n===".."){const t=e.split("/").filter(o=>o);return t.pop(),"/"+t.join("/")}return e==="/"?"/"+n:e+"/"+n}const pe=()=>V,rt=()=>B,$=st;async function Ge(e){let t=await pe().ilistFiles(e);return t=t.map(o=>({fileName:o.path,type:o.type,size:o.size})),t=t.sort(at),t}async function Ve(e){let n=await ot(B,e);return n=n.sort(at),n}function at(e,n){return e.fileName.localeCompare(n.fileName)}async function bn({root:e,parentFolder:n,fileName:t}){if(e==null||n==null||t==null)return!1;const o=pe(),i=o.getFullPath(e,n,t),s=await o.fileExists(i),c=await o.folderExists(i);return s||c}async function wn({root:e,parentFolder:n,fileName:t}){return e==null||n==null||t==null?!1:te(B,$(e,n,t))}async function ae({fileNames:e=[],parentPath:n,source:t}){let o=[];return t==="board"?o=await Ve(n):o=await Ge(n),o.filter(i=>e.indexOf(i.fileName)!==-1)}function Ke(e){{const n=`New${window.appState.fileCounter}.py`;return window.appState.fileCounter++,n}}function ii(){return`${Date.now()}_${parseInt(Math.random()*1024)}`}async function oi(e,n,t){t=t||function(){};const o=rt(),i=pe();await o.createFolder(n);let s=await i.ilistAllFiles(e);for(let c in s){const r=s[c],a=r.path.substring(e.length);if(r.type==="folder")await o.createFolder($(n,a,""));else{const l=i.getFullPath(e,a,""),d=$(n,a,""),p=await V.loadFile(l),u=new Uint8Array(p);await o.saveFile(d,u,{progressCallback:f=>{t(f,a)}})}t(100,a)}}async function si(e,n,t){t=t||function(){},await pe().createFolder(n);try{const i=[];async function s(c){const r=await ot(B,c);for(const a of r){const l=c==="/"?`/${a.fileName}`:`${c}/${a.fileName}`;a.type==="folder"?(i.push({path:l,type:"folder"}),await s(l)):i.push({path:l,type:"file"})}}await s(e);for(let c in i){const r=i[c],a=r.path.substring(e.length),l=pe(),d=rt();if(r.type=="folder")await l.createFolder(l.getFullPath(n,a,""));else{const p=$(e,a,""),u=$(n,a,""),f=await d.loadFile(p,{progressCallback:g=>{t(g,a)}});await V.saveFileContent(u,f.buffer)}t(100,a)}}catch(i){throw console.error(`[Store] Error downloading folder ${e}:`,i),new Error(`Failed to download folder: ${i.message}`)}}async function Me(e){try{await ti(B,e)}catch(n){throw console.error(`[Store] Error removing folder ${e}:`,n),new Error(`Failed to remove folder: ${n.message}`)}}function lt({isConnected:e,openFiles:n,editingFile:t}){const o=n.find(i=>i.id===t);return!o||!o.hasChanges?!1:o.source==="disk"?!0:e}function _e({isConnected:e}){return e}function ri({isConnected:e,selectedFiles:n}){const t=n.filter(o=>o.source==="disk");return e&&n.length>0&&t.length===0}function ai({isConnected:e,selectedFiles:n}){const t=n.filter(o=>o.source==="board");return e&&n.length>0&&t.length===0}function li({selectedFiles:e}){return e.filter(t=>t.type=="file").length!=0}function ci(e,n){const t=e.isNewFileDialogOpen?"open":"closed";function o(u){u.target.id=="dialog-new-file"&&n("close-new-file-dialog")}function i(u){return()=>{const f=document.querySelector("#file-name"),g=f.value.trim()||f.placeholder;n("create-new-tab",u,g)}}let s="";e.isConnected&&(s=html`
...
`;if(e.isNewFileDialogOpen){const u=p.querySelector("#dialog-new-file .dialog-content > input");return u&&u.focus(),p}}function di(e,n){return e.isScriptOsModalOpen?html`
    <div class="scriptos-modal-overlay" onclick=${t=>{t.target.classList.contains("scriptos-modal-overlay")&&n("close-scriptos-modal")}}>
      <div class="scriptos-modal">
        ...
        ${e.scriptOsModalView==="library"?ui(e,n):pi(e,n)}
      </div>
    </div>
  `:html`<div></div>`}function ui(e,n){if(e.scriptOsCategoryCollapse||(e.scriptOsCategoryCollapse={}),e.isLoadingRegistry)return html`
  ...
  `}function pi(e,n){const t=e.selectedScriptOs;if(!t)return html`<div>Loading...</div>`;const o=t.config.info||{},i=t.config.args,s=i&&typeof i=="object"&&Object.keys(i).length>0;let c="v1.0.0";return o.version&&(Array.isArray(o.version)?c=`v${o.version.join(".")}`:c=`v${o.version}`),html`
  ...
  `}function fi(e,n,t){const o=Object.keys(e);return html`
  ...
  `}function gi(e,n,t,o){const i=n.type,s=t.scriptOsArgs[e],c=n.value!==void 0?n.value:null;switch(i){case"str":return html`
        <input 
          type="text" 
          id="arg-${e}"
      ...
      `;default:return html`
        ...
        />
      `}}function hi(e,n){if(!e.scriptOsUiModal||!e.scriptOsUiModal.isOpen)return html`<div></div>`;const{url:t,title:o}=e.scriptOsUiModal;return html`
    <div 
  ...
  `}function mi(e,n){return!e.isExtensionsModalOpen&&!e.installingDependencies&&!e.dependencyPrompt?html`<div></div>`:e.dependencyPrompt?vi(e,n):e.installingDependencies?yi(e):html`
  ...
  `}function vi(e,n){const{extensionId:t,extensionName:o,dependencies:i}=e.dependencyPrompt,s=i?.mipPackage||"";return html`
  ...
  `}function yi(e,n){const{extensionName:t,mipPackage:o}=e.installingDependencies;return html`
  ...
  `}function bi(e,n){const t=e.availableExtensions||[],o=e.installedExtensions||[],i=new Set(o.map(r=>r.id)),s=t.filter(r=>!i.has(r.id)),c=(r,a)=>{for(let l=0;l<3;l++){const d=r[l]||0,p=a[l]||0;if(d>p)return!0;if(d<p)return!1}return!1};return t.length===0?html`
      <div class="scriptos-library">
        <div class="scriptos-header-sticky">
           <div class="scriptos-header">
            <h2>Extensions</h2>
...
Are you sure you want to proceed?`)&&n("trigger-reset",1)}e.isResetDialogOpen&&window.addEventListener("keydown",function r(a){a.key==="Escape"&&(n("close-reset-dialog"),window.removeEventListener("keydown",r))},{once:!0});const c=html`
  ...
  `;if(e.isResetDialogOpen)return c}function Ci(e,n){if(!e.debugger||!e.debugger.configOpen)return html``;const t=e.openFiles.filter(c=>c.fileName&&c.fileName.endsWith(".py")),i=(e.debugger.watchExpressions[""]||[]).join(`
`),s=e.debugger.active;return html`
  ...
  `}function xi(e,n){if(!e.debugger||!e.debugger.breakpointModalOpen)return html`<div></div>`;const{file:t,line:o}=e.debugger.editingBreakpoint,i=e.debugger.breakpoints[t][o]||{condition:"",hitCount:"",enabled:!0},s=()=>{n("debugger:save-breakpoint",{file:t,line:o,config:i})},c=()=>{n("debugger:delete-breakpoint",{file:t,line:o})},r=()=>{n("debugger:close-breakpoint-modal")};return html`
  ...
  `}function Si(e,n,t){const o=e.activeExtension,i=e.activeExtensionPanel;if(!o||!i)return t`
    ...
    `}}function Ei(e,n){return e.aiAgent.isOpen?html`
    <div class="agent-sidebar">
      ...
      <div class="agent-sidebar-messages" id="agent-messages">
        ...
        `:e.aiAgent.messages.map(t=>$i(t,n))}
  ...
  `:html`<div></div>`}function $i(e,n){const t=new Date(e.timestamp).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return e.role==="user"?html`
...
`;this.term.write(f),this.state.logs?.autoScroll!==!1&&this.term.scrollToBottom()}cleanup(){this.writeHandler&&(window.removeEventListener("log-terminal-write",this.writeHandler),this.writeHandler=null),this.clearHandler&&(window.removeEventListener("log-terminal-clear",this.clearHandler),this.clearHandler=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this.term&&(this.term.dispose(),this.term=null),this.fitAddon=null}}let ye=null;function Ni(e,n){if(!e.logs.isOpen)return ye=null,null;ye||(ye=new Ti("log-terminal",e,n));const t=ye.render(e),o=e.logSidebarWidth||350;return html`
  ...
  `}const Ii=dt("disk"),Oi=dt("board");function dt(e){return function(t,o){function i(u){u.key.toLowerCase()==="enter"&&u.target.blur(),u.key.toLowerCase()==="escape"&&(u.target.value=null,u.target.blur())}const s=html`
    ...
    `;function r(u,f){const g=html`
        <input type="text"
          ...
          ondblclick=${T=>!1}
          />
      `,h=t.selectedFiles.find(T=>T.fileName===u.fileName&&T.source===e);function b(T){return T.preventDefault(),o("rename-file",e,u),!1}function E(){t.renamingFile||o(`navigate-${e}-folder`,u.fileName)}function N(){t.renamingFile||o("open-file",e,u)}let _=u.fileName;const O=t.selectedFiles.find(T=>T.fileName===_);t.renamingFile==e&&O&&(_=g);function C(T){if(T==null)return"";if(T===0)return"0 B";const W=1024,z=["B","KB","MB","GB"],P=Math.floor(Math.log(T)/Math.log(W));return parseFloat((T/Math.pow(W,P)).toFixed(1))+" "+z[P]}const R=u.type==="file"?C(u.size):"";return u.type==="folder"?html`
          <div
  ...
  ..
    ...
    `;return new MutationObserver(u=>{const f=d.querySelector("input");f&&f.focus()}).observe(d,{childList:!0,subtree:!0}),d}}function Fi(e,n){const t=()=>{e.panelHeight>Y?n("close-panel"):n("open-panel")};e.isPanelOpen;const o=e.panelHeight>mt?"visible":"hidden";let i="terminal-enabled";return(!e.isConnected||e.isNewFileDialogOpen)&&(i="terminal-disabled"),w`
  ...
  `}function Li(e,n){let t=html`<div id="overlay" class="closed"></div>`;if(e.diskFiles==null&&(n("load-disk-files"),t=html`<div id="overlay" class="open"><p>Loading files...</p></div>`),e.isRemoving&&(t=html`<div id="overlay" class="open"><p>Removing...</p></div>`),e.isConnecting&&(t=html`<div id="overlay" class="open"><p>Connecting...</p></div>`),e.isLoadingFiles&&(t=html`<div id="overlay" class="open"><p>Loading files...</p></div>`),e.isSaving&&(t=html`<div id="overlay" class="open"><p>Saving file... ${e.savingProgress}</p></div>`),e.isTransferring){const o=String(e.transferringProgress||""),i=o.match(/(\d+)%?$/),s=i?parseInt(i[1]):0,c=o.match(/^(.+?):/),r=c?c[1]:"file";t=html`
    ...
    `}return t}const fe="ScriptO Studio © JetPax 2026";function Mi(e){const n=(e||0)*60,t=Math.floor(n/86400),o=Math.floor(n%86400/3600),i=Math.floor(n%3600/60),s=Math.floor(n%60),c=[];return t>0&&c.push(`${t}d`),o>0&&c.push(`${o}h`),i>0&&c.push(`${i}m`),(s>0||c.length===0)&&c.push(`${s}s`),c.join(" ")}function Je(e,n){if(!e)return{connected:!1,disconnectedText:fe,ram:null,temp:null,uptime:null,rssi:null};const t=e.mem||{},o=e.temp,i=e.uptime||0,s=e.wifi_rssi,c=t.alloc||0,r=t.free||0,a=c+r,l=(c/1024).toFixed(2),d=(a/(1024*1024)).toFixed(2);let p=null;o!=null&&((n||"degC")==="degF"?p=`${(o*9/5+32).toFixed(1)}°F`:p=`${o.toFixed(1)}°C`);const u=Mi(i);let f=null;return s!=null&&(f=`${s} dBm`),{connected:!0,disconnectedText:fe,ram:`${l} KB / ${d} MB`,temp:p,uptime:u,rssi:f}}function Bi(e,n){const t=Je(e.isConnected?e.statusInfo:null,e.temperatureUnit||"degC");if(!t||!t.connected){const o=t&&t.disconnectedText||fe;return html`
  ...
  `}function zi(e,n){const t=window.html||(()=>{}),o=e.locale||"en",i=window.i18n?window.i18n.getAvailableLocales():["en","de","es","fr"],s={en:"English",de:"Deutsch",es:"Español",fr:"Français"},c=window.i18n?window.i18n.t("language"):"Language";return t`
  ...
  `}typeof window<"u"&&(window.LanguageSelector=zi);function Sn(e,n){const t=window.i18n?window.i18n.t:o=>o;return html`
  ...
  `}function Ui(e){const n={light:html`
  ...
  `}function ji(e,n){const t=window.i18n?window.i18n.t:i=>i;if(!e.systemInfo&&e.isConnected&&!e.isLoadingSystemInfo&&!e.systemInfoAttempted&&(e.systemInfoAttempted=!0,n("refresh-system-info")),!e.systemInfo)return e.isConnected?html`
      <div class="panel-container">
  ...
  `}function Hi(e,n){const t=e.os||{};return html`
    <div class="panel-section">
  ...
  `}function qi(e,n){return!e.partitions||e.partitions.length===0?"":html`
    <div class="panel-section">
      ...
      <div class="partitions-table">
        ...
        ${e.partitions.map(t=>{let o;return Array.isArray(t)?o={type:t[0],subtype:t[1],offset:t[2],size:t[3],name:t[4]||"unknown",encrypted:t[5]}:o=t,html`
            <div class="partition-row">
              ...
              <span class="partition-type">${Gi(o.type,o.subtype)}</span>
  ...
  `}function Gi(e,n){return{0:"APP",1:"DATA"}[e]||`Type ${e}`}function Vi(e){if(!e)return"📦";const n=e.toLowerCase();return n.includes("ota")?"🔄":n.includes("nvs")?"💾":n.includes("www")?"🌐":n.includes("vfs")?"📁":n.includes("data")?"💿":n.includes("factory")?"🏭":"📦"}function ut(e){return e?e<1024?e+" B":e<1024*1024?(e/1024).toFixed(1)+" KB":(e/(1024*1024)).toFixed(2)+" MB":"N/A"}function $n(e,n){if(!e.networksInfo&&e.isConnected&&!e.isLoadingNetworks&&n("refresh-networks"),!e.networksInfo)return html`
      <div class="panel-container">
        <div class="panel-header">
  ...
  `:""}function Xi(e,n){if(!e.networksInfo&&e.isConnected&&!e.isLoadingNetworks&&n("refresh-networks"),e.isConnected&&!e.ethConfigLoaded&&!e.isLoadingEthConfig&&n("load-eth-config"),!e.networksInfo)return html`
      <div class="panel-container">
        <div class="panel-header">
  ...
  `:html`
    ...
    `}function Yi(e,n){e.isConnected&&!e.vpnConfigLoaded&&!e.isLoadingVpnConfig&&n("load-vpn-config");const t=e.vpnConfig||{hostname:"",join_code:"",auto_connect:!1},o=e.networksInfo?.vpn,i=e.isConnected,s=e.networksInfo&&o!==void 0;!s||o.available;const c=s&&o.active;return html`
    <div class="panel-container">
      <div class="panel-header">
  ...
  `}function Qi(e,n){if(!e.networksInfo&&e.isConnected&&!e.isLoadingNetworks&&n("refresh-networks"),!e.networksInfo)return html`
      <div class="panel-container">
        <div class="panel-header">
  ...
  `}function eo(e,n){e.isConnected&&!e.mqttConfigLoaded&&!e.isLoadingMqttConfig&&n("load-mqtt-config");const t=e.mqttConfig||{};return html`
    <div class="panel-container">
      <div class="panel-header">
  ...
  `}function no(e,n){e.isConnected&&!e.ntpConfigLoaded&&!e.isLoadingNtpConfig&&n("load-ntp-config");const t=e.ntpConfig||{server:"pool.ntp.org",timezone:"UTC",autoDetect:!1,autoSync:!1},o=e.ntpSyncResult||null,i=r=>{if(!r)return"--:--:--";const{year:a,month:l,day:d,hour:p,minute:u,second:f}=r;return`${String(p).padStart(2,"0")}:${String(u).padStart(2,"0")}:${String(f).padStart(2,"0")}`},s=r=>{if(!r)return"";const{year:a,month:l,day:d}=r;return`${a}-${String(l).padStart(2,"0")}-${String(d).padStart(2,"0")}`},c=[{value:"UTC",offset:0,label:"UTC (Coordinated Universal Time)"},{value:"EST",offset:-5,label:"EST (Eastern Standard Time)"},{value:"CST",offset:-6,label:"CST (Central Standard Time)"},{value:"MST",offset:-7,label:"MST (Mountain Standard Time)"},{value:"PST",offset:-8,label:"PST (Pacific Standard Time)"},{value:"GMT",offset:0,label:"GMT (Greenwich Mean Time)"},{value:"CET",offset:1,label:"CET (Central European Time)"},{value:"EET",offset:2,label:"EET (Eastern European Time)"},{value:"JST",offset:9,label:"JST (Japan Standard Time)"},{value:"AEST",offset:10,label:"AEST (Australian Eastern Standard Time)"}];return html`
    <div class="panel-container">
      ...
      <div class="panel-section">
        ...
        <form class="config-form" onsubmit=${async r=>{r.preventDefault();const a=new FormData(r.target),l=a.get("server")||"pool.ntp.org",d=a.get("timezone")||"UTC",p=a.get("auto_detect")==="on",u=a.get("auto_sync")==="on",f=c.find(b=>b.value===d),g=f?f.offset:0,h={server:l,tz_offset:g,timezone:d,auto_detect:p,auto_sync:u};try{await new Promise((b,E)=>{const N=setTimeout(()=>E(new Error("Save timeout")),1e4),_=()=>{clearTimeout(N),window.appInstance.emitter.removeListener("ntp-config-saved",O),window.appInstance.emitter.removeListener("ntp-config-save-error",C)},O=()=>{_(),b()},C=R=>{_(),E(R)};window.appInstance.emitter.once("ntp-config-saved",O),window.appInstance.emitter.once("ntp-config-save-error",C),n("save-ntp-config",h)}),n("sync-ntp-time",l,g,p,u)}catch(b){console.error("[NTP] Failed to save config before sync:",b),alert(`Failed to save NTP configuration: ${b.message}`)}}}>
          <div class="form-group">
  ...
  `}function to(e,n){e.isConnected&&!e.canConfigLoaded&&!e.isLoadingCanConfig&&n("load-can-config");const t=e.canConfig||{bitrate:5e5,enabled:!0};return html`
    <div class="panel-container">
      <div class="panel-header">
  ...
  `}function kn(e,n){e.isConnected&&!e.gpsDataLoaded&&!e.isLoadingGpsData&&n("load-gps-data");const t=e.gpsData||{},o=t.latitude!==void 0&&t.longitude!==void 0,i=37.3349,s=-122.009,c=o?t.latitude:i,r=o?t.longitude:s;return html`
    <div class="panel-container">
      <div class="panel-header">
        <h2>GPS Location</h2>
      </div>
            ...
            <div class="info-grid" style="margin-top: 1rem;">
              ...
              ${t.date?html`
                <div class="info-item">
                  ...
                  <span class="info-value info-mono">${io(t.date)}</span>
                </div>
              `:""}
              ${t.time?html`
                <div class="info-item">
                  <span class="info-label">Time:</span>
                  <span class="info-value info-mono">${oo(t.time)}</span>
                </div>
              `:""}
            </div>
  ...
  `}function io(e){if(!e||e.length!==6)return e;const n=e.substring(0,2),t=e.substring(2,4),o="20"+e.substring(4,6);return`${n}/${t}/${o}`}function oo(e){if(!e)return e;const n=e.indexOf("."),t=n!==-1?e.substring(0,n):e;if(t.length!==6)return e;const o=t.substring(0,2),i=t.substring(2,4),s=t.substring(4,6);return`${o}:${i}:${s}`}function so(e,n){e.isConnected&&!e.modemStatusLoaded&&!e.isLoadingModemStatus&&n("load-modem-status");const t=e.modemStatus||{},o=t.info||{},i=t.signal||{},s=t.ppp||{},c=i.dbm,r=ro(c),a=ao(c),l=lo(c);let d="Not detected",p="status-disconnected";return t.connected&&(s.connected?(d="PPP Active",p="status-ppp"):s.connecting?(d="PPP Connecting...",p="status-connecting"):(d="Connected (AT)",p="status-connected")),html`
    <div class="panel-container">
      <div class="panel-header">
        <h2>Modem</h2>
      </div>
  ...
  `}function ro(e){return e==null||e===-999?0:e>=-70?5:e>=-80?4:e>=-90?3:e>=-100?2:e>=-110?1:0}function ao(e){return e==null||e===-999?"Unknown":e>=-70?"Excellent":e>=-80?"Good":e>=-90?"Fair":e>=-100?"Poor":"Very Poor"}function lo(e){return e==null||e===-999?"var(--text-secondary)":e>=-70||e>=-80?"#22c55e":e>=-90||e>=-100?"#f59e0b":"#ef4444"}function co(e,n){const o=e.boardConfig?.hardware?.sdcard;e.isConnected&&!e.sdcardConfigLoaded&&!e.isLoadingSdcardConfig&&n("load-sdcard-config"),o&&e.isConnected&&!e.sdcardInfo&&!e.isLoadingSdcardInfo&&n("sdcard-get-info");const i=e.sdcardConfig||{mountPoint:"/sd",autoMount:!1};return e.isConnected?o?html`
    <div class="panel-container">
      <div class="panel-header">
  ...
  `:html`
    ...
    `}function uo(e){if(!e)return"";const n=e.pins||{},t=e.power_control||{},o=e.mode||"SD";let i=1;n.d3!==void 0?i=4:n.d0!==void 0?i=1:o==="SD"&&(i=4);const s=o==="SD"?"SDMMC":o;return html`
    <div class="panel-section">
      <div class="section-header">
  ...
  `}function ze(e){if(!e||e===0)return"0 B";const n=1024,t=["B","KB","MB","GB"],o=Math.floor(Math.log(e)/Math.log(n));return Math.round(e/Math.pow(n,o)*100)/100+" "+t[o]}const po="https://api.github.com/repos/jetpax/pyDirect/releases",fo="https://corsproxy.io/?",go={"ESP32-S3":"ESP32_S3","ESP32-P4":"ESP32_P4","ESP32-S2":"ESP32_S2","ESP32-C3":"ESP32_C3","ESP32-C6":"ESP32_C6",ESP32:"ESP32"};async function ho(){try{const e=await fetch(po);if(!e.ok)throw new Error(`GitHub API error: ${e.status}`);return(await e.json()).filter(t=>!t.draft).map(t=>({id:t.id,name:t.name||t.tag_name,tag:t.tag_name,published:t.published_at,prerelease:t.prerelease,assets:t.assets.filter(o=>o.name.startsWith("pyDirect-")&&o.name.endsWith("-merged.bin")).map(o=>({name:o.name,size:o.size,downloadUrl:o.browser_download_url}))})).filter(t=>t.assets.length>0)}catch(e){throw console.error("[firmware-flasher] Failed to fetch releases:",e),e}}async function mo(){const e=await ho();return e.find(t=>!t.prerelease)||e[0]||null}function vo(e,n){let t=e.replace(/_/g," ");if(n){const o=(n/1024/1024).toFixed(1);t+=` (${o} MB)`}return t}function pt(e,n){const t=go[n];return t?e.assets.filter(i=>{const s=i.name.match(/^pyDirect-(.+)-merged\.bin$/);if(!s)return!1;const c=s[1];return!!(c.startsWith(t)||n==="ESP32-S3"&&(c==="RetroVMS_Mini"||c.includes("S3")))}).map(i=>{const s=i.name.match(/^pyDirect-(.+)-merged\.bin$/),c=s?s[1]:i.name;return{...i,productId:c,displayName:vo(c,i.size)}}):(console.warn(`[firmware-flasher] No firmware mapping for chip: ${n}`),[])}function yo(e,n,t=null){const o=pt(e,n);if(o.length===0)return null;let i=o[0];if(t&&n==="ESP32-S3"&&parseInt(t)>=16){const c=o.find(r=>r.productId==="ESP32_S3_16MB");c&&(i=c)}return i}async function bo(e,n=()=>{}){try{let t=await fetch(e);if(t.ok||(console.log("[firmware-flasher] Direct download failed, trying CORS proxy"),t=await fetch(fo+encodeURIComponent(e))),!t.ok)throw new Error(`Download failed: ${t.status}`);const o=t.headers.get("content-length"),i=o?parseInt(o,10):0;if(!t.body){const d=await t.arrayBuffer();return n(100),d}const s=t.body.getReader(),c=[];let r=0;for(;;){const{done:d,value:p}=await s.read();if(d)break;c.push(p),r+=p.length,i>0&&n(Math.round(r/i*100))}const a=new Uint8Array(r);let l=0;for(const d of c)a.set(d,l),l+=d.length;return console.log(`[firmware-flasher] Downloaded ${r} bytes`),a.buffer}catch(t){throw console.error("[firmware-flasher] Download error:",t),t}}let S=null,L=null,Te="",Ne="",ie=!0,Ue=null,ge=null,m={view:"connect",deviceInfo:null,releases:[],selectedFirmware:null,flashProgress:0,wifiNetworks:[],selectedNetwork:null,credentials:null,logs:[{message:"> Ready",type:"info",timestamp:new Date().toLocaleTimeString()}],isFlashing:!1,isScanning:!1,terminalCollapsed:!1,reblessComplete:!1,reblessHostname:null,flashStep:"select",currentRelease:null,firmwareOptions:[],flashComplete:!1};function x(e,n="info"){m.logs.push({message:`> ${e}`,type:n,timestamp:new Date().toLocaleTimeString()}),m.logs.length>100&&(m.logs=m.logs.slice(-100)),k()}function en(){m.logs=[]}function k(){document.dispatchEvent(new CustomEvent("firmware-panel-update"))}async function nn(){L&&(await L.disconnect(),L=null,await new Promise(s=>setTimeout(s,100))),await S.close(),await new Promise(s=>setTimeout(s,100)),await S.open({baudRate:115200}),await S.setSignals({dataTerminalReady:!1,requestToSend:!1}),await new Promise(s=>setTimeout(s,50)),await S.setSignals({dataTerminalReady:!1,requestToSend:!0}),await new Promise(s=>setTimeout(s,100)),await S.setSignals({dataTerminalReady:!1,requestToSend:!1});const e=S.readable.getReader(),n=new TextDecoder;let t="";const o=Date.now();let i=!1;for(;Date.now()-o<8e3;){const{value:s,done:c}=await e.read();if(c)break;if(s&&(t+=n.decode(s),t.includes("System booting..."))){i=!0,e.releaseLock();const r=S.writable.getWriter();await r.write(new Uint8Array([3,3,3])),await new Promise(a=>setTimeout(a,30)),await r.write(new Uint8Array([3,3])),r.releaseLock();break}}if(!i){e.releaseLock();const s=S.writable.getWriter();await s.write(new Uint8Array([3,3])),s.releaseLock()}await new Promise(s=>setTimeout(s,200));try{const s=S.readable.getReader(),c=setTimeout(()=>s.cancel(),500);try{for(;;){const{value:r,done:a}=await s.read();if(a)break}}catch{}clearTimeout(c),s.releaseLock()}catch(s){console.log("[DRAIN] Error:",s)}}async function j(e,n,t=15e3,o=!0){const i=e.writable.getWriter();try{const s=n.split(`
`).filter(g=>g.trim().length>0),c=Math.min(...s.map(g=>{const h=g.match(/^(\s*)/);return h?h[1].length:0})),r=s.map(g=>g.slice(c)).join(`
`);o&&(await i.write(new Uint8Array([1])),await new Promise(g=>setTimeout(g,100)));const a=new TextEncoder().encode(r),l=64;for(let g=0;g<a.length;g+=l){const h=a.slice(g,Math.min(g+l,a.length));await i.write(h),await new Promise(b=>setTimeout(b,10))}await new Promise(g=>setTimeout(g,50)),await i.write(new Uint8Array([4])),i.releaseLock();const d=e.readable.getReader();let p="";const u=new TextDecoder,f=Date.now();for(;Date.now()-f<t;){const{value:g,done:h}=await d.read();if(h||g&&(p+=u.decode(g),p.includes("OK")&&p.endsWith(">")))break}return d.releaseLock(),p}catch(s){try{i.releaseLock()}catch{}throw s}}async function wo(e){Ue||(Ue=(await A(()=>import("./tasmota-esptool.bundle-CejzY9o0.js"),[])).ESPLoader,console.log("[firmware-panel] ESPLoader module loaded"));const n={log:r=>console.log(r),debug:r=>console.debug(r),error:r=>console.error(r)},t=new Ue(e,n);await t.initialize();const o=t.chipName||"Unknown";console.log("Connected to chip:",o);const i=t.macAddr(),s=Array.isArray(i)&&i.length>=6?i.slice(0,6).map(r=>r.toString(16).padStart(2,"0")).join(":"):"Unknown";let c="Unknown";try{console.log("Running stub...");const r=await t.runStub();await r.detectFlashSize(),c=r.flashSize||"Unknown",console.log("Flash size detected:",c),L=r}catch(r){console.warn("Stub/Feature detection failed:",r),c="Detection Failed",L=t}return{chipName:o,flashSizeMB:c,macAddress:s}}async function Co(){try{L&&(await L.disconnect(),L=null),S&&(await S.close(),S=null)}catch(e){console.log("Cleanup previous connection:",e)}try{en(),x("Requesting serial port..."),S=await navigator.serial.requestPort({}),await S.open({baudRate:115200}),x("Port opened"),x("Detecting hardware...");const e=await wo(S);Te=e.chipName,Ne=e.macAddress,x(`Detected: ${Te}`),x(`MAC: ${Ne}`),m.deviceInfo={chipName:Te,mac:Ne,flashSize:e.flashSizeMB},ie=!0,m.view="scenarios",x("Device connected - select an action"),ge&&(ge.connectionMode="usb"),k()}catch(e){console.error("[firmware-panel]",e),x(`Error: ${e.message}`,"error");try{S&&await S.close()}catch{}S=null,L=null,k()}}async function xo(){try{if(L&&(await L.disconnect(),L=null),S){try{await S.setSignals({dataTerminalReady:!1,requestToSend:!1}),await new Promise(e=>setTimeout(e,50)),await S.setSignals({dataTerminalReady:!1,requestToSend:!0}),await new Promise(e=>setTimeout(e,100)),await S.setSignals({dataTerminalReady:!1,requestToSend:!1}),await new Promise(e=>setTimeout(e,100))}catch(e){console.log("[handleDisconnect] Reset signals error:",e)}await S.close(),S=null}}catch{}m.view="connect",m.deviceInfo=null,Te="",Ne="",ie=!0,ge&&(ge.connectionMode=null),en(),x("Disconnected"),k()}function we(e){x(`Selected: ${e}`),m.view=e,e==="new-device"?So():e==="forgot-credentials"?ko():e==="change-wifi"?ft():e==="re-provision"&&To(),k()}function Fe(){m.flashStep="select",m.flashComplete=!1,m.flashProgress=0,m.view="scenarios",k()}async function So(){try{x("Loading firmware options..."),m.flashStep="select",m.firmwareOptions=[],k();const e=await mo();if(!e){x("No firmware releases found","error");return}m.currentRelease=e,x(`Found release: ${e.name}`);const n=m.deviceInfo?.chipName?.includes("ESP32-S3")?"ESP32-S3":m.deviceInfo?.chipName?.includes("ESP32-P4")?"ESP32-P4":m.deviceInfo?.chipName?.includes("ESP32-C3")?"ESP32-C3":m.deviceInfo?.chipName?.includes("ESP32")?"ESP32":null;if(!n){x("Unknown chip family - cannot select firmware","error");return}const t=pt(e,n);if(t.length===0){x(`No firmware available for ${n}`,"error");return}m.firmwareOptions=t;const o=m.deviceInfo?.flashSize,i=yo(e,n,o);m.selectedFirmware=i||t[0],x(`Found ${t.length} firmware option(s)`),x(`Selected: ${m.selectedFirmware.displayName||m.selectedFirmware.name}`),k()}catch(e){x(`Error: ${e.message}`,"error"),k()}}async function Eo(){if(!L){x("Error: No device connected","error");return}if(!m.selectedFirmware){x("Error: No firmware selected","error");return}if(!confirm(`⚠️ FLASH FIRMWARE ⚠️
...
Are you sure you want to continue?`)){x("Flash cancelled by user");return}try{m.flashStep="downloading",m.flashProgress=0,k(),x(`Downloading ${m.selectedFirmware.name}...`);const n=await bo(m.selectedFirmware.downloadUrl,t=>{m.flashProgress=t,t%20===0&&x(`Download: ${t}%`),k()});x(`Downloaded ${(n.byteLength/1024/1024).toFixed(1)} MB`),m.flashStep="flashing",m.flashProgress=0,k(),x("Syncing with device...");try{await L.sync()}catch{await L.initialize()}x("Flashing firmware...");try{await L.flashData(n,(t,o)=>{const i=Math.floor(t/o*100);m.flashProgress=i,i%10===0&&x(`Progress: ${i}%`),k()},0,!0)}catch(t){if((t?.message||String(t)).includes("Timed out")&&m.flashProgress>=95)x("Flash complete (device rebooted)");else throw t}x("✓ Flash complete!","success");try{await L.disconnect()}catch{}L=null,m.flashStep="complete",m.flashComplete=!0,m.terminalCollapsed=!0,k()}catch(n){console.error("[firmware-panel] Flash error:",n),x(`Flash failed: ${n.message}`,"error"),m.flashStep="select";try{S&&await S.close()}catch{}S=null,L=null,k()}}async function $o(){x("Proceeding to WiFi setup..."),m.flashStep="select",m.flashComplete=!1,m.flashProgress=0,m.view="change-wifi";try{if(!S){x("Please reconnect device"),m.view="connect",k();return}ft()}catch(e){x(`Error: ${e.message}`,"error")}k()}async function ko(){try{x("Reading credentials from device..."),await nn();const n=(await j(S,`
import json
...
`)).match(/CREDS:(\{.*\})/);if(n){const t=JSON.parse(n[1]);m.credentials={hostname:t.h+".local",password:t.p,ssid:t.s},x(`Found: ${t.h}.local`,"success")}else throw new Error("Could not read settings - device may need firmware");k()}catch(e){x(`Error: ${e.message}`,"error"),k()}}async function ft(){en();try{x("Connecting to REPL..."),await nn(),x("Scanning for WiFi networks..."),m.isScanning=!0,k();const n=(await j(S,`
import network
import json
...
`)).match(/JSON:(\[.*\])/);if(!n)throw new Error("Failed to parse network scan - no JSON found");let t;try{t=JSON.parse(n[1])}catch(o){throw new Error("Failed to parse network JSON: "+o.message)}if(t.length===0)throw new Error("No WiFi networks found");x(`Found ${t.length} networks`),m.wifiNetworks=t,m.isScanning=!1,k()}catch(e){x(`Error: ${e.message}`,"error"),m.isScanning=!1,k()}}async function _o(e,n){try{x(`Connecting to ${e}...`),await j(S,`
from lib.sys import settings
settings.set("wifi.ssid", ${JSON.stringify(e)})
settings.set("wifi.password", ${JSON.stringify(n)})
settings.save()
print("SAVED")
`,5e3,!1),x("Credentials saved");const t=await j(S,`
import network
import time
wlan = network.WLAN(network.STA_IF)
wlan.active(True)
...
if wlan.isconnected():
    ...
    print("FAILED")
`,2e4,!1);if(t.includes("CONNECTED:")){const o=t.match(/CONNECTED:([0-9.]+)/)?.[1];x(`Connected! IP: ${o}`,"success")}else x("Connection failed","error");k()}catch(t){x(`Error: ${t.message}`,"error"),k()}}async function To(){try{x("Starting re-provisioning..."),await nn(),x("Reading device settings...");const n=(await j(S,`
from lib.sys import settings
print("HOST:" + settings.get("device.hostname", "pydirect-xxxx"))
`)).match(/HOST:(.+)/),t=n?n[1].trim():"pydirect-new";x(`Generating new certificate for ${t}.local...`),window.forge||await new Promise((c,r)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/node-forge@1.3.1/dist/forge.min.js",a.onload=c,a.onerror=r,document.head.appendChild(a)});const o=t+".local",{certPem:i,keyPem:s}=No(o);x("Installing new certificate..."),await Po(S,i,s),x("Enabling setup mode..."),await j(S,`
from lib.sys import settings
settings.set("setup_mode", True)
settings.save()
print("SETUP_MODE_SET")
`,5e3,!1),x("Restarting device..."),await j(S,`
import machine
machine.reset()
`,2e3,!1),x("✓ Re-provisioning complete!"),x(`Device ready at: https://${o}`),x('Click "Open Device Setup" to set your password.'),m.reblessComplete=!0,m.reblessHostname=o,m.terminalCollapsed=!0,k()}catch(e){x(`Error: ${e.message}`,"error"),k()}}function No(e,n=10){const t=forge.pki.rsa.generateKeyPair(2048),o=forge.pki.createCertificate();o.publicKey=t.publicKey,o.serialNumber="01",o.validity.notBefore=new Date,o.validity.notAfter=new Date,o.validity.notAfter.setFullYear(o.validity.notBefore.getFullYear()+n);const i=[{name:"commonName",value:e}];return o.setSubject(i),o.setIssuer(i),o.setExtensions([{name:"subjectAltName",altNames:[{type:2,value:e}]}]),o.sign(t.privateKey,forge.md.sha256.create()),{certPem:forge.pki.certificateToPem(o),keyPem:forge.pki.privateKeyToPem(t.privateKey)}}async function Po(e,n,t){x("Creating /certs directory..."),await j(e,`
import os
try:
    os.mkdir('/certs')
except OSError:
...
print('KEY_OK')
`,5e3,!1),x("Certificates installed!")}function Io(e,n){ge=e;const t=m.view;return w`
    <div class="firmware-panel">
      ${t==="connect"?Oo():""}
      ${t==="scenarios"?Fo():""}
      ${t==="new-device"?Do():""}
      ${t==="forgot-credentials"?Ao():""}
      ${t==="change-wifi"?Ro():""}
      ${t==="re-provision"?Lo():""}
      
      ${Mo()}
    </div>
  `}function Oo(e,n){return w`
    <div class="fw-view active">
      ...
      <button class="fw-btn fw-btn-primary" onclick=${Co}>
  ...
  `}function Fo(e,n){const t=m.deviceInfo,o=v(ie?"firmware.readyToFlash":"firmware.pyDirectDetected"),i=ie?"fw-status-warning":"fw-status-success";return w`
    <div class="fw-view active">
      ${t?w`
        <div class="fw-device-info-compact">
          ${y.renderIcon("cpu",{className:"fw-device-icon"})}
      ...
      <button class="fw-btn fw-btn-secondary" onclick=${xo}>
        ${y.renderIcon("unlink",{className:"fw-btn-icon"})}
        ${v("firmware.disconnect")}
      </button>
    </div>
  `}function Do(e,n){const t=m.deviceInfo,o=m.flashStep,i=m.flashProgress,s=m.selectedFirmware;if(o==="complete")return w`
      <div class="fw-view active">
        <div class="fw-device-card">
          ...
          <button class="fw-btn fw-btn-primary" onclick=${$o}>
            ${y.renderIcon("wifi",{className:"fw-btn-icon",size:20})}
            ${v("firmware.configureWifi")}
          </button>
          <button class="fw-btn fw-btn-secondary" onclick=${()=>{m.view="connect",m.flashStep="select",m.flashComplete=!1,S=null,k()}}>
            ${v("firmware.skipForNow")}
          </button>
        </div>
      </div>
    `;if(o==="downloading"||o==="flashing"){const c=v(o==="downloading"?"firmware.downloading":"firmware.flashing");return w`
      <div class="fw-view active">
        <div class="fw-device-card">
          <div class="fw-device-card-header">
            <h3>
    ...
    <div class="fw-view active">
      ...
      <div class="fw-device-card" style="margin-top: 1rem;">
        ...
        ${s?w`
          ${m.firmwareOptions.length>1?w`
            <div class="fw-form-group">
              <select class="fw-select" onchange=${c=>{const r=m.firmwareOptions.find(a=>a.productId===c.target.value);r&&(m.selectedFirmware=r,k())}}>
                ${m.firmwareOptions.map(c=>w`
          ...
          <button class="fw-btn fw-btn-primary" onclick=${Eo} style="margin-top: 1rem;">
  ...
  `}function Ao(e,n){const t=m.credentials;return w`
    <div class="fw-view active">
      <button class="fw-btn-back" onclick=${Fe}>
        ${v("firmware.back")}
      </button>
  ...
  `}function Ro(e,n){const t=m.wifiNetworks,o=m.selectedNetwork;return w`
    <div class="fw-view active">
      <button class="fw-btn-back" onclick=${Fe}>
        ${v("firmware.back")}
      </button>
      ...
      <div class="fw-device-card">
        <div class="fw-device-card-header">
          <h3>
            ...
            ${v("firmware.wifiNetworks")}
          </h3>
        </div>
        
        ${m.isScanning?w`
          <div class="fw-loading">
            <span>${v("firmware.scanningNetworks")}</span>
          </div>
        `:t.length>0?w`
          <div class="fw-network-list">
            ${t.map(i=>w`
              <div class="fw-network-item ${o?.ssid===i.ssid?"selected":""}"
                   onclick=${()=>{m.selectedNetwork=i,k()}}>
                <span class="fw-network-name">${i.ssid}</span>
                <span class="fw-network-signal">${i.rssi} dBm</span>
                ${i.sec?y.renderIcon("lock",{className:"fw-network-lock"}):""}
              </div>
            `)}
          </div>
          ...
          ${o?w`
            <div class="fw-wifi-form">
              <input type="password" id="wifi-password" placeholder="${v("firmware.wifiPassword")}" class="fw-input" />
              <button class="fw-btn fw-btn-primary" onclick=${()=>{const i=document.getElementById("wifi-password")?.value||"";_o(o.ssid,i)}}>
                ${v("firmware.connect")}
              </button>
            </div>
          `:""}
        `:w`
          <div class="fw-empty-state">
            <span>${v("firmware.noNetworksFound")}</span>
          </div>
        `}
      </div>
    </div>
  `}function Lo(e,n){const t=()=>{const i=`https://${m.reblessHostname}`;window.open(i,"_blank")},o=()=>{m.reblessComplete=!1,m.reblessHostname=null,m.view="connect",S=null,L=null,k()};return m.reblessComplete?w`
      <div class="fw-view active">
        <div class="fw-device-card">
          <div class="fw-device-card-header">
            <h3>
  ...
  `}function Mo(){const e=m.logs;return w`
    <div class="fw-terminal ${m.terminalCollapsed?"collapsed":""}">
      <div class="fw-terminal-header" onclick=${()=>{m.terminalCollapsed=!m.terminalCollapsed,k()}}>
        <span>${y.renderIcon("terminal",{className:"fw-terminal-icon",size:14})} ${v("firmware.statusLog")}</span>
  ...
  `}function Bo(e,n){const t=e.aiAgent.settings;return html`
    <div class="panel-container">
  ...
  `}function jo(e,n){let t="Connect to board",o=`${e.diskNavigationRoot}${e.diskNavigationPath}`;return e.isConnected&&(t=`${e.connectedPort}${e.boardNavigationPath}`),html`
    <div id="file-manager">
      <div id="board-files">
  ...
  `}function je(e){window.open(e,"_blank","noopener,noreferrer")}function Wo(e,n){e.sidebarIconRotated===void 0&&(e.sidebarIconRotated=!1);const t=e.connectionMode==="webrepl"?"#00FF7F":e.connectionMode==="usb"?"#FF9500":"var(--text-secondary)",o=w`
    ...
    <div class="system-sidebar-extension">
      ...
      ${d?w`
        <div class="system-sidebar-submenu">
          ${s.map(C=>{const R=e.activeSystemPanel===C.id;return w`
              <div 
                class="system-sidebar-subitem ${R?"active":""}"
                onclick=${()=>n("change-system-panel",C.id)}
              >
                ${y.renderIcon(C.icon,{className:"",size:16})}
                <span>${C.label}</span>
              </div>
            `})}
        </div>
  ...
  `,u=e.expandedNetworks!==!1,f=w`
    <div class="system-sidebar-extension">
      ...
      ${u?w`
        <div class="system-sidebar-submenu">
          ${c.map(C=>{const R=e.activeNetworkPanel===C.id;return w`
              <div 
                class="system-sidebar-subitem ${R?"active":""}"
  ...
  `,g=e.expandedPeripherals!==!1,h=w`
    <div class="system-sidebar-extension">
      ...
      ${g?w`
        <div class="system-sidebar-submenu">
          ${r.map(C=>{const R=e.activePeripheralsPanel===C.id;return w`
              <div 
                class="system-sidebar-subitem ${R?"active":""}"
  ...
  `,b=C=>{if(C.iconSvg)try{const z=new DOMParser().parseFromString(C.iconSvg,"image/svg+xml").querySelector("svg");if(z){const P=z.getAttribute("viewBox")||"0 0 24 24",D=Array.from(z.querySelectorAll("path"));return w`
          ...
          `}}catch(T){console.warn("[System] Failed to parse extension icon SVG:",T)}const R=C.icon||"settings";return y.renderIcon(R,{className:"",size:20})},E=(e.installedExtensions||[]).map(C=>{const R=e.expandedExtensions[C.id],T=e.activeExtension===C.id,W=C.devices===!0;let z=null;if(W&&R)if(!e.loadedExtensions[C.id])console.warn("[System] Extension not loaded:",C.id);else{const P=e.loadedExtensions[C.id];if(!P.instance)try{const D=P.data.content,oe=new Function("DeviceAPI","html","emit","state",`
              ${D}
      ...
      <div class="system-sidebar-extension">
        ...
        >
          ${b(C)}
          <span>${C.name}</span>
          ${y.renderIcon("chevron-down",{className:`expand-icon ${R?"expanded":""}`,size:16})}
        </div>
  ...
  `}function Tn(e,n,t){const o=n.systemSection===e.id,s=["editor","file-manager"].includes(e.id)?"change-view":"change-system-section";return w`
    <div
  ...
  `}function qo(e,n){const t=e.systemSection;if(t==="editor")return Uo(e,n);if(t==="file-manager")return jo(e,n);if(t==="landing")return _n(e,n);if(t?.startsWith("extension:"))return Si(e,n,w);if(t?.startsWith("network:"))switch(t.split(":")[1]){case"wifi":return $n(e,n);case"ethernet":return Xi(e,n);case"vpn":return Yi(e,n);case"btle":return Qi(e,n);case"wwan":return Zi(e,n);case"mqtt":return eo(e,n);case"ntp":return no(e,n);case"can":return to(e,n);default:return $n(e,n)}if(t?.startsWith("peripherals:"))switch(t.split(":")[1]){case"gps":return kn(e,n);case"4g-modem":return so(e,n);case"sdcard":return co(e,n);default:return kn(e,n)}if(t?.startsWith("system:"))switch(t.split(":")[1]){case"settings":return Sn(e,n);case"ai-agent":return Bo(e,n);case"firmware":return Io(e);default:return Sn(e,n)}return e.isConnected?ji(e,n):_n(e,n)}const Ce=Date.now();window.i18nReady=Promise.all([fetch(`locales/en.json?v=${Ce}`).then(e=>e.json()),fetch(`locales/de.json?v=${Ce}`).then(e=>e.json()),fetch(`locales/es.json?v=${Ce}`).then(e=>e.json()),fetch(`locales/fr.json?v=${Ce}`).then(e=>e.json())]).then(([e,n,t,o])=>{if(window.i18n){window.i18n.initTranslations(e,n,t,o);const i=localStorage.getItem("locale")||"en";window.i18n.setLocale(i),console.log("[i18n] Translations loaded, locale set to:",i),window.appInstance&&window.appInstance.emitter.emit("render")}else console.warn("[i18n] window.i18n not available yet");return!0}).catch(e=>(console.error("[i18n] Failed to load translations:",e),!1));const Oe=`# This program was created in ScriptO Studio for MicroPython
...
`);if(console.log("[Connection] banner() returned:",r),r&&r.name){const a=r.name,l=`MicroPython ${r.version} on ${r.machine}`,p=(await Vt(a,null)).split(/\r?\n/).filter(f=>f.trim().length>0);let u=`\r\x1B[K\x1B[38;05;208;1m\r
`;for(const f of p)u+="  "+f+`\r
`;u+=`\r
\x1B[1;32m`+l+`\x1B[0m\r
`,u+=`\x1B[0mType "help()" for more information.\r
`,c.write(u),c.write(G),c.scrollToBottom(),e.bannerDisplayed=!0,console.log("[Connection] Welcome banner displayed")}}catch(r){console.debug("[Connection] Failed to fetch banner:",r.message)}})}function as(e,n,t,o,i,s,c){n.on("save",async()=>{if(console.log("save"),lt({isConnected:e.isConnected,openFiles:e.openFiles,editingFile:e.editingFile})==!1){console.log("can't save");return}e.isSaving=!0,I(e);let a=e.openFiles.find(g=>g.id===e.editingFile),l=!1;const d=a.parentFolder,p=d===null;p&&(a.source=="board"?a.parentFolder=e.boardNavigationPath:a.source=="disk"&&(a.parentFolder=e.diskNavigationPath));let u=!1;if(a.source=="board"?u=await te(B,$(e.boardNavigationRoot,a.parentFolder,a.fileName)):a.source=="disk"&&(u=await o.fileExists(o.getFullPath(e.diskNavigationRoot,a.parentFolder,a.fileName))),(p||!u)&&(a.source=="board"?(a.parentFolder=e.boardNavigationPath,l=await te(B,$(e.boardNavigationRoot,a.parentFolder,a.fileName))):a.source=="disk"&&(a.parentFolder=e.diskNavigationPath,l=await o.fileExists(o.getFullPath(e.diskNavigationRoot,a.parentFolder,a.fileName)))),l&&await M(`You are about to overwrite the file ${a.fileName} on your ${a.source}.

 Are you sure you want to proceed?`)!==0){e.isSaving=!1,a.parentFolder=d,I(e),n.emit("render");return}let f=a.editor.content||"";if(a.fileName&&a.fileName.toLowerCase().endsWith(".json"))try{const g=f.trim();if(g&&(g[0]==="{"||g[0]==="[")){const h=JSON.parse(g),b=JSON.stringify(h,null,2)+`
`;b!==f&&(f=b)}}catch{}try{if(a.source=="board"){if(["main.py","boot.py"].includes(a.fileName)&&await M(`⚠️ Warning: Saving '${a.fileName}' to device may cause disconnection.
...
`,a=await t.run(r,!1);if(a&&(a.includes("error")||a.includes("Error")||a.includes("Exception")))throw new Error(`mip install failed: ${a}`);e.installingDependencies=null,e.isConnected&&t&&Pn(t,e,n),n.emit("render"),alert("Dependencies installed successfully via mip!")}catch(c){console.error("[Extensions] Dependency installation failed:",c),e.installingDependencies=null,e.isConnected&&t&&Pn(t,e,n),n.emit("render"),alert(`Failed to install dependencies:
...
${c.message}`)}})}console.log("[Stores] ES modules loaded");let We=null;async function fs(){return We||(We=(await A(()=>Promise.resolve().then(()=>Ht),void 0)).CodeMirrorEditor),We}const In=console.log,K=B,He=V,gs=new Go;async function hs(e,n){async function t(s){const{source:c,parentFolder:r,fileName:a,content:l=Oe,hasChanges:d=!1}=s,p=ii(),u=await fs(),f=e.cache(u,`editor_${p}`);return f.content=l,f.fileName=a,{id:p,source:c,parentFolder:r,fileName:a,editor:f,hasChanges:d}}async function o(s,c=null,r=null,a=null){s=="board"?e.boardNavigationPath:e.diskNavigationPath;const l=await t({fileName:c===null?Ke():c,parentFolder:r,source:s,hasChanges:!0,content:a||Oe});let d=!1;return r!=null&&(s=="board"?d=await te(B,st(e.boardNavigationRoot,l.parentFolder,l.fileName)):s=="disk"&&(d=await He.fileExists(He.getFullPath(e.diskNavigationRoot,l.parentFolder,l.fileName)))),e.openFiles.find(u=>u.parentFolder===l.parentFolder&&u.fileName===l.fileName&&u.source===l.source)||d?(await M(`File ${l.fileName} already exists on ${s}. Please choose another name.`),!1):(l.editor.onChange=function(){l.hasChanges=!0,n.emit("render")},e.openFiles.push(l),e.editingFile=l.id,!0)}await Vo(e,n,o),Xo(e,n),Yo(e,n);const i=()=>{};Qo(e,n,K),rs(e,n,K,i,Ie),as(e,n,K,He,t,o),Zo(e,n,K,H),us(e,n,o),es(e,n),document.addEventListener("connection-mode-change",s=>{const c=s.detail?.mode||"none";e.connectionMode=c,n.emit("render")}),document.addEventListener("firmware-panel-update",()=>{n.emit("render")}),n.on("navigate",s=>{n.emit("change-system-section",s)}),n.on("change-view",async s=>{s==="file-manager"&&(e.isConnected&&B&&B.isCommandRunning()&&(n.emit("stop"),await gt(250)),e.filesLoadedOnce||(In("[File Manager] Loading files for first time..."),e.filesLoadedOnce=!0),e.isConnected?n.emit("refresh-files"):n.emit("refresh-disk-files")),e.systemSection!==s&&(e.selectedFiles=[],e.systemSection=s,e.activeNetworkPanel=null,e.activePeripheralsPanel=null,e.activeSystemPanel=null,e.activeExtension=null,e.activeExtensionPanel=null,s==="editor"&&e.isConnected&&setTimeout(()=>{Ie(e);const c=e.cache(H,"terminal");c&&c.term&&(n.emit("bind-terminal-input"),n.emit("terminal-focus"))},100),n.emit("render"))}),n.on("launch-app",async(s,c)=>{window.launchApp(s,c)}),n.on("change-system-section",s=>{if(In("change-system-section",s),e.systemSection=s,s.startsWith("network:")){const c=s.split(":")[1];e.activeNetworkPanel=c,e.activeSystemPanel=null,e.activePeripheralsPanel=null,e.activeExtension=null,e.activeExtensionPanel=null}else if(s.startsWith("peripherals:")){const c=s.split(":")[1];e.activePeripheralsPanel=c,e.activeNetworkPanel=null,e.activeSystemPanel=null,e.activeExtension=null,e.activeExtensionPanel=null}else if(s.startsWith("system:")){const c=s.split(":")[1];e.activeSystemPanel=c,e.activeNetworkPanel=null,e.activePeripheralsPanel=null,e.activeExtension=null,e.activeExtensionPanel=null}else e.activeNetworkPanel=null,e.activePeripheralsPanel=null,e.activeSystemPanel=null,e.activeExtension=null,e.activeExtensionPanel=null;(s==="ai-agent"||s==="system:ai-agent")&&e.aiAgent.settings.provider==="openrouter"&&e.aiAgent.settings.apiKey&&e.aiAgent.openRouterModels.length===0&&n.emit("ai-fetch-openrouter-models"),n.emit("render")}),ts(e,n,K),is(e,n,K),ns(e,n),ds(e,n,K),ps(e,n,gs,o),typeof Nn=="function"?Nn(e,n):console.warn("[Store] Debugger store not loaded"),n.on("change-locale",s=>{e.locale=s,localStorage.setItem("locale",s),window.i18n&&window.i18n.setLocale(s),n.emit("render")}),window.i18n?(window.i18n.setLocale(e.locale),console.log("[i18n] Locale initialized to:",e.locale)):console.warn("[i18n] i18n module not available")}const ms=45,vs=65,ys=320;typeof window<"u"&&(window.PANEL_CLOSED=ms,window.PANEL_TOO_SMALL=vs,window.PANEL_DEFAULT=ys);function bs(e,n){return e.isInitializing?w`
  ...
  `}async function On(){window.i18nReady&&(await window.i18nReady,console.log("[App] Translations loaded, starting app..."));let e=bt();e.use(hs),e.route("*",bs),e.mount("#app"),window.appState=e.state,window.appInstance=e,e.emitter.on("DOMContentLoaded",()=>{e.state.diskNavigationRoot&&e.emitter.emit("refresh-files");const n=new URLSearchParams(window.location.search),t=n.get("device");if(t){const i=`wss://${t}/webrepl`;localStorage.setItem("webrepl-url",i),console.log(`[App] Device URL from query param: ${i}`),setTimeout(()=>{e.emitter.emit("open-connection-dialog");const s=window.location.pathname;window.history.replaceState({},"",s)},500)}const o=n.get("configure");o&&setTimeout(()=>{e.emitter.emit("configure-scripto",o);const i=window.location.pathname;window.history.replaceState({},"",i)},500)})}document.readyState==="complete"?On():window.addEventListener("load",On);export{A as _};
