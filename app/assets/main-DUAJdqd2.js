...
with open('/settings/board.json', 'w') as f:
    f.write('${c}')
print("BOARD_OK")
`,5e3,!1),addLog("Board config installed","success")}catch(a){addLog(`Warning: Could not install board config: ${a.message}`,"error")}addLog("Enabling setup mode..."),await sendREPLCommand(currentPort,`
from lib.sys import settings
