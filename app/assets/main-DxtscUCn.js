const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/tree-sitter-4SCwCoQM.js","assets/vendor-4K4sQ085.js","assets/vendor-YJ71nRLj.js","assets/vendor-Ck17KaKn.css","assets/index-D8uXHUWg.js","assets/index-BvC6oQL-.js","assets/index-CEIVfw6W.js","assets/index-Ckq7-Rzu.js","assets/index-BR6z4vJu.js","assets/index-Bvni1Ih1.js","assets/index-CzizjDTO.js","assets/xterm-DOrYoP_4.css"])))=>i.map(i=>d[i]);
...
`),E&&console.log(`[Debugger] Generated instrumentation for row ${C+1} (${k})`),l.set(C,$)}let y=[];for(let C=0;C<a.length;C++)l.has(C)&&y.push(l.get(C)),y.push(a[C]);const b=y.join(`
    ...
    <div class="panel-section">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <span class="info-value info-mono">${"2910415"}</span>
        </div>
        <div class="info-item">
          <span class="info-label">${e("sysinfo.studioBuildDate")}</span>
          <span class="info-value">${"2026-03-25"}</span>
        </div>
      </div>
    </div>
...
${a.message}`)}});async function r(d,a,l,c,u){const p=d.id,f=Array.isArray(d.version)?d.version.join("."):String(d.version);o(`[Extensions] Running onInstall for ${d.name}...`),showStyledModal({variant:"",icon:"packages",title:"Installing Extension",subtitle:d.name,body:`<p>Installing extension files to device...</p>
             ...
             </div>`,buttons:[]});try{stopStatusInfoPolling();const h=(v,...y)=>v.reduce((b,S,x)=>b+S+(y[x]||""),""),m=instantiateExtension(a.content,l,c.emit.bind(c),h);if(typeof m.onInstall=="function"){updateModalBody(`<p>Writing files to device...</p>
          <div style="margin-top: 16px; color: var(--text-secondary);">
