const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/tree-sitter-BsJWnVBR.js","assets/vendor-4K4sQ085.js","assets/vendor-YJ71nRLj.js","assets/vendor-Ck17KaKn.css","assets/index-D8uXHUWg.js","assets/index-BvC6oQL-.js","assets/index-CEIVfw6W.js","assets/index-Ckq7-Rzu.js","assets/index-BR6z4vJu.js","assets/index-Bvni1Ih1.js","assets/index-CzizjDTO.js","assets/xterm-DOrYoP_4.css"])))=>i.map(i=>d[i]);
...
`}),a+=`${e}_ds.st()
`,a}async function instrumentCodeForExec(e,n={}){const{watches:i={},conditionalBP:s={},fileName:o="main.py"}=n,r=performance.now(),d=await identifyCodeRows(e);console.log(`[Debugger] Identified ${d.size} code rows in ${performance.now()-r}ms`);let a=e.split(/\r?\n/);const c=new Map,l=i[""]||[],u=i[o]||[],p=[...new Set([...l,...u])],f=s[""]||[],h=s[o]||[],m=[...new Set([...f,...h])],v=Array.from(d.keys()).sort((C,w)=>C-w);for(const C of v){const w=a[C],k=d.get(C);if(w===void 0)continue;const E=/# ●/.test(w),T=n.breakpoints&&n.breakpoints[o]?n.breakpoints[o][C+1]:null;(E||T)&&console.log(`[Debugger] Breakpoint detected at line ${C+1}: ${w}`);const I=w.match(/^(\s*)/)[1];let $=generateDebugBlock(I,E,o,C+1,p,m,T);k==="function_definition"?$+=`${I}@_ds.wrap
`:k==="async_function_definition"&&($+=`${I}@_ds.awrap
`),E&&console.log(`[Debugger] Generated instrumentation for row ${C+1} (${k})`),c.set(C,$)}let y=[];for(let C=0;C<a.length;C++)c.has(C)&&y.push(c.get(C)),y.push(a[C]);const b=y.join(`
...
`,x=performance.now()-r;return console.log(`[Debugger] Instrumentation complete in ${x.toFixed(0)}ms`),S}console.log("[Libs] ES modules loaded");function renderIcon(e,n={}){const{className:i="",size:s=24,color:o="currentColor"}=n;return html$1`
  ...
  `}const IconSprite={renderIcon};await __vitePreload(()=>import("./vendor-4K4sQ085.js"),__vite__mapDeps([1,2,3]));console.log("[Views] Vendor loaded, Component available:",!!window.Component);function Button(e){const{first:n=!1,size:i="",square:s=!1,icon:o="link",onClick:r=C=>{},disabled:d=!1,active:a=!1,tooltip:c,label:l,background:u}=e;let p=html``;c&&(p=html`<div class="tooltip">${c}</div>`),p=html``;let f=a?"active":"",h=a?"selected":"",m=u?"inverted":"",v=n?"first":"",y=s?"square":"",b=d?"inactive":"active",S=i==="small"?"":html`<div class="label ${b} ${h}">${l}</div>`;const x=IconSprite.renderIcon(o,{className:""});return html`
     <div class="button ${v}">
...
`;if(e.isNewFileDialogOpen){const f=p.querySelector("#dialog-new-file .dialog-content > input");return f&&f.focus(),p}}function ScriptOsModal(e,n){return e.isScriptOsModalOpen?html`
  ...
  `:html`<div></div>`}function ScriptOsLibraryView(e,n){if(e.scriptOsCategoryCollapse||(e.scriptOsCategoryCollapse={}),e.isLoadingRegistry)return html`
    ...
    `;const i=y=>{if(y.slug){const b=[];return y.category&&b.push(y.category),y.skillType&&b.push(y.skillType==="skill"?"📦 Package":"🔧 Tool"),{name:y.displayName||y.slug,description:y.summary||"",tags:b,author:"",version:y.latestVersion?.version||"1.0.0"}}else return y.config&&y.config.info?{name:y.config.info.name||y.filename,description:y.config.info.description||"",tags:y.config.info.category?[y.config.info.category]:[],author:y.config.info.author||"",version:y.config.info.version||[1,0,0]}:{name:y.filename||"Unknown",description:"",tags:[],author:"",version:[1,0,0]}},s=new Set;e.scriptOsList.forEach(y=>{i(y).tags.forEach(S=>s.add(S))});const o=Array.from(s).sort(),r=(e.scriptOsSearchQuery||"").toLowerCase(),d=e.scriptOsFilterTags||[],a=e.scriptOsList.filter(y=>{const b=i(y),S=b.name.toLowerCase(),x=b.description.toLowerCase(),C=b.tags.join(" ").toLowerCase(),w=!r||S.includes(r)||x.includes(r)||C.includes(r),k=d.length===0||d.every(E=>b.tags.includes(E));return w&&k}),c={},l=[];a.forEach(y=>{const b=i(y),S=b.tags.length>0?b.tags[0]:null;S?(c[S]||(c[S]=[]),c[S].push(y)):l.push(y)});const u=Object.keys(c).sort(),p=y=>{e.scriptOsCategoryCollapse[y]=!e.scriptOsCategoryCollapse[y],n("render")},f=()=>{e.scriptOsFiltersCollapsed=!e.scriptOsFiltersCollapsed,n("render")},h=()=>{e.scriptOsViewMode=e.scriptOsViewMode==="cards"?"list":"cards",n("render")},m=e.scriptOsFiltersCollapsed,v=e.scriptOsViewMode||"cards";return html`
    <div class="scriptos-library">
          ...
          ${o.length>1&&!m?html`
            <div class="scriptos-tag-filters">
              <div class="scriptos-tag-filters-list">
                ${o.map(y=>{const b=d.includes(y);return html`
                    <button 
                      class="scriptos-tag-filter ${b?"active":""}" 
                      onclick=${()=>n("scriptos-toggle-tag",y)}
                      title="${b?"Remove filter":"Filter by "+y}">
                      ${y}
      ...
      <div class="scriptos-content">
        ...
        `:html`
          <div class="scriptos-categories">
            ${u.map(y=>{const b=e.scriptOsCategoryCollapse[y]===!0;return html`
  ...
  `}function ExtensionsLibraryView(e,n){const i=e.availableExtensions||[],s=e.installedExtensions||[],o=new Set(s.map(a=>a.id)),r=i.filter(a=>!o.has(a.id)),d=(a,c)=>{for(let l=0;l<3;l++){const u=a[l]||0,p=c[l]||0;if(u>p)return!0;if(u<p)return!1}return!1};return i.length===0?html`
      <div class="scriptos-library">
        <div class="scriptos-header-sticky">
           <div class="scriptos-header">
            <h2>Extensions</h2>
      ...
      <div class="scriptos-content">
        ${s.length>0?html`
          <div class="scriptos-section" style="margin-bottom: 32px">
            ...
            <div class="scriptos-grid">
              ${s.map(a=>{const c=i.find(u=>u.id===a.id),l=c&&d(c.version,a.version);return html`
                  <div class="scriptos-card installed ${l?"has-update":""}">
                    ...
                    <div class="scriptos-card-actions" style="margin-top: auto; padding-top: 12px; border-top: 1px solid var(--border-color); display: flex; gap: 8px;">
                      ${l?html`
                        <button 
                          class="scriptos-update-btn"
                          onclick=${u=>{u.stopPropagation(),n("update-extension",{extension:a,newVersion:c})}}
...
`;this.term.write(h),this.state.logs?.autoScroll!==!1&&this.term.scrollToBottom()}cleanup(){this.writeHandler&&(window.removeEventListener("log-terminal-write",this.writeHandler),this.writeHandler=null),this.clearHandler&&(window.removeEventListener("log-terminal-clear",this.clearHandler),this.clearHandler=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this.term&&(this.term.dispose(),this.term=null),this.fitAddon=null}}let logTerminalComponent=null;function LogSidebar(e,n){if(!e.logs.isOpen)return logTerminalComponent=null,null;logTerminalComponent||(logTerminalComponent=new LogTerminalComponent("log-terminal",e,n));const i=logTerminalComponent.render(e),s=e.logSidebarWidth||350;return html`
  ...
  `}const DiskFileList=generateFileList("disk"),BoardFileList=generateFileList("board");function generateFileList(e){return function(i,s){function o(f){f.key.toLowerCase()==="enter"&&f.target.blur(),f.key.toLowerCase()==="escape"&&(f.target.value=null,f.target.blur())}const r=html`
    ...
    `;function a(f,h){const m=html`
        <input type="text"
          ...
          ondblclick=${E=>!1}
          />
      `,v=i.selectedFiles.find(E=>E.fileName===f.fileName&&E.source===e);function y(E){return E.preventDefault(),s("rename-file",e,f),!1}function b(){i.renamingFile||s(`navigate-${e}-folder`,f.fileName)}function S(){i.renamingFile||s("open-file",e,f)}let x=f.fileName;const C=i.selectedFiles.find(E=>E.fileName===x);i.renamingFile==e&&C&&(x=m);function w(E){if(E==null)return"";if(E===0)return"0 B";const T=1024,I=["B","KB","MB","GB"],$=Math.floor(Math.log(E)/Math.log(T));return parseFloat((E/Math.pow(T,$)).toFixed(1))+" "+I[$]}const k=f.type==="file"?w(f.size):"";return f.type==="folder"?html`
          <div
            class="item ${v?"selected":""}"
            onclick=${E=>s("toggle-file-selection",f,e,E)}
            ondblclick=${b}
            >
            ${IconSprite.renderIcon("folder",{className:"icon"})}
    ...
    <div class="panel-section">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <span class="info-value info-mono">${"438967f"}</span>
        </div>
        <div class="info-item">
          <span class="info-label">${e("sysinfo.studioBuildDate")}</span>
          <span class="info-value">${"2026-03-23"}</span>
        </div>
      </div>
    </div>
  ...
  `:""}function EthernetPanel(e,n){if(!e.networksInfo&&e.isConnected&&!e.isLoadingNetworks&&n("refresh-networks"),e.isConnected&&!e.ethConfigLoaded&&!e.isLoadingEthConfig&&n("load-eth-config"),e.isConnected&&!e.networkInterfacesConfig&&!e.isLoadingNetworkInterfacesConfig&&n("load-network-interfaces-config"),!e.networksInfo)return html`
    ...
    `;const i=e.networksInfo.eth,s=e.ethStatus,o=s&&s.initialized?s:i&&i.mac?i:s||i,r=e.ethConfig||{},d=i!==null,a=e.networkInterfacesConfig?.ethernet===!1,c=o&&(o.mac||o.enabled||o.enable||o.initialized),l=o&&o.ip&&o.ip!=="0.0.0.0",u=o&&o.linkup===!0,p=l;if(!d)return html`
      <div class="panel-container">
        <div class="panel-header">
          <h2>Ethernet Configuration</h2>
        </div>
    ...
    `;const f=a?"status-disabled":p?"status-active":u?"status-warning":"status-inactive",h=a?"Disabled":p?"Connected":u?"Link Up (No IP)":c?"No Link":"Not Initialized";return html`
    <div class="panel-container">
      <div class="panel-header">
        <h2>Ethernet Configuration</h2>
      </div>
  ...
  `:html`
    ...
    <div class="panel-container">
      ...
      <div class="panel-section">
        ...
        <form class="config-form" onsubmit=${c=>{c.preventDefault();const l=new FormData(c.target),u={apn:l.get("apn")||"",username:l.get("username")||"",password:l.get("password")||"",auto_init_modem:l.get("auto_init_modem")==="on",mobile_data_enabled:s.mobile_data_enabled||!1};n("save-wwan-config",u)}}>
          <div class="form-group">
            <label for="wwan-apn">
              GPRS APN
              <span class="label-tooltip">
  ...
  `}function NTPPanel(e,n){e.isConnected&&!e.ntpConfigLoaded&&!e.isLoadingNtpConfig&&n("load-ntp-config");const i=e.ntpConfig||{server:"pool.ntp.org",tzOffset:0,timezone:"UTC",autoDetect:!1},s=e.ntpSyncResult||null,o=l=>{if(!l)return"--:--:--";const{year:u,month:p,day:f,hour:h,minute:m,second:v}=l;return`${String(h).padStart(2,"0")}:${String(m).padStart(2,"0")}:${String(v).padStart(2,"0")}`},r=l=>{if(!l)return"";const{year:u,month:p,day:f}=l;return`${u}-${String(p).padStart(2,"0")}-${String(f).padStart(2,"0")}`},d=[{value:"UTC",offset:0,label:"UTC (Coordinated Universal Time)"},{value:"EST",offset:-5,label:"EST (Eastern Standard Time)"},{value:"CST",offset:-6,label:"CST (Central Standard Time)"},{value:"MST",offset:-7,label:"MST (Mountain Standard Time)"},{value:"PST",offset:-8,label:"PST (Pacific Standard Time)"},{value:"GMT",offset:0,label:"GMT (Greenwich Mean Time)"},{value:"CET",offset:1,label:"CET (Central European Time)"},{value:"EET",offset:2,label:"EET (Eastern European Time)"},{value:"JST",offset:9,label:"JST (Japan Standard Time)"},{value:"AEST",offset:10,label:"AEST (Australian Eastern Standard Time)"}],a=i.timezone,c=[...d];return a&&!d.find(l=>l.value===a)&&c.unshift({value:a,offset:i.tzOffset||0,label:`${a} (Detected)`}),html`
    <div class="panel-container">
      ...
      <div class="panel-section">
        ...
        <form class="config-form" onsubmit=${async l=>{l.preventDefault();const u=new FormData(l.target),p=u.get("server")||"pool.ntp.org",f=u.get("timezone")||"UTC",h=u.get("auto_detect")==="on",m=c.find(b=>b.value===f),v=m?m.offset:0,y={server:p,tz_offset:v,timezone:f,auto_detect:h};try{await new Promise((b,S)=>{const x=setTimeout(()=>S(new Error("Save timeout")),1e4),C=()=>{clearTimeout(x),window.appInstance.emitter.removeListener("ntp-config-saved",w),window.appInstance.emitter.removeListener("ntp-config-save-error",k)},w=()=>{C(),b()},k=E=>{C(),S(E)};window.appInstance.emitter.once("ntp-config-saved",w),window.appInstance.emitter.once("ntp-config-save-error",k),n("save-ntp-config",y)}),n("sync-ntp-time",p,v,h)}catch(b){console.error("[NTP] Failed to save config before sync:",b),alert(`Failed to save NTP configuration: ${b.message}`)}}}>
          <div class="form-group">
...
`,5e3,!1),addLog("Resetting device...");try{const a=currentPort.writable.getWriter(),l=new TextEncoder().encode("import machine; machine.reset()"),u=new Uint8Array(l.length+1);u.set(l),u[l.length]=4,await a.write(u),a.releaseLock()}catch{}await new Promise(a=>setTimeout(a,500));try{await currentPort.close()}catch{}currentPort=null,addLog("Device is restarting and connecting to WiFi...","success");let d=`https://${n}/setup`;o&&(d+=`?ext=${encodeURIComponent(o)}`),showSecurityWarningModal(n,d)}catch(n){addLog(`Error: ${n.message}`,"error"),triggerRerender()}}async function startRebless(){try{addLog("Starting re-provisioning...");const e=await transitionToREPL();if(!e.success){addLog("Boot detection failed — attempting recovery...","warning"),addLog("Sending interrupt to reach REPL...");try{const c=currentPort.writable.getWriter();for(let l=0;l<3;l++)await c.write(new Uint8Array([3,3,3])),await new Promise(u=>setTimeout(u,500));c.releaseLock(),await new Promise(l=>setTimeout(l,1e3))}catch{addLog("Could not send interrupt — device may need re-flash","error"),await handleBootFailure(e.error);return}}addLog("Reading device settings...");const i=(await sendREPLCommand(currentPort,`
from lib.sys import settings
print("HOST:" + settings.get("device.hostname", "pybot-xxxx"))
`)).match(/HOST:(.+)/),s=i?i[1].trim():"pybot-new";addLog(`Generating new certificate for ${s}.local...`),window.forge||await new Promise((c,l)=>{const u=document.createElement("script");u.src="https://cdn.jsdelivr.net/npm/node-forge@1.3.1/dist/forge.min.js",u.onload=c,u.onerror=l,document.head.appendChild(u)});const o=s+".local",{certPem:r,keyPem:d}=generateSelfSignedCert(o);addLog("Installing new certificate..."),await uploadCertsToDevice(currentPort,r,d);try{const l=(await sendREPLCommand(currentPort,`
import json
try:
...
`)){const r=o.match(/^(\w+)\s*:\s*(.+)$/);r&&(n.meta[r[1].trim()]=r[2].trim())}n.body=e.slice(i[0].length)}return n.body=n.body.replace(/^ScriptO for\s+\[.*?\]\(.*?\)\.?\s*Run on device\s*\(MicroPython\)\.?\s*\n?/im,""),n.body=n.body.trim(),n}function SkillSidebar(e,n){if(!e.isSkillSidebarOpen||!e.skillSidebarContent)return html`<div></div>`;const{name:i,skillMd:s}=e.skillSidebarContent,{meta:o,body:r}=parseSkillMd(s);let d="";try{r&&(d=g.parse(r,{breaks:!0}))}catch(p){console.error("[SkillSidebar] Failed to parse markdown:",p),d=`<pre>${r}</pre>`}const a=[];o.description&&a.push(`<p class="skill-meta-description">${o.description}</p>`);const c=[];o.category&&c.push(`<span class="skill-meta-tag">${o.category}</span>`),o.author&&c.push(`<span class="skill-meta-tag">by ${o.author}</span>`),c.length&&a.push(`<div class="skill-meta-tags">${c.join("")}</div>`);const l=a.length?`<div class="skill-meta-block">${a.join("")}</div>`:"",u=document.createElement("div");return u.className="skill-sidebar-content skill-md-content",u.innerHTML=l+d,html`
    ...
    <div class="system-sidebar-extension">
      ...
      ${u?html$1`
        <div class="system-sidebar-submenu">
          ${r.map(w=>{const k=e.activeSystemPanel===w.id;return html$1`
              <div 
                class="system-sidebar-subitem ${k?"active":""}"
                onclick=${()=>n("change-system-panel",w.id)}
              >
  ...
  `,f=e.expandedNetworks!==!1,h=html$1`
    <div class="system-sidebar-extension">
      ...
      ${f?html$1`
        <div class="system-sidebar-submenu">
          ${d.map(w=>{const k=e.activeNetworkPanel===w.id;return html$1`
              <div 
                class="system-sidebar-subitem ${k?"active":""}"
                onclick=${()=>n("change-network-panel",w.id)}
              >
                ${IconSprite.renderIcon(w.icon,{className:"",size:16})}
                <span>${w.label}</span>
              </div>
  ...
  `,m=e.expandedPeripherals!==!1,v=html$1`
    <div class="system-sidebar-extension">
      ...
      ${m?html$1`
        <div class="system-sidebar-submenu">
          ${a.map(w=>{const k=e.activePeripheralsPanel===w.id;return html$1`
              <div 
                class="system-sidebar-subitem ${k?"active":""}"
                onclick=${()=>n("change-peripherals-panel",w.id)}
              >
                ${IconSprite.renderIcon(w.icon,{className:"",size:16})}
                <span>${w.label}</span>
              </div>
  ...
  `,y=w=>{const k=w.icon||"settings";return IconSprite.renderIcon(k,{className:"",size:20})},b=(e.installedExtensions||[]).map(w=>{const k=e.expandedExtensions[w.id],E=e.activeExtension===w.id,T=w.devices===!0;let I=null;if(T&&k)if(!e.loadedExtensions[w.id])console.warn("[System] Extension not loaded:",w.id);else{const $=e.loadedExtensions[w.id];if(!$.instance)try{const _=$.data.content,N=new Function("DeviceAPI","html","emit","state",`
              ${_}
      ...
      <div class="system-sidebar-extension">
        <div 
          ...
          onclick=${()=>n("toggle-extension-menu",w.id)}
        >
          ${y(w)}
          <span>${w.name}</span>
        ...
        ${k?html$1`
          <div class="system-sidebar-submenu">
            ${w.menu.map($=>{const _=e.activeExtension===w.id&&e.activeExtensionPanel===$.id,P=$.disabled===!0;return html$1`
                <div 
                  class="system-sidebar-subitem ${_?"active":""} ${P?"disabled":""}"
                  onclick=${P?null:()=>n("change-extension-panel",{extensionId:w.id,panelId:$.id})}
...
${a.message}`)}});async function r(d,a,c,l,u){const p=d.id,f=Array.isArray(d.version)?d.version.join("."):String(d.version);o(`[Extensions] Running onInstall for ${d.name}...`),showStyledModal({variant:"",icon:"packages",title:"Installing Extension",subtitle:d.name,body:`<p>Installing extension files to device...</p>
             <div style="margin-top: 16px; color: var(--text-secondary);">
               <span class="install-spinner">◐</span> Preparing...
             </div>`,buttons:[]});try{stopStatusInfoPolling();const h=(v,...y)=>v.reduce((b,S,x)=>b+S+(y[x]||""),""),m=instantiateExtension(a.content,c,l.emit.bind(l),h);if(typeof m.onInstall=="function"){updateModalBody(`<p>Writing files to device...</p>
          <div style="margin-top: 16px; color: var(--text-secondary);">
...
Please check your internet connection and try again.`)}}),n.on("select-scriptos",async r=>{if(o("select-scriptos:",r.displayName||r.slug),r.slug&&!r.content){const d=r.slug;console.log("[Registry] Fetching skill from ScriptoHub:",d);try{const a=await getSkill(d,e.scriptohubApiUrl);if(!a||!a.latestVersion)throw new Error(`Skill "${d}" has no published version`);const l=(await getSkillVersionFiles(d,a,e.scriptohubApiUrl)).files.find(h=>h.path.endsWith(".py"));if(!l)throw new Error(`Skill "${d}" has no .py file`);const[u,p]=await Promise.all([getSkillFile(d,l.path,e.scriptohubApiUrl),getSkillFile(d,"SKILL.md",e.scriptohubApiUrl).catch(()=>null)]),f=parseScriptOsConfig(u);if(!f)throw new Error("Failed to parse ScriptO configuration");console.log("[Registry] Fetched skill:",d,"py:",l.path,"skill.md:",!!p),r={slug:d,filename:l.path,displayName:r.displayName||a.skill?.displayName,content:u,config:f,skillMd:p}}catch(a){console.error("[Registry] Error fetching skill:",a),alert(`Failed to load skill:
