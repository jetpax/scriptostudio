const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/tree-sitter-uMmJBH9q.js","assets/vendor-CyyQKiqp.js","assets/vendor-YJ71nRLj.js","assets/vendor-lO5W-5Cn.css","assets/index-D8uXHUWg.js","assets/index-BvC6oQL-.js","assets/index-CEIVfw6W.js","assets/index-Ckq7-Rzu.js","assets/index-BR6z4vJu.js","assets/index-Bvni1Ih1.js","assets/index-CzizjDTO.js","assets/xterm-DOrYoP_4.css"])))=>i.map(i=>d[i]);
...
`)}}n.write(TERMINAL_PROMPT)}else if(r==="	"){if(i.isConnected&&o&&typeof o.requestCompletion=="function")try{const s=await o.requestCompletion(i.currentLine);if(!s||s.length===0){n.write("\x07");return}const a=u=>u&&u.length>=2&&/^[A-Z][A-Z0-9_]*$/.test(u),c=s.filter(u=>!a(u));if(c.length===0){n.write("\x07");return}let l="",d=[];if(c.length===1)l=c[0];else{const u=i.currentLine;let p=c[0];for(let h=1;h<c.length;h++){let f=0;for(;f<p.length&&f<c[h].length&&p[f]===c[h][f];)f++;p=p.slice(0,f)}p.length>u.length&&(l=p.slice(u.length)),d=c}if(l&&(i.currentLine=i.currentLine.slice(0,i.cursorPos)+l+i.currentLine.slice(i.cursorPos),i.cursorPos+=l.length,redrawLine(n,i.currentLine,i.cursorPos,o)),d.length>0){n.write(`\r
`);const u=80;let p="";for(const h of d){const f=p.length+h.length+(p?4:0);p&&f>u?(n.write(p+`\r
...
`),i.currentLine="",i.cursorPos=0,i.historyIndex=-1,n.write(TERMINAL_PROMPT);else if(r===""||r==="\b")i.cursorPos>0&&(o.isCommandRunning&&o.isCommandRunning()?(i.currentLine=i.currentLine.slice(0,-1),i.cursorPos--,n.write("\b \b")):(i.currentLine=i.currentLine.slice(0,i.cursorPos-1)+i.currentLine.slice(i.cursorPos),i.cursorPos--,redrawLine(n,i.currentLine,i.cursorPos,o)));else if(r.length>=1){const s=r.split("").filter(a=>{const c=a.charCodeAt(0);return c>=32&&c<127}).join("");s.length>0&&(o.isCommandRunning&&o.isCommandRunning()?(i.currentLine+=s,i.cursorPos+=s.length,n.write(s)):(i.currentLine=i.currentLine.slice(0,i.cursorPos)+s+i.currentLine.slice(i.cursorPos),i.cursorPos+=s.length,redrawLine(n,i.currentLine,i.cursorPos,o)))}n.scrollToBottom()})}let TerminalClass=null,FitAddonClass=null,xtermLoaded=!1;async function loadXterm(){if(xtermLoaded)return{Terminal:TerminalClass,FitAddon:FitAddonClass};try{const[n,i]=await Promise.all([__vitePreload(()=>import("./xterm-CASmyfyk.js"),[]),__vitePreload(()=>import("./addon-fit-DOCEibfw.js"),[]),__vitePreload(()=>Promise.resolve({}),__vite__mapDeps([11]))]);return TerminalClass=n.Terminal,FitAddonClass=i.FitAddon,xtermLoaded=!0,console.debug("[XTerm] Lazy loaded xterm modules"),{Terminal:TerminalClass,FitAddon:FitAddonClass}}catch(n){throw console.error("[XTerm] Failed to load xterm:",n),n}}loadXterm();class XTerm extends Component$1{constructor(i,o,r){super(i),this.term=null,this.fitAddon=null,this.resizeObserver=null,this.inputBound=!1,this._emit=r}load(i){if(this.term){console.debug("[XTerm] Reusing existing terminal instance (no re-open needed)");const o=this.term.element?.parentElement;o&&i.appendChild(o),this.resizeObserver&&this.resizeObserver.disconnect(),this.resizeObserver=new ResizeObserver(()=>{setTimeout(()=>this.fitTerminal(),50)}),this.resizeObserver.observe(i),setTimeout(()=>this.fitTerminal(),50),setTimeout(()=>this.fitTerminal(),150);return}loadXterm().then(()=>this.ensureFontsLoaded()).then(()=>this.createAndOpenTerminal(i)).catch(o=>{console.error("[XTerm] Failed to initialize terminal:",o),i.innerHTML='<div style="color:red;padding:10px;">Terminal failed to load. Check console for errors.</div>'})}async ensureFontsLoaded(){if(document.fonts&&document.fonts.ready)try{return await document.fonts.ready,document.fonts.check&&await new Promise(i=>setTimeout(i,50)),Promise.resolve()}catch{return new Promise(o=>setTimeout(o,200))}else return new Promise(i=>setTimeout(i,200))}createAndOpenTerminal(i){this.term=new TerminalClass({fontFamily:"monospace",fontSize:12,letterSpacing:0,cursorBlink:!0,cursorStyle:"block",scrollback:1e3,theme:{foreground:"#33ff33",background:"#000000",cursor:"#FFFFFF",cursorAccent:"#000000"}}),this.term.open(i),this.fitAddon=new FitAddonClass,this.term.loadAddon(this.fitAddon),setTimeout(()=>this.fitTerminal(),50),setTimeout(()=>this.fitTerminal(),150),setTimeout(()=>this.fitTerminal(),300),setTimeout(()=>this.fitTerminal(),600);let o=null;const r=()=>{o&&clearTimeout(o),o=setTimeout(()=>this.fitTerminal(),100)};this.resizeObserver=new ResizeObserver(r),this.resizeObserver.observe(i);const s=i.closest(".repl-panel-main");s&&this.resizeObserver.observe(s)}createElement(){return html$1`<div class="terminal-wrapper"></div>`}update(){return this.fitAddon&&setTimeout(()=>this.fitTerminal(),50),!1}unload(){this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null)}fitTerminal(){if(!(!this.term||!this.fitAddon))try{this.fitAddon.fit(),this.term.refresh&&this.term.refresh(0,this.term.rows-1)}catch(i){console.warn("[XTerm] Fit failed:",i)}}resizeTerm(){this.fitTerminal()}bindInput(i,o){return this.inputBound||!this.term?!1:(console.debug("[XTerm] Binding input handler"),this.inputBound=!0,this.term.textarea&&this.term.textarea.addEventListener("focus",()=>{this._emit&&this._emit("terminal-focus")}),setupTerminalInputHandler(this.term,i,o),!0)}isInputBound(){return this.inputBound}}function CodeEditor(n,i){if(n.editingFile){const o=n.openFiles.find(r=>r.id==n.editingFile);return o?o.editor.render():(console.error("[CodeEditor] File not found for id:",n.editingFile),html$1`<div id="code-editor">File not found</div>`)}else return html$1`
    ...
    `}function ConnectionDialog(n,i){const o=n.isConnectionDialogOpen?"open":"closed",r=localStorage.getItem("webrepl-url")||"",s=localStorage.getItem("webrepl-password")||"";let a=!1;function c(h){a=h.target.closest(".dialog-content")!==null}function l(h){h.target.id=="dialog-connection"&&!a&&i("close-connection-dialog"),a=!1}function d(h){if(h.preventDefault(),h.stopPropagation(),n.isConnecting)return;const f=document.getElementById("webrepl-url").value,m=document.getElementById("webrepl-password").value;i("connect-webrepl",{wsUrl:f,password:m})}function u(h){h.stopPropagation(),h.key==="Enter"&&!n.isConnecting&&d(h)}n.isConnectionDialogOpen&&!window._connectionDialogEnterHandler?(window._connectionDialogEmit=i,window._connectionDialogEnterHandler=h=>{const f=document.getElementById("dialog-connection");if(!f||!f.classList.contains("open"))return;const m=f.querySelector(".connect-button");if(!(m&&m.disabled)&&h.key==="Enter"){const v=h.target;if(v.tagName!=="INPUT"&&v.tagName!=="TEXTAREA"){h.preventDefault(),h.stopPropagation();const y=document.getElementById("webrepl-url")?.value,w=document.getElementById("webrepl-password")?.value;y&&w&&window._connectionDialogEmit&&window._connectionDialogEmit("connect-webrepl",{wsUrl:y,password:w})}}},document.addEventListener("keydown",window._connectionDialogEnterHandler)):!n.isConnectionDialogOpen&&window._connectionDialogEnterHandler&&(document.removeEventListener("keydown",window._connectionDialogEnterHandler),window._connectionDialogEnterHandler=null,window._connectionDialogEmit=null);const p=html`
  <div id="dialog-connection" class="dialog ${o}" tabindex="-1" onmousedown=${c} onclick=${l} onkeydown=${h=>{h.key==="Enter"&&!n.isConnecting&&(h.preventDefault(),h.stopPropagation(),d(h))}} oncreate=${()=>{const h=document.getElementById("webrepl-url"),f=document.getElementById("webrepl-password");h&&r&&(h.value=r),f&&s&&(f.value=s)}}>
...
`;if(n.isNewFileDialogOpen){const f=h.querySelector("#dialog-new-file .dialog-content > input");return f&&f.focus(),h}}function ScriptOsModal(n,i){return n.isScriptOsModalOpen?html`
          ...
          <div class="scriptos-categories">
            ${p.map(w=>{const b=n.scriptOsCategoryCollapse[w]===!0;return html`
                <div class="scriptos-category ${b?"collapsed":""}">
                  <h3 class="scriptos-category-title" onclick=${()=>h(w)}>
  ...
  `}function ExtensionsLibraryView(n,i){const o=n.availableExtensions||[],r=n.installedExtensions||[],s=new Set(r.map(l=>l.id)),a=o.filter(l=>!s.has(l.id)),c=(l,d)=>{for(let u=0;u<3;u++){const p=l[u]||0,h=d[u]||0;if(p>h)return!0;if(p<h)return!1}return!1};return o.length===0?html`
      <div class="scriptos-library">
        <div class="scriptos-header-sticky">
           <div class="scriptos-header">
            <h2>Extensions</h2>
...
`;this.term.write(m),this.state.logs?.autoScroll!==!1&&this.term.scrollToBottom()}cleanup(){this.writeHandler&&(window.removeEventListener("log-terminal-write",this.writeHandler),this.writeHandler=null),this.clearHandler&&(window.removeEventListener("log-terminal-clear",this.clearHandler),this.clearHandler=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this.term&&(this.term.dispose(),this.term=null),this.fitAddon=null}}let logTerminalComponent=null;function LogSidebar(n,i){if(!n.logs.isOpen)return logTerminalComponent=null,null;logTerminalComponent||(logTerminalComponent=new LogTerminalComponent("log-terminal",n,i));const o=logTerminalComponent.render(n),r=n.logSidebarWidth||350;return html`
  ...
  `}const DiskFileList=generateFileList("disk"),BoardFileList=generateFileList("board");function generateFileList(n){return function(o,r){function s(f){f.key.toLowerCase()==="enter"&&f.target.blur(),f.key.toLowerCase()==="escape"&&(f.target.value=null,f.target.blur())}const a=html`
    ...
    `;function l(f,m){const v=html`
        <input type="text"
          ...
          ondblclick=${x=>!1}
          />
      `,y=o.selectedFiles.find(x=>x.fileName===f.fileName&&x.source===n);function w(x){return x.preventDefault(),r("rename-file",n,f),!1}function b(){o.renamingFile||r(`navigate-${n}-folder`,f.fileName)}function C(){o.renamingFile||r("open-file",n,f)}let E=f.fileName;const $=o.selectedFiles.find(x=>x.fileName===E);o.renamingFile==n&&$&&(E=v);function S(x){if(x==null)return"";if(x===0)return"0 B";const I=1024,P=["B","KB","MB","GB"],k=Math.floor(Math.log(x)/Math.log(I));return parseFloat((x/Math.pow(I,k)).toFixed(1))+" "+P[k]}const _=f.type==="file"?S(f.size):"";return f.type==="folder"?html`
          <div
        ...
        `}const d=o[`${n}Files`].sort((f,m)=>{const v=f.fileName.toUpperCase(),y=m.fileName.toUpperCase();if(f.type==="folder"&&m.type==="file")return-1;if(f.type===m.type){if(v<y)return-1;if(v>y)return 1}return 0}),u=html`<div class="item"
    ...
    <div class="panel-section">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <span class="info-value info-mono">${"7e16211"}</span>
        </div>
        <div class="info-item">
          <span class="info-label">${n("sysinfo.studioBuildDate")}</span>
          <span class="info-value">${"2026-02-26"}</span>
        </div>
      </div>
    </div>
  ...
  `:""}function EthernetPanel(n,i){if(!n.networksInfo&&n.isConnected&&!n.isLoadingNetworks&&i("refresh-networks"),n.isConnected&&!n.ethConfigLoaded&&!n.isLoadingEthConfig&&i("load-eth-config"),n.isConnected&&!n.networkInterfacesConfig&&!n.isLoadingNetworkInterfacesConfig&&i("load-network-interfaces-config"),!n.networksInfo)return html`
    ...
    `;const o=n.networksInfo.eth,r=n.ethStatus,s=r&&r.initialized?r:o&&o.mac?o:r||o,a=n.ethConfig||{},c=o!==null,l=n.networkInterfacesConfig?.ethernet===!1,d=s&&(s.mac||s.enabled||s.enable||s.initialized),u=s&&s.ip&&s.ip!=="0.0.0.0",p=s&&s.linkup===!0,h=u;if(!c)return html`
      <div class="panel-container">
        <div class="panel-header">
          <h2>Ethernet Configuration</h2>
        </div>
    ...
    `;const f=l?"status-disabled":h?"status-active":p?"status-warning":"status-inactive",m=l?"Disabled":h?"Connected":p?"Link Up (No IP)":d?"No Link":"Not Initialized";return html`
    <div class="panel-container">
      <div class="panel-header">
        <h2>Ethernet Configuration</h2>
      </div>
  ...
  `}function VPNPanel(n,i){n.isConnected&&!n.vpnConfigLoaded&&!n.isLoadingVpnConfig&&i("load-vpn-config");const o=n.vpnConfig||{hostname:"",join_code:"",auto_connect:!1},r=n.networksInfo?.vpn,s=n.isConnected,a=n.networksInfo&&r!==void 0;!a||r.available;const c=a&&r.active;return html`
    <div class="panel-container">
      ...
      <div class="panel-section">
        ...
        <form class="config-form" onsubmit=${l=>{l.preventDefault();const d=new FormData(l.target),u=d.get("hostname")||"",p=d.get("join_code")||"",h=d.get("auto_connect")==="on";if(!u.trim()){alert("Please enter a hostname for this device");return}if(!p.trim()){alert("Please enter a Husarnet join code");return}i("vpn-connect",{hostname:u.trim(),join_code:p.trim(),auto_connect:h})}}>
          <div class="form-group">
  ...
  `}function NTPPanel(n,i){n.isConnected&&!n.ntpConfigLoaded&&!n.isLoadingNtpConfig&&i("load-ntp-config");const o=n.ntpConfig||{server:"pool.ntp.org",tzOffset:0,timezone:"UTC",autoDetect:!1},r=n.ntpSyncResult||null,s=u=>{if(!u)return"--:--:--";const{year:p,month:h,day:f,hour:m,minute:v,second:y}=u;return`${String(m).padStart(2,"0")}:${String(v).padStart(2,"0")}:${String(y).padStart(2,"0")}`},a=u=>{if(!u)return"";const{year:p,month:h,day:f}=u;return`${p}-${String(h).padStart(2,"0")}-${String(f).padStart(2,"0")}`},c=[{value:"UTC",offset:0,label:"UTC (Coordinated Universal Time)"},{value:"EST",offset:-5,label:"EST (Eastern Standard Time)"},{value:"CST",offset:-6,label:"CST (Central Standard Time)"},{value:"MST",offset:-7,label:"MST (Mountain Standard Time)"},{value:"PST",offset:-8,label:"PST (Pacific Standard Time)"},{value:"GMT",offset:0,label:"GMT (Greenwich Mean Time)"},{value:"CET",offset:1,label:"CET (Central European Time)"},{value:"EET",offset:2,label:"EET (Eastern European Time)"},{value:"JST",offset:9,label:"JST (Japan Standard Time)"},{value:"AEST",offset:10,label:"AEST (Australian Eastern Standard Time)"}],l=o.timezone,d=[...c];return l&&!c.find(u=>u.value===l)&&d.unshift({value:l,offset:o.tzOffset||0,label:`${l} (Detected)`}),html`
    <div class="panel-container">
      ...
      <div class="panel-section">
        ...
        <form class="config-form" onsubmit=${async u=>{u.preventDefault();const p=new FormData(u.target),h=p.get("server")||"pool.ntp.org",f=p.get("timezone")||"UTC",m=p.get("auto_detect")==="on",v=d.find(b=>b.value===f),y=v?v.offset:0,w={server:h,tz_offset:y,timezone:f,auto_detect:m};try{await new Promise((b,C)=>{const E=setTimeout(()=>C(new Error("Save timeout")),1e4),$=()=>{clearTimeout(E),window.appInstance.emitter.removeListener("ntp-config-saved",S),window.appInstance.emitter.removeListener("ntp-config-save-error",_)},S=()=>{$(),b()},_=x=>{$(),C(x)};window.appInstance.emitter.once("ntp-config-saved",S),window.appInstance.emitter.once("ntp-config-save-error",_),i("save-ntp-config",w)}),i("sync-ntp-time",h,y,m)}catch(b){console.error("[NTP] Failed to save config before sync:",b),alert(`Failed to save NTP configuration: ${b.message}`)}}}>
          <div class="form-group">
...
`)).match(/CREDS:(\{.*\})/);if(o){const r=JSON.parse(o[1]);panelState.credentials={hostname:r.h+".local",password:r.p,ssid:r.s},addLog(`Found: ${r.h}.local`,"success")}else throw new Error("Could not read settings - device may need firmware");triggerRerender()}catch(n){addLog(`Error: ${n.message}`,"error"),triggerRerender()}}async function performWifiSetup(){clearLog();try{let l=function(d){return new Promise((u,p)=>{const h=document.createElement("div");h.className="fw-modal-overlay active",h.innerHTML=`
        ...
        `,document.body.appendChild(h);const f=y=>{const w=y.target.closest(".fw-modal-network-item");if(w){const b=parseInt(w.dataset.index);v(),u(b)}},m=()=>{v(),p(new Error("Setup cancelled"))},v=()=>{h.remove()};h.querySelector(".fw-network-modal-list").addEventListener("click",f),h.querySelector(".fw-modal-cancel").addEventListener("click",m)})};addLog("Connecting to REPL...");const n=await transitionToREPL();if(!n.success){await handleBootFailure(n.error);return}addLog("Scanning for WiFi networks...");const o=(await sendREPLCommand(currentPort,`
import network
import json
...
`)){const a=s.match(/^(\w+)\s*:\s*(.+)$/);a&&(i.meta[a[1].trim()]=a[2].trim())}i.body=n.slice(o[0].length)}return i.body=i.body.replace(/^ScriptO for\s+\[.*?\]\(.*?\)\.?\s*Run on device\s*\(MicroPython\)\.?\s*\n?/im,""),i.body=i.body.trim(),i}function SkillSidebar(n,i){if(!n.isSkillSidebarOpen||!n.skillSidebarContent)return html`<div></div>`;const{name:o,skillMd:r}=n.skillSidebarContent,{meta:s,body:a}=parseSkillMd(r);let c="";try{a&&(c=g.parse(a,{breaks:!0}))}catch(h){console.error("[SkillSidebar] Failed to parse markdown:",h),c=`<pre>${a}</pre>`}const l=[];s.description&&l.push(`<p class="skill-meta-description">${s.description}</p>`);const d=[];s.category&&d.push(`<span class="skill-meta-tag">${s.category}</span>`),s.author&&d.push(`<span class="skill-meta-tag">by ${s.author}</span>`),d.length&&l.push(`<div class="skill-meta-tags">${d.join("")}</div>`);const u=l.length?`<div class="skill-meta-block">${l.join("")}</div>`:"",p=document.createElement("div");return p.className="skill-sidebar-content skill-md-content",p.innerHTML=u+c,html`
...
`)}}catch(l){console.debug("[Connection] Failed to fetch version info:",l.message)}c.write(TERMINAL_PROMPT),c.scrollToBottom(),n.bannerDisplayed=!0,console.log("[Connection] Welcome banner displayed")})}function registerFileOperationHandlers(n,i,o,r,s,a,c){i.on("save",async()=>{if(console.log("save"),canSave({isConnected:n.isConnected,openFiles:n.openFiles,editingFile:n.editingFile})==!1){console.log("can't save");return}n.isSaving=!0,updateOverlayDirectly(n);let d=n.openFiles.find(v=>v.id===n.editingFile),u=!1;const p=d.parentFolder,h=p===null;h&&(d.source=="board"?d.parentFolder=n.boardNavigationPath:d.source=="disk"&&(d.parentFolder=n.diskNavigationPath));let f=!1;if(d.source=="board"?f=await fileExists(BridgeDevice,getFullPath(n.boardNavigationRoot,d.parentFolder,d.fileName)):d.source=="disk"&&(f=await r.fileExists(r.getFullPath(n.diskNavigationRoot,d.parentFolder,d.fileName))),(h||!f)&&(d.source=="board"?(d.parentFolder=n.boardNavigationPath,u=await fileExists(BridgeDevice,getFullPath(n.boardNavigationRoot,d.parentFolder,d.fileName))):d.source=="disk"&&(d.parentFolder=n.diskNavigationPath,u=await r.fileExists(r.getFullPath(n.diskNavigationRoot,d.parentFolder,d.fileName)))),u&&await confirmDialog(`You are about to overwrite the file ${d.fileName} on your ${d.source}.
...
`,d.forEach(m=>u+=`${m}
`),u+=`
`),u+="Are you sure you want to proceed?",await confirmDialog(u)!==0){i.emit("render");return}let h=!1,f=!1;for(let m in n.selectedFiles){const v=n.selectedFiles[m];v.type=="folder"?v.source==="board"?(await removeBoardFolder(getFullPath(n.boardNavigationRoot,n.boardNavigationPath,v.fileName)),h=!0):(await r.removeFolder(r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,v.fileName)),f=!0):v.source==="board"?(await deleteFile(o,getFullPath(n.boardNavigationRoot,n.boardNavigationPath,v.fileName)),h=!0):(await r.removeFile(r.getFullPath(n.diskNavigationRoot,n.diskNavigationPath,v.fileName)),f=!0)}h&&f?i.emit("refresh-files"):h?i.emit("refresh-board-files"):f&&i.emit("refresh-disk-files"),n.selectedFiles=[],i.emit("render")}),i.on("rename-file",(l,d)=>{console.log("rename-file",l,d),n.renamingFile=l,i.emit("render")}),i.on("finish-renaming-file",async l=>{console.log("finish-renaming-file",l);const d=n.selectedFiles[0];if(!l||d.fileName==l){n.renamingFile=null,i.emit("render");return}if(n.isSaving=!0,updateOverlayDirectly(n),n.renamingFile=="board"&&n.isConnected){if((await checkOverwrite({fileNames:[l],parentPath:r.getFullPath(n.boardNavigationRoot,n.boardNavigationPath,""),source:"board"})).length>0){let p=`You are about to overwrite the following file/folder on your board:
...
${l.message}`)}});async function a(c,l,d,u,p){const h=c.id,f=Array.isArray(c.version)?c.version.join("."):String(c.version);s(`[Extensions] Running onInstall for ${c.name}...`),showStyledModal({variant:"",icon:"packages",title:"Installing Extension",subtitle:c.name,body:`<p>Installing extension files to device...</p>
...
Please check your internet connection and try again.`)}}),i.on("select-scriptos",async a=>{if(s("select-scriptos:",a.displayName||a.slug),a.slug&&!a.content){const c=a.slug;console.log("[Registry] Fetching skill from ScriptoHub:",c);try{const l=await getSkill(c,n.scriptohubApiUrl);if(!l||!l.latestVersion)throw new Error(`Skill "${c}" has no published version`);const u=(await getSkillVersionFiles(c,l,n.scriptohubApiUrl)).files.find(m=>m.path.endsWith(".py"));if(!u)throw new Error(`Skill "${c}" has no .py file`);const[p,h]=await Promise.all([getSkillFile(c,u.path,n.scriptohubApiUrl),getSkillFile(c,"SKILL.md",n.scriptohubApiUrl).catch(()=>null)]),f=parseScriptOsConfig(p);if(!f)throw new Error("Failed to parse ScriptO configuration");console.log("[Registry] Fetched skill:",c,"py:",u.path,"skill.md:",!!h),a={slug:c,filename:u.path,displayName:a.displayName||l.skill?.displayName,content:p,config:f,skillMd:h}}catch(l){console.error("[Registry] Error fetching skill:",l),alert(`Failed to load skill:
