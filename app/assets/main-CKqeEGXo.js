const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/tree-sitter-C0SS3geu.js","assets/vendor-Usn1lVw9.js","assets/vendor-YJ71nRLj.js","assets/vendor-BtOwRsPs.css","assets/index-D8uXHUWg.js","assets/index-BvC6oQL-.js","assets/index-CEIVfw6W.js","assets/index-Ckq7-Rzu.js","assets/index-BR6z4vJu.js","assets/index-Bvni1Ih1.js","assets/index-CzizjDTO.js","assets/xterm-DOrYoP_4.css"])))=>i.map(i=>d[i]);
...
`,x=performance.now()-r;return console.log(`[Debugger] Instrumentation complete in ${x.toFixed(0)}ms`),S}console.log("[Libs] ES modules loaded");function renderIcon(e,n={}){const{className:i="",size:s=24,color:o="currentColor"}=n;return html$1`
  ...
  `}const IconSprite={renderIcon};await __vitePreload(()=>import("./vendor-Usn1lVw9.js"),__vite__mapDeps([1,2,3]));console.log("[Views] Vendor loaded, Component available:",!!window.Component);function Button(e){const{first:n=!1,size:i="",square:s=!1,icon:o="link",onClick:r=k=>{},disabled:d=!1,active:a=!1,tooltip:l,label:c,background:p}=e;let u=html``;l&&(u=html`<div class="tooltip">${l}</div>`),u=html``;let f=a?"active":"",h=a?"selected":"",m=p?"inverted":"",v=n?"first":"",y=s?"square":"",w=d?"inactive":"active",S=i==="small"?"":html`<div class="label ${w} ${h}">${c}</div>`;const x=IconSprite.renderIcon(o,{className:""});return html`
     <div class="button ${v}">
...
`;if(e.isNewFileDialogOpen){const f=u.querySelector("#dialog-new-file .dialog-content > input");return f&&f.focus(),u}}function ScriptOsModal(e,n){return e.isScriptOsModalOpen?html`
  ...
  `}function ExtensionsLibraryView(e,n){const i=e.availableExtensions||[],s=e.installedExtensions||[],o=new Set(s.map(a=>a.id)),r=i.filter(a=>!o.has(a.id)),d=(a,l)=>{for(let c=0;c<3;c++){const p=a[c]||0,u=l[c]||0;if(p>u)return!0;if(p<u)return!1}return!1};return i.length===0?html`
      <div class="scriptos-library">
        <div class="scriptos-header-sticky">
           <div class="scriptos-header">
            <h2>Extensions</h2>
      ...
      <div class="scriptos-content">
        ${s.length>0?html`
          <div class="scriptos-section" style="margin-bottom: 32px">
            ...
            <div class="scriptos-grid">
              ${s.map(a=>{const l=i.find(p=>p.id===a.id),c=l&&d(l.version,a.version);return html`
...
`;this.term.write(h),this.state.logs?.autoScroll!==!1&&this.term.scrollToBottom()}cleanup(){this.writeHandler&&(window.removeEventListener("log-terminal-write",this.writeHandler),this.writeHandler=null),this.clearHandler&&(window.removeEventListener("log-terminal-clear",this.clearHandler),this.clearHandler=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this.term&&(this.term.dispose(),this.term=null),this.fitAddon=null}}let logTerminalComponent=null;function LogSidebar(e,n){if(!e.logs.isOpen)return logTerminalComponent=null,null;logTerminalComponent||(logTerminalComponent=new LogTerminalComponent("log-terminal",e,n));const i=logTerminalComponent.render(e),s=e.logSidebarWidth||350;return html`
  ...
  `}function Overlay(e,n){let i=html`<div id="overlay" class="closed"></div>`;if(e.diskFiles==null&&(n("load-disk-files"),i=html`<div id="overlay" class="open"><p>Loading files...</p></div>`),e.isRemoving&&(i=html`<div id="overlay" class="open"><p>Removing...</p></div>`),e.isConnecting&&(i=html`<div id="overlay" class="open"><p>Connecting...</p></div>`),e.isLoadingFiles&&(i=html`<div id="overlay" class="open"><p>Loading files...</p></div>`),e.isSaving&&(i=html`<div id="overlay" class="open"><p>Saving file... ${e.savingProgress}</p></div>`),e.isTransferring){const s=String(e.transferringProgress||""),o=s.match(/(\d+)%?$/),r=o?parseInt(o[1]):0,d=s.match(/^(.+?):/),a=d?d[1]:"file";i=html`
    ...
    `}return i}const DISCONNECTED_STATUS_TEXT="ScriptO Studio © JetPax 2026";function formatUptimeMinutes(e){const n=(e||0)*60,i=Math.floor(n/86400),s=Math.floor(n%86400/3600),o=Math.floor(n%3600/60),r=Math.floor(n%60),d=[];return i>0&&d.push(`${i}d`),s>0&&d.push(`${s}h`),o>0&&d.push(`${o}m`),(r>0||d.length===0)&&d.push(`${r}s`),d.join(" ")}function buildStatusBarModel(e,n){if(!e)return{connected:!1,disconnectedText:DISCONNECTED_STATUS_TEXT,ram:null,temp:null,uptime:null,rssi:null};const i=e.mem||{},s=e.temp,o=e.uptime||0,r=e.wifi_rssi,d=i.alloc||0,a=i.free||0,l=d+a,c=(d/1024).toFixed(2),p=(l/(1024*1024)).toFixed(2);let u=null;s!=null&&((n||"degC")==="degF"?u=`${(s*9/5+32).toFixed(1)}°F`:u=`${s.toFixed(1)}°C`);const f=formatUptimeMinutes(o);let h=null;return r!=null&&(h=`${r} dBm`),{connected:!0,disconnectedText:DISCONNECTED_STATUS_TEXT,ram:`${c} KB / ${p} MB`,temp:u,uptime:f,rssi:h}}function StatusBar(e,n){const i=buildStatusBarModel(e.isConnected?e.statusInfo:null,e.temperatureUnit||"degC");if(!i||!i.connected){const s=i&&i.disconnectedText||DISCONNECTED_STATUS_TEXT;return html`
  ...
  `}function LanguageSelector(e,n){const i=window.html||(()=>{}),s=e.locale||"en",o=window.i18n?window.i18n.getAvailableLocales():["en","de","es","fr"],r={en:"English",de:"Deutsch",es:"Español",fr:"Français"},d=window.i18n?window.i18n.t("language"):"Language";return i`
    <div class="language-selector">
      ...
      <select
        ...
        onchange=${l=>{const c=l.target.value;n("change-locale",c)}}
      >
        ${o.map(l=>i`
    ...
    <div class="panel-section">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <span class="info-value info-mono">${"8514bb7"}</span>
        </div>
        <div class="info-item">
  ...
  `:""}function EthernetPanel(e,n){if(!e.networksInfo&&e.isConnected&&!e.isLoadingNetworks&&n("refresh-networks"),e.isConnected&&!e.ethConfigLoaded&&!e.isLoadingEthConfig&&n("load-eth-config"),e.isConnected&&!e.networkInterfacesConfig&&!e.isLoadingNetworkInterfacesConfig&&n("load-network-interfaces-config"),!e.networksInfo)return html`
    ...
    `;const i=e.networksInfo.eth,s=e.ethStatus,o=s&&s.initialized?s:i&&i.mac?i:s||i,r=e.ethConfig||{},d=i!==null,a=e.networkInterfacesConfig?.ethernet===!1,l=o&&(o.mac||o.enabled||o.enable||o.initialized),c=o&&o.ip&&o.ip!=="0.0.0.0",p=o&&o.linkup===!0,u=c;if(!d)return html`
      <div class="panel-container">
        <div class="panel-header">
          <h2>Ethernet Configuration</h2>
        </div>
  ...
  `}function VPNPanel(e,n){e.isConnected&&!e.vpnConfigLoaded&&!e.isLoadingVpnConfig&&n("load-vpn-config");const i=e.vpnConfig||{hostname:"",join_code:"",auto_connect:!1},s=e.networksInfo?.vpn,o=e.isConnected,r=e.networksInfo&&s!==void 0;!r||s.available;const d=r&&s.active;return html`
    <div class="panel-container">
      ...
      <div class="panel-section">
        ...
        <form class="config-form" onsubmit=${a=>{a.preventDefault();const l=new FormData(a.target),c=l.get("hostname")||"",p=l.get("join_code")||"",u=l.get("auto_connect")==="on";if(!c.trim()){alert("Please enter a hostname for this device");return}if(!p.trim()){alert("Please enter a Husarnet join code");return}n("vpn-connect",{hostname:c.trim(),join_code:p.trim(),auto_connect:u})}}>
          <div class="form-group">
  ...
  `:html`
    ...
    <div class="panel-container">
      ...
      <div class="panel-section">
        ...
        <form class="config-form" onsubmit=${l=>{l.preventDefault();const c=new FormData(l.target),p={apn:c.get("apn")||"",username:c.get("username")||"",password:c.get("password")||"",auto_init_modem:c.get("auto_init_modem")==="on",mobile_data_enabled:s.mobile_data_enabled||!1};n("save-wwan-config",p)}}>
          <div class="form-group">
            <label for="wwan-apn">
              GPRS APN
              <span class="label-tooltip">
...
`)){const r=o.match(/^(\w+)\s*:\s*(.+)$/);r&&(n.meta[r[1].trim()]=r[2].trim())}n.body=e.slice(i[0].length)}return n.body=n.body.replace(/^ScriptO for\s+\[.*?\]\(.*?\)\.?\s*Run on device\s*\(MicroPython\)\.?\s*\n?/im,""),n.body=n.body.trim(),n}function SkillSidebar(e,n){if(!e.isSkillSidebarOpen||!e.skillSidebarContent)return html`<div></div>`;const{name:i,skillMd:s}=e.skillSidebarContent,{meta:o,body:r}=parseSkillMd(s);let d="";try{r&&(d=g.parse(r,{breaks:!0}))}catch(u){console.error("[SkillSidebar] Failed to parse markdown:",u),d=`<pre>${r}</pre>`}const a=[];o.description&&a.push(`<p class="skill-meta-description">${o.description}</p>`);const l=[];o.category&&l.push(`<span class="skill-meta-tag">${o.category}</span>`),o.author&&l.push(`<span class="skill-meta-tag">by ${o.author}</span>`),l.length&&a.push(`<div class="skill-meta-tags">${l.join("")}</div>`);const c=a.length?`<div class="skill-meta-block">${a.join("")}</div>`:"",p=document.createElement("div");return p.className="skill-sidebar-content skill-md-content",p.innerHTML=c+d,html`
  ...
  `,f=e.expandedNetworks!==!1,h=html$1`
    <div class="system-sidebar-extension">
      ...
      ${f?html$1`
        <div class="system-sidebar-submenu">
          ${d.map(b=>{const $=e.activeNetworkPanel===b.id;return html$1`
              <div 
                class="system-sidebar-subitem ${$?"active":""}"
...
${a.message}`)}});async function r(d,a,l,c,p){const u=d.id,f=Array.isArray(d.version)?d.version.join("."):String(d.version);o(`[Extensions] Running onInstall for ${d.name}...`),showStyledModal({variant:"",icon:"packages",title:"Installing Extension",subtitle:d.name,body:`<p>Installing extension files to device...</p>
...
Please check your internet connection and try again.`)}}),n.on("select-scriptos",async r=>{if(o("select-scriptos:",r.displayName||r.slug),r.slug&&!r.content){const d=r.slug;console.log("[Registry] Fetching skill from ScriptoHub:",d);try{const a=await getSkill(d,e.scriptohubApiUrl);if(!a||!a.latestVersion)throw new Error(`Skill "${d}" has no published version`);const c=(await getSkillVersionFiles(d,a,e.scriptohubApiUrl)).files.find(h=>h.path.endsWith(".py"));if(!c)throw new Error(`Skill "${d}" has no .py file`);const[p,u]=await Promise.all([getSkillFile(d,c.path,e.scriptohubApiUrl),getSkillFile(d,"SKILL.md",e.scriptohubApiUrl).catch(()=>null)]),f=parseScriptOsConfig(p);if(!f)throw new Error("Failed to parse ScriptO configuration");console.log("[Registry] Fetched skill:",d,"py:",c.path,"skill.md:",!!u),r={slug:d,filename:c.path,displayName:r.displayName||a.skill?.displayName,content:p,config:f,skillMd:u}}catch(a){console.error("[Registry] Error fetching skill:",a),alert(`Failed to load skill:
...
${d.message}`)}})}async function getSkillVersionFiles(e,n,i){const s=n.latestVersion?.version;if(!s)throw new Error(`Skill "${e}" has no version`);const o=await fetch(`${i}/api/v1/skills/${encodeURIComponent(e)}/versions/${encodeURIComponent(s)}`);if(!o.ok)throw new Error(`Failed to fetch version files: ${o.status}`);const r=await o.json();return r.version||r}console.log("[Stores] ES modules loaded");let CodeMirrorEditorClass=null;async function getCodeMirrorEditor(){return CodeMirrorEditorClass||(CodeMirrorEditorClass=(await __vitePreload(()=>Promise.resolve().then(()=>editor),void 0)).CodeMirrorEditor),CodeMirrorEditorClass}const log=console.log,device=BridgeDevice,disk=BridgeDisk,registryCache=new RegistryCache;async function store(e,n){async function i(r){const{source:d,parentFolder:a,fileName:l,content:c=newFileContent,hasChanges:p=!1}=r,u=generateHash(),f=await getCodeMirrorEditor(),h=e.cache(f,`editor_${u}`);return h.content=c,h.fileName=l,{id:u,source:d,parentFolder:a,fileName:l,editor:h,hasChanges:p}}async function s(r,d=null,a=null,l=null){r=="board"?e.boardNavigationPath:e.diskNavigationPath;const c=await i({fileName:d===null?generateFileName():d,parentFolder:a,source:r,hasChanges:!0,content:l||newFileContent});let p=!1;return a!=null&&(r=="board"?p=await fileExists(BridgeDevice,getFullPath$1(e.boardNavigationRoot,c.parentFolder,c.fileName)):r=="disk"&&(p=await disk.fileExists(disk.getFullPath(e.diskNavigationRoot,c.parentFolder,c.fileName)))),e.openFiles.find(f=>f.parentFolder===c.parentFolder&&f.fileName===c.fileName&&f.source===c.source)||p?(await confirmDialog(`File ${c.fileName} already exists on ${r}. Please choose another name.`),!1):(c.editor.onChange=function(){c.hasChanges=!0,n.emit("render")},e.openFiles.push(c),e.editingFile=c.id,!0)}await initializeState(e,n,s),initializeTheme(e,n),registerThemeHandlers(e,n);const o=()=>{};registerDialogHandlers(e,n,device),registerConnectionHandlers(e,n,device,o,bindTerminalOutput),registerFileOperationHandlers(e,n,device,disk,i,s),registerTerminalHandlers(e,n,device,XTerm),registerAIAgentHandlers(e,n,s),registerLogHandlers(e,n),document.addEventListener("connection-mode-change",r=>{const d=r.detail?.mode||"none";e.connectionMode=d,n.emit("render")}),document.addEventListener("firmware-panel-update",()=>{n.emit("render")}),n.on("navigate",r=>{n.emit("change-system-section",r)}),n.on("change-view",async r=>{r==="file-manager"&&(e.isConnected&&BridgeDevice&&BridgeDevice.isCommandRunning()&&(n.emit("stop"),await sleep(250)),e.filesLoadedOnce||(log("[File Manager] Loading files for first time..."),e.filesLoadedOnce=!0),e.isConnected?n.emit("refresh-files"):n.emit("refresh-disk-files")),e.systemSection!==r&&(e.selectedFiles=[],e.systemSection=r,e.activeNetworkPanel=null,e.activePeripheralsPanel=null,e.activeSystemPanel=null,e.activeExtension=null,e.activeExtensionPanel=null,r==="editor"&&e.isConnected&&setTimeout(()=>{bindTerminalOutput(e);const d=e.cache(XTerm,"terminal");d&&d.term&&(n.emit("bind-terminal-input"),n.emit("terminal-focus"))},100),n.emit("render"))}),n.on("launch-app",async(r,d)=>{window.launchApp(r,d)}),n.on("change-system-section",r=>{if(log("change-system-section",r),e.systemSection=r,r.startsWith("network:")){const d=r.split(":")[1];e.activeNetworkPanel=d,e.activeSystemPanel=null,e.activePeripheralsPanel=null,e.activeExtension=null,e.activeExtensionPanel=null}else if(r.startsWith("peripherals:")){const d=r.split(":")[1];e.activePeripheralsPanel=d,e.activeNetworkPanel=null,e.activeSystemPanel=null,e.activeExtension=null,e.activeExtensionPanel=null}else if(r.startsWith("system:")){const d=r.split(":")[1];e.activeSystemPanel=d,e.activeNetworkPanel=null,e.activePeripheralsPanel=null,e.activeExtension=null,e.activeExtensionPanel=null}else e.activeNetworkPanel=null,e.activePeripheralsPanel=null,e.activeSystemPanel=null,e.activeExtension=null,e.activeExtensionPanel=null;(r==="ai-agent"||r==="system:ai-agent")&&e.aiAgent.settings.provider==="openrouter"&&e.aiAgent.settings.apiKey&&e.aiAgent.openRouterModels.length===0&&n.emit("ai-fetch-openrouter-models"),n.emit("render")}),registerNetworkConfigHandlers(e,n,device),registerHardwareConfigHandlers(e,n,device),registerSystemConfigHandlers(e,n,device),registerExtensionHandlers(e,n,device),registerScriptOsHandlers(e,n,registryCache,s),typeof debuggerStore=="function"?debuggerStore(e,n):console.warn("[Store] Debugger store not loaded"),n.on("change-locale",r=>{e.locale=r,localStorage.setItem("locale",r),window.i18n&&window.i18n.setLocale(r),n.emit("render")}),window.i18n?(window.i18n.setLocale(e.locale),console.log("[i18n] Locale initialized to:",e.locale)):console.warn("[i18n] i18n module not available")}const PANEL_CLOSED=45,PANEL_TOO_SMALL=65,PANEL_DEFAULT=320;typeof window<"u"&&(window.PANEL_CLOSED=PANEL_CLOSED,window.PANEL_TOO_SMALL=PANEL_TOO_SMALL,window.PANEL_DEFAULT=PANEL_DEFAULT);function App(e,n){return e.isInitializing?html$1`
  ...
  `}async function initApp(){window.i18nReady&&(await window.i18nReady,console.log("[App] Translations loaded, starting app...")),console.log("%c ScriptO Studio v1.1.1 ","background: #9b59b6; color: #fff; font-size: 11px; padding: 2px 6px; border-radius: 3px;","build 8514bb7 (2026-03-13)");let e=Choo();e.use(store),e.route("*",App),e.mount("#app"),window.appState=e.state,window.appInstance=e,e.emitter.on("DOMContentLoaded",()=>{e.state.diskNavigationRoot&&e.emitter.emit("refresh-files");const n=new URLSearchParams(window.location.search),i=n.get("device");if(i){const d=`wss://${i}/webrepl`;localStorage.setItem("webrepl-url",d),console.log(`[App] Device URL from query param: ${d}`),setTimeout(()=>{e.emitter.emit("open-connection-dialog");const a=window.location.pathname;window.history.replaceState({},"",a)},500)}const s=n.get("configure");s&&setTimeout(()=>{e.emitter.emit("configure-scripto",s);const d=window.location.pathname;window.history.replaceState({},"",d)},500);const o=n.get("extension");if(o){localStorage.setItem("pending-extension-id",o),sessionStorage.setItem("extension-install-active",o),console.log(`[App] Extension from query param: ${o}`),n.delete("extension");const d=n.toString(),a=window.location.pathname+(d?"?"+d:"");window.history.replaceState({},"",a),i||setTimeout(()=>{console.log("[App] Fresh extension install — navigating to Device Setup"),e.emitter.emit("change-system-panel","firmware")},500)}const r=localStorage.getItem("pending-extension-id");if(r&&i&&setTimeout(async()=>{try{const l=(await new ExtensionRegistry().getInstalledExtensions()).find(c=>c.id===r);l&&l.menu&&l.menu.length>0&&(console.log(`[App] Auto-navigating to extension: ${r}`),localStorage.removeItem("pending-extension-id"),e.emitter.emit("change-extension-panel",{extensionId:r,panelId:l.menu[0].id}))}catch(d){console.warn("[App] Could not auto-navigate to extension:",d)}},1e3),!e.state.isConnected){let d=document.getElementById("hand-click-hint");if(!d){d=document.createElement("div"),d.id="hand-click-hint";const c=document.createElementNS("http://www.w3.org/2000/svg","svg");c.setAttribute("width","36"),c.setAttribute("height","36"),c.setAttribute("viewBox","0 0 24 24"),c.setAttribute("fill","none"),c.setAttribute("stroke","currentColor"),c.setAttribute("stroke-width","2"),c.setAttribute("stroke-linecap","round"),c.setAttribute("stroke-linejoin","round"),c.innerHTML=`
          ...
          <path d="M14 3l1 -1" />
          <path d="M15 6h1" />
        `,d.appendChild(c),document.body.appendChild(d)}const a=()=>{d.classList.add("animate"),setTimeout(()=>{d.classList.remove("animate")},7500)};setTimeout(a,1e3);const l=setInterval(a,1e4);e.emitter.on("connect",()=>{clearInterval(l);const c=document.getElementById("hand-click-hint");c&&c.remove()})}})}document.readyState==="complete"?initApp():window.addEventListener("load",initApp);export{__vitePreload as _};
