...
`);if(console.log("[Connection] banner() returned:",l),l&&l.name){const d=l.name,u=`MicroPython ${l.version} on ${l.machine}`,h=(await convertToAsciiArt(d,null)).split(/\r?\n/).filter(m=>m.trim().length>0);let f=`\r\x1B[K\x1B[38;05;208;1m\r
