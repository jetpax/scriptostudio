const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/tree-sitter-D1WVKiXN.js","assets/vendor-Usn1lVw9.js","assets/vendor-YJ71nRLj.js","assets/vendor-BtOwRsPs.css","assets/index-D8uXHUWg.js","assets/index-BvC6oQL-.js","assets/index-CEIVfw6W.js","assets/index-Ckq7-Rzu.js","assets/index-BR6z4vJu.js","assets/index-Bvni1Ih1.js","assets/index-CzizjDTO.js","assets/xterm-DOrYoP_4.css"])))=>i.map(i=>d[i]);
...
`),C&&console.log(`[Debugger] Generated instrumentation for row ${k+1} (${$})`),d.set(k,E)}let y=[];for(let k=0;k<a.length;k++)d.has(k)&&y.push(d.get(k)),y.push(a[k]);const w=y.join(`
  ...
  `}function LanguageSelector(e,n){const i=window.html||(()=>{}),s=e.locale||"en",o=window.i18n?window.i18n.getAvailableLocales():["en","de","es","fr"],r=window.i18n?window.i18n.t("language"):"Language";return i`
    <div class="language-selector">
      ...
      <select
        ...
        onchange=${a=>{const d=a.target.value;n("change-locale",d)}}
      >
        ${o.map(a=>i`
    ...
    <div class="panel-section">
      ...
      <div class="info-grid">
        <div class="info-item">
          ...
          <span class="info-value">${"1.1.4"}</span>
        </div>
        <div class="info-item">
          <span class="info-label">${e("sysinfo.studioCommit")}</span>
          <span class="info-value info-mono">${"fb6fd41"}</span>
        </div>
        <div class="info-item">
...
${a.message}`)}});async function r(c,a,d,l,p){const u=c.id,f=Array.isArray(c.version)?c.version.join("."):String(c.version);o(`[Extensions] Running onInstall for ${c.name}...`),showStyledModal({variant:"",icon:"packages",title:"Installing Extension",subtitle:c.name,body:`<p>Installing extension files to device...</p>
             ...
             </div>`,buttons:[]});try{stopStatusInfoPolling();const h=(v,...y)=>v.reduce((w,S,x)=>w+S+(y[x]||""),""),m=instantiateExtension(a.content,d,l.emit.bind(l),h);if(typeof m.onInstall=="function"){updateModalBody(`<p>Writing files to device...</p>
          <div style="margin-top: 16px; color: var(--text-secondary);">
