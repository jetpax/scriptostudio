    ...
    <div class="panel-section">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <span class="info-value info-mono">${"d99884c"}</span>
        </div>
        <div class="info-item">
    ...
    <div class="landing-view">
      <div class="landing-container">
        ...
        <div class="landing-scenario-grid">
          <div class="landing-scenario-card" onclick=${()=>openExternal("https://scriptohub.ai/extensions")}>
          ...
          <div class="landing-scenario-card" onclick=${()=>openExternal("https://scriptohub.ai/skills")}>
            <div class="landing-scenario-icon">
