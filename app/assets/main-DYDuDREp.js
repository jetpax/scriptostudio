    ...
    <div class="panel-section">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <span class="info-value info-mono">${"d650b17"}</span>
        </div>
        <div class="info-item">
        ...
        ${s?html$1`
          ...
          `:html$1`
            <div class="fw-firmware-info">
              <p style="font-weight: 500; margin-bottom: 0.25rem;">${s.displayName}</p>
              <p style="font-size: 0.8rem; color: var(--text-secondary);">
                ${s.version?`pyDirect ${s.version}`:""}
                ${s.version&&s.size?" · ":""}
