const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/tree-sitter-bNTnDsZt.js","assets/vendor-DA8ypj4B.js","assets/vendor-CeCKEaxg.js","assets/vendor-C1PjELkX.css","assets/index-BalQ1Nwo.js","assets/index-DXz9816u.js","assets/index-C67KyK7a.js","assets/index-BlIhKDWf.js","assets/index-DdUpN0Lu.js","assets/index-ByjkoLU-.js","assets/xterm-DOrYoP_4.css"])))=>i.map(i=>d[i]);
import{PANEL_TOO_SMALL as St,PANEL_CLOSED as oe,PANEL_DEFAULT as Ge}from"./vendor-DA8ypj4B.js";import{c as me,C as Et,h as C,a as $t,b as kt}from"./vendor-CeCKEaxg.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();function de(e){const n="# === START_CONFIG_PARAMETERS ===",t="# === END_CONFIG_PARAMETERS ===",o=e.indexOf(n),i=e.indexOf(t);if(o===-1||i===-1)return console.warn("[ScriptOs Parser] Config markers not found"),null;const s=e.substring(o+n.length,i).trim();try{return _t(s)}catch(c){return console.error("[ScriptOs Parser] Failed to parse config:",c),null}}function _t(e){let n=e.trim();n.startsWith("dict(")&&n.endsWith(")")&&(n=n.substring(5,n.length-1).trim()),n=n.split(`
...
`}),r+=`${e}_ds.st()
`,r}async function hn(e,n={}){const{watches:t={},conditionalBP:o={},fileName:i="main.py"}=n,s=performance.now(),c=await qt(e);console.log(`[Debugger] Identified ${c.size} code rows in ${performance.now()-s}ms`);let r=e.split(/\r?\n/);const a=new Map,l=t[""]||[],d=t[i]||[],p=[...new Set([...l,...d])],u=o[""]||[],f=o[i]||[],g=[...new Set([...u,...f])],h=Array.from(c.keys()).sort((O,x)=>O-x);for(const O of h){const x=r[O],L=c.get(O);if(x===void 0)continue;const T=/# ●/.test(x),W=n.breakpoints&&n.breakpoints[i]?n.breakpoints[i][O+1]:null;(T||W)&&console.log(`[Debugger] Breakpoint detected at line ${O+1}: ${x}`);const z=x.match(/^(\s*)/)[1];let N=Gt(z,T,i,O+1,p,g,W);L==="function_definition"?N+=`${z}@_ds.wrap
`:L==="async_function_definition"&&(N+=`${z}@_ds.awrap
`),T&&console.log(`[Debugger] Generated instrumentation for row ${O+1} (${L})`),a.set(O,N)}let w=[];for(let O=0;O<r.length;O++)a.has(O)&&w.push(a.get(O)),w.push(r[O]);const E=w.join(`
`),P=`${Wt}

# Execute isolated code
_ds.exec("""${E.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/'/g,"\\'")}""")
`,k=performance.now()-s;return console.log(`[Debugger] Instrumentation complete in ${k.toFixed(0)}ms`),P}console.log("[Libs] ES modules loaded");function Vt(e,n={}){const{className:t="",size:o=24,color:i="currentColor"}=n;return C`
...
`),n.currentLine="",n.cursorPos=0,n.historyIndex=-1,e.write(G);else if(o===""||o==="\b")n.cursorPos>0&&(t.isCommandRunning&&t.isCommandRunning()?(n.currentLine=n.currentLine.slice(0,-1),n.cursorPos--,e.write("\b \b")):(n.currentLine=n.currentLine.slice(0,n.cursorPos-1)+n.currentLine.slice(n.cursorPos),n.cursorPos--,Q(e,n.currentLine,n.cursorPos,t)));else if(o.length>=1){const i=o.split("").filter(s=>{const c=s.charCodeAt(0);return c>=32&&c<127}).join("");i.length>0&&(t.isCommandRunning&&t.isCommandRunning()?(n.currentLine+=i,n.cursorPos+=i.length,e.write(i)):(n.currentLine=n.currentLine.slice(0,n.cursorPos)+i+n.currentLine.slice(n.cursorPos),n.cursorPos+=i.length,Q(e,n.currentLine,n.cursorPos,t)))}e.scrollToBottom()})}async function Zt(e,n=null){const t=()=>`\x1B[3m${e}\x1B[0m`;return typeof figlet<"u"&&typeof figlet=="function"?ye(e,figlet,n).catch(()=>t()):document.querySelector('script[src*="figlet"]')?typeof figlet<"u"&&typeof figlet=="function"?ye(e,figlet,n).catch(()=>t()):new Promise(i=>{let s=0;const c=setInterval(()=>{s++,typeof figlet<"u"&&typeof figlet=="function"?(clearInterval(c),ye(e,figlet,n).then(i).catch(()=>i(t()))):s>50&&(clearInterval(c),i(t()))},100)}):new Promise(i=>{const s=document.createElement("script");s.src="https://cdn.jsdelivr.net/npm/figlet@1.7.0/lib/figlet.js",s.onload=()=>{setTimeout(()=>{typeof figlet<"u"&&typeof figlet=="function"?ye(e,figlet,n).then(i).catch(()=>i(t())):i(t())},100)},s.onerror=()=>{i(t())},document.head.appendChild(s)})}function ye(e,n,t=null){return new Promise(o=>{n.defaults&&n.defaults({fontPath:"https://cdn.jsdelivr.net/npm/figlet@1.7.0/fonts"});const i=["Slant","Standard","Block","Small","Big"],s=t?[t,...i.filter(a=>a!==t)]:i;let c=0;const r=()=>{if(c>=s.length){o(`\x1B[3m${e}\x1B[0m`);return}const a=s[c++];n(e,a,(l,d)=>{l||!d||d.length<=e.length*3?r():o(d)})};r()})}let ke=null,_e=null,yn=!1;async function rt(){if(yn)return{Terminal:ke,FitAddon:_e};try{const[e,n]=await Promise.all([R(()=>import("./xterm-CASmyfyk.js"),[]),R(()=>import("./addon-fit-DOCEibfw.js"),[]),R(()=>Promise.resolve({}),__vite__mapDeps([10]))]);return ke=e.Terminal,_e=n.FitAddon,yn=!0,console.debug("[XTerm] Lazy loaded xterm modules"),{Terminal:ke,FitAddon:_e}}catch(e){throw console.error("[XTerm] Failed to load xterm:",e),e}}rt();class H extends $t{constructor(n,t,o){super(n),this.term=null,this.fitAddon=null,this.resizeObserver=null,this.inputBound=!1,this._emit=o}load(n){if(this.term){console.debug("[XTerm] Reusing existing terminal instance (no re-open needed)");const t=this.term.element?.parentElement;t&&n.appendChild(t),this.resizeObserver&&this.resizeObserver.disconnect(),this.resizeObserver=new ResizeObserver(()=>{setTimeout(()=>this.fitTerminal(),50)}),this.resizeObserver.observe(n),setTimeout(()=>this.fitTerminal(),50),setTimeout(()=>this.fitTerminal(),150);return}rt().then(()=>this.ensureFontsLoaded()).then(()=>this.createAndOpenTerminal(n)).catch(t=>{console.error("[XTerm] Failed to initialize terminal:",t),n.innerHTML='<div style="color:red;padding:10px;">Terminal failed to load. Check console for errors.</div>'})}async ensureFontsLoaded(){if(document.fonts&&document.fonts.ready)try{return await document.fonts.ready,document.fonts.check&&await new Promise(n=>setTimeout(n,50)),Promise.resolve()}catch{return new Promise(t=>setTimeout(t,200))}else return new Promise(n=>setTimeout(n,200))}createAndOpenTerminal(n){this.term=new ke({fontFamily:"CodeFont, Cascadia Code, Menlo, Monaco, Consolas, monospace",fontSize:14,letterSpacing:0,cursorBlink:!0,cursorStyle:"block",scrollback:1e3,theme:{foreground:"#33ff33",background:"#000000",cursor:"#FFFFFF",cursorAccent:"#000000"}}),this.term.open(n),this.fitAddon=new _e,this.term.loadAddon(this.fitAddon),setTimeout(()=>this.fitTerminal(),50),setTimeout(()=>this.fitTerminal(),150),setTimeout(()=>this.fitTerminal(),300),setTimeout(()=>this.fitTerminal(),600);let t=null;const o=()=>{t&&clearTimeout(t),t=setTimeout(()=>this.fitTerminal(),100)};this.resizeObserver=new ResizeObserver(o),this.resizeObserver.observe(n);const i=n.closest(".repl-panel-main");i&&this.resizeObserver.observe(i)}createElement(){return C`<div class="terminal-wrapper"></div>`}update(){return this.fitAddon&&setTimeout(()=>this.fitTerminal(),50),!1}unload(){this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null)}fitTerminal(){if(!(!this.term||!this.fitAddon))try{this.fitAddon.fit(),this.term.refresh&&this.term.refresh(0,this.term.rows-1)}catch(n){console.warn("[XTerm] Fit failed:",n)}}resizeTerm(){this.fitTerminal()}bindInput(n,t){return this.inputBound||!this.term?!1:(console.debug("[XTerm] Binding input handler"),this.inputBound=!0,this.term.textarea&&this.term.textarea.addEventListener("focus",()=>{this._emit&&this._emit("terminal-focus")}),Qt(this.term,n,t),!0)}isInputBound(){return this.inputBound}}function ei(e,n){if(e.editingFile){const t=e.openFiles.find(o=>o.id==e.editingFile);return t?t.editor.render():(console.error("[CodeEditor] File not found for id:",e.editingFile),C`<div id="code-editor">File not found</div>`)}else return C`
  ...
  `;if(e.isConnectionDialogOpen)return d}function ti(e="/"){return`
import os, json
S_IFDIR = 0x4000
S_IFREG = 0x8000
...
print(json.dumps({'path': dir_path, 'entries': entries_dict}))`.trim()}function ii(e){return`
import os
S_IFDIR = 0x4000
def S_ISDIR(m): return (m & 0xF000) == S_IFDIR
def _join(p1, p2):
...
`;if(e.isNewFileDialogOpen){const u=p.querySelector("#dialog-new-file .dialog-content > input");return u&&u.focus(),p}}function mi(e,n){return e.isScriptOsModalOpen?html`
    <div class="scriptos-modal-overlay" onclick=${t=>{t.target.classList.contains("scriptos-modal-overlay")&&n("close-scriptos-modal")}}>
      <div class="scriptos-modal">
        ...
        ${e.scriptOsModalView==="library"?vi(e,n):yi(e,n)}
      </div>
    </div>
  `:html`<div></div>`}function vi(e,n){if(e.scriptOsCategoryCollapse||(e.scriptOsCategoryCollapse={}),e.isLoadingRegistry)return html`
  ...
  `}function yi(e,n){const t=e.selectedScriptOs;if(!t)return html`<div>Loading...</div>`;const o=t.config.info||{},i=t.config.args,s=i&&typeof i=="object"&&Object.keys(i).length>0;let c="v1.0.0";return o.version&&(Array.isArray(o.version)?c=`v${o.version.join(".")}`:c=`v${o.version}`),html`
  ...
  `}function wi(e,n,t){const o=Object.keys(e);return html`
  ...
  `}function bi(e,n,t,o){const i=n.type,s=t.scriptOsArgs[e],c=n.value!==void 0?n.value:null;switch(i){case"str":return html`
        <input 
          type="text" 
          id="arg-${e}"
      ...
      `;default:return html`
        ...
        />
      `}}function Ci(e,n){if(!e.scriptOsUiModal||!e.scriptOsUiModal.isOpen)return html`<div></div>`;const{url:t,title:o}=e.scriptOsUiModal;return html`
    <div 
  ...
  `}function xi(e,n){return!e.isExtensionsModalOpen&&!e.installingDependencies&&!e.dependencyPrompt?html`<div></div>`:e.dependencyPrompt?Si(e,n):e.installingDependencies?Ei(e):html`
  ...
  `}function Si(e,n){const{extensionId:t,extensionName:o,dependencies:i}=e.dependencyPrompt,s=i?.mipPackage||"";return html`
  ...
  `}function $i(e,n){const t=e.availableExtensions||[],o=e.installedExtensions||[],i=new Set(o.map(r=>r.id)),s=t.filter(r=>!i.has(r.id)),c=(r,a)=>{for(let l=0;l<3;l++){const d=r[l]||0,p=a[l]||0;if(d>p)return!0;if(d<p)return!1}return!1};return t.length===0?html`
      <div class="scriptos-library">
        <div class="scriptos-header-sticky">
           <div class="scriptos-header">
            <h2>Extensions</h2>
  ...
  `}function $n(e){const n={sliders:html`
    ...
    `};return n[e]||n.cpu}function ki(e,n){const t=e.isResetDialogOpen?"open":"closed";function o(r){r.target.id==="dialog-reset"&&n("close-reset-dialog")}function i(){n("trigger-reset",0)}async function s(){confirm(`HARD RESET WARNING:
...
Are you sure you want to proceed?`)&&n("trigger-reset",1)}e.isResetDialogOpen&&window.addEventListener("keydown",function r(a){a.key==="Escape"&&(n("close-reset-dialog"),window.removeEventListener("keydown",r))},{once:!0});const c=html`
  ...
  `;if(e.isResetDialogOpen)return c}function _i(e,n){if(!e.debugger||!e.debugger.configOpen)return html``;const t=e.openFiles.filter(c=>c.fileName&&c.fileName.endsWith(".py")),i=(e.debugger.watchExpressions[""]||[]).join(`
`),s=e.debugger.active;return html`
  ...
  `}function Ti(e,n){if(!e.debugger||!e.debugger.breakpointModalOpen)return html`<div></div>`;const{file:t,line:o}=e.debugger.editingBreakpoint,i=e.debugger.breakpoints[t][o]||{condition:"",hitCount:"",enabled:!0},s=()=>{n("debugger:save-breakpoint",{file:t,line:o,config:i})},c=()=>{n("debugger:delete-breakpoint",{file:t,line:o})},r=()=>{n("debugger:close-breakpoint-modal")};return html`
  ...
  `}function Pi(e,n,t){const o=e.activeExtension,i=e.activeExtensionPanel;if(!o||!i)return t`
    ...
    `}}function Ni(e,n){return e.aiAgent.isOpen?html`
    <div class="agent-sidebar">
      ...
      <div class="agent-sidebar-messages" id="agent-messages">
        ...
        `:e.aiAgent.messages.map(t=>Ii(t,n))}
  ...
  `:html`<div></div>`}function Ii(e,n){const t=new Date(e.timestamp).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return e.role==="user"?html`
    ...
    `:e.role==="assistant"?html`
      <div class="agent-message agent-message-assistant">
        ...
        <div class="agent-message-content">
          <div class="agent-message-text">${Oi(e.content)}</div>
          ${e.code?html`
...
`;this.term.write(f),this.state.logs?.autoScroll!==!1&&this.term.scrollToBottom()}cleanup(){this.writeHandler&&(window.removeEventListener("log-terminal-write",this.writeHandler),this.writeHandler=null),this.clearHandler&&(window.removeEventListener("log-terminal-clear",this.clearHandler),this.clearHandler=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this.term&&(this.term.dispose(),this.term=null),this.fitAddon=null}}let we=null;function Ai(e,n){if(!e.logs.isOpen)return we=null,null;we||(we=new Di("log-terminal",e,n));const t=we.render(e),o=e.logSidebarWidth||350;return html`
  ...
  `}function Ri(e,n){const{isConnected:t,selectedFiles:o}=e;return html`
  <div id="file-actions">
    ${F({icon:"edit",size:"small",disabled:!gi({selectedFiles:e.selectedFiles}),onClick:()=>n("open-selected-files")})}
    ${F({icon:"arrow-left",size:"small",background:"inverted",active:!0,disabled:!fi({isConnected:t,selectedFiles:o}),onClick:()=>n("upload-files")})}
    ${F({icon:"arrow-right",size:"small",background:"inverted",active:!0,disabled:!pi({isConnected:t,selectedFiles:o}),onClick:()=>n("download-files")})}
    ${F({icon:"trash",size:"small",disabled:e.selectedFiles.length===0,onClick:()=>n("remove-files")})}
  </div>

  `}const Li=ft("disk"),Mi=ft("board");function ft(e){return function(t,o){function i(u){u.key.toLowerCase()==="enter"&&u.target.blur(),u.key.toLowerCase()==="escape"&&(u.target.value=null,u.target.blur())}const s=html`
      <div class="item">
    ...
    `;function r(u,f){const g=html`
        <input type="text"
          value=${u.fileName}
          onkeydown=${i}
          onblur=${T=>o("finish-renaming-file",T.target.value)}
          onclick=${T=>!1}
          ondblclick=${T=>!1}
          />
      `,h=t.selectedFiles.find(T=>T.fileName===u.fileName&&T.source===e);function w(T){return T.preventDefault(),o("rename-file",e,u),!1}function E(){t.renamingFile||o(`navigate-${e}-folder`,u.fileName)}function P(){t.renamingFile||o("open-file",e,u)}let k=u.fileName;const O=t.selectedFiles.find(T=>T.fileName===k);t.renamingFile==e&&O&&(k=g);function x(T){if(T==null)return"";if(T===0)return"0 B";const W=1024,z=["B","KB","MB","GB"],N=Math.floor(Math.log(T)/Math.log(W));return parseFloat((T/Math.pow(W,N)).toFixed(1))+" "+z[N]}const L=u.type==="file"?x(u.size):"";return u.type==="folder"?html`
          <div
            class="item ${h?"selected":""}"
            onclick=${T=>o("toggle-file-selection",u,e,T)}
            ondblclick=${E}
            >
            ${y.renderIcon("folder",{className:"icon"})}
  ...
  ..
    ...
    `;return new MutationObserver(u=>{const f=d.querySelector("input");f&&f.focus()}).observe(d,{childList:!0,subtree:!0}),d}}function Bi(e,n){const t=()=>{e.panelHeight>oe?n("close-panel"):n("open-panel")};e.isPanelOpen;const o=e.panelHeight>St?"visible":"hidden";let i="terminal-enabled";return(!e.isConnected||e.isNewFileDialogOpen)&&(i="terminal-disabled"),C`
  ...
  `}function Wi(e,n){let t=html`<div id="overlay" class="closed"></div>`;if(e.diskFiles==null&&(n("load-disk-files"),t=html`<div id="overlay" class="open"><p>Loading files...</p></div>`),e.isRemoving&&(t=html`<div id="overlay" class="open"><p>Removing...</p></div>`),e.isConnecting&&(t=html`<div id="overlay" class="open"><p>Connecting...</p></div>`),e.isLoadingFiles&&(t=html`<div id="overlay" class="open"><p>Loading files...</p></div>`),e.isSaving&&(t=html`<div id="overlay" class="open"><p>Saving file... ${e.savingProgress}</p></div>`),e.isTransferring){const o=String(e.transferringProgress||""),i=o.match(/(\d+)%?$/),s=i?parseInt(i[1]):0,c=o.match(/^(.+?):/),r=c?c[1]:"file";t=html`
    ...
    `}return t}const ge="ScriptO Studio © JetPax 2026";function Hi(e){const n=(e||0)*60,t=Math.floor(n/86400),o=Math.floor(n%86400/3600),i=Math.floor(n%3600/60),s=Math.floor(n%60),c=[];return t>0&&c.push(`${t}d`),o>0&&c.push(`${o}h`),i>0&&c.push(`${i}m`),(s>0||c.length===0)&&c.push(`${s}s`),c.join(" ")}function Xe(e,n){if(!e)return{connected:!1,disconnectedText:ge,ram:null,temp:null,uptime:null,rssi:null};const t=e.mem||{},o=e.temp,i=e.uptime||0,s=e.wifi_rssi,c=t.alloc||0,r=t.free||0,a=c+r,l=(c/1024).toFixed(2),d=(a/(1024*1024)).toFixed(2);let p=null;o!=null&&((n||"degC")==="degF"?p=`${(o*9/5+32).toFixed(1)}°F`:p=`${o.toFixed(1)}°C`);const u=Hi(i);let f=null;return s!=null&&(f=`${s} dBm`),{connected:!0,disconnectedText:ge,ram:`${l} KB / ${d} MB`,temp:p,uptime:u,rssi:f}}function qi(e,n){const t=Xe(e.isConnected?e.statusInfo:null,e.temperatureUnit||"degC");if(!t||!t.connected){const o=t&&t.disconnectedText||ge;return html`
  ...
  `}function Gi(e,n){const t=window.html||(()=>{}),o=e.locale||"en",i=window.i18n?window.i18n.getAvailableLocales():["en","de","es","fr"],s={en:"English",de:"Deutsch",es:"Español",fr:"Français"},c=window.i18n?window.i18n.t("language"):"Language";return t`
  ...
  `}typeof window<"u"&&(window.LanguageSelector=Gi);function kn(e,n){const t=window.i18n?window.i18n.t:o=>o;return html`
  ...
  `}function Vi(e){const n={light:html`
  ...
  `}function Ki(e,n){const t=window.i18n?window.i18n.t:i=>i;if(!e.systemInfo&&e.isConnected&&!e.isLoadingSystemInfo&&!e.systemInfoAttempted&&(e.systemInfoAttempted=!0,n("refresh-system-info")),!e.systemInfo)return e.isConnected?html`
      <div class="panel-container">
  ...
  `}function Xi(e,n){const t=e.os||{};return html`
    <div class="panel-section">
  ...
  `}function Yi(e,n){return!e.partitions||e.partitions.length===0?"":html`
    <div class="panel-section">
  ...
  `}function Qi(e,n){return{0:"APP",1:"DATA"}[e]||`Type ${e}`}function Zi(e){if(!e)return"📦";const n=e.toLowerCase();return n.includes("ota")?"🔄":n.includes("nvs")?"💾":n.includes("www")?"🌐":n.includes("vfs")?"📁":n.includes("data")?"💿":n.includes("factory")?"🏭":"📦"}function gt(e){return e?e<1024?e+" B":e<1024*1024?(e/1024).toFixed(1)+" KB":(e/(1024*1024)).toFixed(2)+" MB":"N/A"}function Tn(e,n){if(!e.networksInfo&&e.isConnected&&!e.isLoadingNetworks&&n("refresh-networks"),!e.networksInfo)return html`
      <div class="panel-container">
        <div class="panel-header">
  ...
  `:""}function to(e,n){if(!e.networksInfo&&e.isConnected&&!e.isLoadingNetworks&&n("refresh-networks"),e.isConnected&&!e.ethConfigLoaded&&!e.isLoadingEthConfig&&n("load-eth-config"),!e.networksInfo)return html`
      <div class="panel-container">
        <div class="panel-header">
  ...
  `:html`
    ...
    `}function io(e,n){e.isConnected&&!e.vpnConfigLoaded&&!e.isLoadingVpnConfig&&n("load-vpn-config");const t=e.vpnConfig||{hostname:"",join_code:"",auto_connect:!1},o=e.networksInfo?.vpn,i=e.isConnected,s=e.networksInfo&&o!==void 0;!s||o.available;const c=s&&o.active;return html`
    <div class="panel-container">
      <div class="panel-header">
  ...
  `}function oo(e,n){if(!e.networksInfo&&e.isConnected&&!e.isLoadingNetworks&&n("refresh-networks"),!e.networksInfo)return html`
      <div class="panel-container">
        <div class="panel-header">
  ...
  `}function ro(e,n){e.isConnected&&!e.mqttConfigLoaded&&!e.isLoadingMqttConfig&&n("load-mqtt-config");const t=e.mqttConfig||{};return html`
    <div class="panel-container">
      <div class="panel-header">
  ...
  `}function ao(e,n){e.isConnected&&!e.ntpConfigLoaded&&!e.isLoadingNtpConfig&&n("load-ntp-config");const t=e.ntpConfig||{server:"pool.ntp.org",timezone:"UTC",autoDetect:!1,autoSync:!1},o=e.ntpSyncResult||null,i=r=>{if(!r)return"--:--:--";const{year:a,month:l,day:d,hour:p,minute:u,second:f}=r;return`${String(p).padStart(2,"0")}:${String(u).padStart(2,"0")}:${String(f).padStart(2,"0")}`},s=r=>{if(!r)return"";const{year:a,month:l,day:d}=r;return`${a}-${String(l).padStart(2,"0")}-${String(d).padStart(2,"0")}`},c=[{value:"UTC",offset:0,label:"UTC (Coordinated Universal Time)"},{value:"EST",offset:-5,label:"EST (Eastern Standard Time)"},{value:"CST",offset:-6,label:"CST (Central Standard Time)"},{value:"MST",offset:-7,label:"MST (Mountain Standard Time)"},{value:"PST",offset:-8,label:"PST (Pacific Standard Time)"},{value:"GMT",offset:0,label:"GMT (Greenwich Mean Time)"},{value:"CET",offset:1,label:"CET (Central European Time)"},{value:"EET",offset:2,label:"EET (Eastern European Time)"},{value:"JST",offset:9,label:"JST (Japan Standard Time)"},{value:"AEST",offset:10,label:"AEST (Australian Eastern Standard Time)"}];return html`
    <div class="panel-container">
      ...
      <div class="panel-section">
        ...
        <form class="config-form" onsubmit=${async r=>{r.preventDefault();const a=new FormData(r.target),l=a.get("server")||"pool.ntp.org",d=a.get("timezone")||"UTC",p=a.get("auto_detect")==="on",u=a.get("auto_sync")==="on",f=c.find(w=>w.value===d),g=f?f.offset:0,h={server:l,tz_offset:g,timezone:d,auto_detect:p,auto_sync:u};try{await new Promise((w,E)=>{const P=setTimeout(()=>E(new Error("Save timeout")),1e4),k=()=>{clearTimeout(P),window.appInstance.emitter.removeListener("ntp-config-saved",O),window.appInstance.emitter.removeListener("ntp-config-save-error",x)},O=()=>{k(),w()},x=L=>{k(),E(L)};window.appInstance.emitter.once("ntp-config-saved",O),window.appInstance.emitter.once("ntp-config-save-error",x),n("save-ntp-config",h)}),n("sync-ntp-time",l,g,p,u)}catch(w){console.error("[NTP] Failed to save config before sync:",w),alert(`Failed to save NTP configuration: ${w.message}`)}}}>
          <div class="form-group">
  ...
  `}function lo(e,n){e.isConnected&&!e.canConfigLoaded&&!e.isLoadingCanConfig&&n("load-can-config");const t=e.canConfig||{bitrate:5e5,enabled:!0};return html`
    <div class="panel-container">
      <div class="panel-header">
            ...
            <div class="info-grid" style="margin-top: 1rem;">
              ...
              ${t.date?html`
                <div class="info-item">
                  ...
                  <span class="info-value info-mono">${co(t.date)}</span>
                </div>
              `:""}
              ${t.time?html`
                <div class="info-item">
                  <span class="info-label">Time:</span>
                  <span class="info-value info-mono">${uo(t.time)}</span>
                </div>
              `:""}
            </div>
  ...
  `}function co(e){if(!e||e.length!==6)return e;const n=e.substring(0,2),t=e.substring(2,4),o="20"+e.substring(4,6);return`${n}/${t}/${o}`}function uo(e){if(!e)return e;const n=e.indexOf("."),t=n!==-1?e.substring(0,n):e;if(t.length!==6)return e;const o=t.substring(0,2),i=t.substring(2,4),s=t.substring(4,6);return`${o}:${i}:${s}`}function po(e,n){e.isConnected&&!e.modemStatusLoaded&&!e.isLoadingModemStatus&&n("load-modem-status");const t=e.modemStatus||{},o=t.info||{},i=t.signal||{},s=t.ppp||{},c=i.dbm,r=fo(c),a=go(c),l=ho(c);let d="Not detected",p="status-disconnected";return t.connected&&(s.connected?(d="PPP Active",p="status-ppp"):s.connecting?(d="PPP Connecting...",p="status-connecting"):(d="Connected (AT)",p="status-connected")),html`
    <div class="panel-container">
      <div class="panel-header">
        <h2>Modem</h2>
      </div>
  ...
  `}function fo(e){return e==null||e===-999?0:e>=-70?5:e>=-80?4:e>=-90?3:e>=-100?2:e>=-110?1:0}function go(e){return e==null||e===-999?"Unknown":e>=-70?"Excellent":e>=-80?"Good":e>=-90?"Fair":e>=-100?"Poor":"Very Poor"}function ho(e){return e==null||e===-999?"var(--text-secondary)":e>=-70||e>=-80?"#22c55e":e>=-90||e>=-100?"#f59e0b":"#ef4444"}function mo(e,n){const o=e.boardConfig?.hardware?.sdcard;e.isConnected&&!e.sdcardConfigLoaded&&!e.isLoadingSdcardConfig&&n("load-sdcard-config"),o&&e.isConnected&&!e.sdcardInfo&&!e.isLoadingSdcardInfo&&n("sdcard-get-info");const i=e.sdcardConfig||{mountPoint:"/sd",autoMount:!1};return e.isConnected?o?html`
    <div class="panel-container">
      <div class="panel-header">
  ...
  `:html`
    ...
    `}function vo(e){if(!e)return"";const n=e.pins||{},t=e.power_control||{},o=e.mode||"SD";let i=1;n.d3!==void 0?i=4:n.d0!==void 0?i=1:o==="SD"&&(i=4);const s=o==="SD"?"SDMMC":o;return html`
    <div class="panel-section">
      <div class="section-header">
  ...
  `}function Ue(e){if(!e||e===0)return"0 B";const n=1024,t=["B","KB","MB","GB"],o=Math.floor(Math.log(e)/Math.log(n));return Math.round(e/Math.pow(n,o)*100)/100+" "+t[o]}const yo="https://api.github.com/repos/jetpax/pyDirect/releases",wo=["https://api.codetabs.com/v1/proxy?quest=","https://corsproxy.io/?","https://api.allorigins.win/raw?url="],bo=import.meta?.env?.DEV||window.location.hostname==="localhost";function Co(e){return bo&&e.startsWith("https://github.com/")?e.replace("https://github.com","/github-releases"):e}const xo={"ESP32-S3":"ESP32_S3","ESP32-P4":"ESP32_P4","ESP32-S2":"ESP32_S2","ESP32-C3":"ESP32_C3","ESP32-C6":"ESP32_C6",ESP32:"ESP32"};async function So(){try{const e=await fetch(yo);if(!e.ok)throw new Error(`GitHub API error: ${e.status}`);return(await e.json()).filter(t=>!t.draft).map(t=>({id:t.id,name:t.name||t.tag_name,tag:t.tag_name,published:t.published_at,prerelease:t.prerelease,assets:t.assets.filter(o=>o.name.startsWith("pyDirect-")&&o.name.endsWith("-merged.bin")).map(o=>({name:o.name,size:o.size,downloadUrl:o.browser_download_url}))})).filter(t=>t.assets.length>0)}catch(e){throw console.error("[firmware-flasher] Failed to fetch releases:",e),e}}async function Eo(){const e=await So();return e.find(t=>!t.prerelease)||e[0]||null}function $o(e,n){let t=e.replace(/_/g," ");if(n){const o=(n/1024/1024).toFixed(1);t+=` (${o} MB)`}return t}function ht(e,n){const t=xo[n];return t?e.assets.filter(i=>{const s=i.name.match(/^pyDirect-(.+)-merged\.bin$/);if(!s)return!1;const c=s[1];return!!(c.startsWith(t)||n==="ESP32-S3"&&(c==="RetroVMS_Mini"||c.includes("S3"))||n==="ESP32-P4"&&c.includes("P4"))}).map(i=>{const s=i.name.match(/^pyDirect-(.+)-merged\.bin$/),c=s?s[1]:i.name;return{...i,productId:c,displayName:$o(c,i.size)}}):(console.warn(`[firmware-flasher] No firmware mapping for chip: ${n}`),[])}function ko(e,n,t=null){const o=ht(e,n);if(o.length===0)return null;let i=o[0];const s=t?parseInt(t):0;if(s&&n==="ESP32-S3"&&s>=16){const c=o.find(r=>r.productId==="ESP32_S3_16MB");c&&(i=c)}if(s&&n==="ESP32-P4"&&s>=32){const c=o.find(r=>r.productId==="Waveshare_P4_POE"||r.productId==="ESP32_P4_32");c&&(i=c)}return i}async function _o(e,n=()=>{}){let t;const o=Co(e);o!==e&&console.log("[firmware-flasher] Using Vite dev proxy for download");try{if(t=await fetch(o),!t.ok)throw new Error(`HTTP ${t.status}`)}catch(s){console.log("[firmware-flasher] Direct download failed:",s.message,"- trying CORS proxies");let c;for(const r of wo)try{if(console.log("[firmware-flasher] Trying proxy:",r),t=await fetch(r+encodeURIComponent(e)),t.ok){console.log("[firmware-flasher] Proxy succeeded:",r);break}c=new Error(`HTTP ${t.status}`)}catch(a){c=a,console.log("[firmware-flasher] Proxy failed:",r,a.message)}if(!t||!t.ok)throw console.error("[firmware-flasher] All proxies failed"),new Error(`Failed to fetch firmware: ${c?.message||"All proxies failed"}`)}try{const s=t.headers.get("content-length"),c=s?parseInt(s,10):0;if(console.log(`[firmware-flasher] Content-Length: ${s||"unknown"}, starting download...`),!t.body){console.log("[firmware-flasher] Using non-streaming fallback");const f=await t.arrayBuffer();return n(100),f}const r=t.body.getReader(),a=[];let l=0,d=Date.now();for(;;){const{done:f,value:g}=await r.read();if(f)break;if(a.push(g),l+=g.length,c>0)n(Math.round(l/c*100));else if(Date.now()-d>500){console.log(`[firmware-flasher] Downloaded ${(l/1024/1024).toFixed(1)} MB...`),d=Date.now();const w=10+l/1e6%80;n(Math.round(w))}}const p=new Uint8Array(l);let u=0;for(const f of a)p.set(f,u),u+=f.length;return console.log(`[firmware-flasher] Downloaded ${l} bytes (${(l/1024/1024).toFixed(1)} MB)`),n(100),p.buffer}catch(s){throw console.error("[firmware-flasher] Download error:",s),s}}let S=null,A=null,Pe="",Ne="",ie=!0,je=null,he=null,m={view:"connect",deviceInfo:null,releases:[],selectedFirmware:null,flashProgress:0,wifiNetworks:[],selectedNetwork:null,credentials:null,logs:[{message:"> Ready",type:"info",timestamp:new Date().toLocaleTimeString()}],isFlashing:!1,isScanning:!1,terminalCollapsed:!1,reblessComplete:!1,reblessHostname:null,flashStep:"select",currentRelease:null,firmwareOptions:[],flashComplete:!1,isNewDeviceFlow:!1};function v(e,n="info"){m.logs.push({message:`> ${e}`,type:n,timestamp:new Date().toLocaleTimeString()}),m.logs.length>100&&(m.logs=m.logs.slice(-100)),_()}function nn(){m.logs=[]}function _(){document.dispatchEvent(new CustomEvent("firmware-panel-update"))}async function tn(e){await e.setSignals({dataTerminalReady:!1,requestToSend:!1}),await new Promise(n=>setTimeout(n,50)),await e.setSignals({dataTerminalReady:!1,requestToSend:!0}),await new Promise(n=>setTimeout(n,100)),await e.setSignals({dataTerminalReady:!1,requestToSend:!1}),await new Promise(n=>setTimeout(n,100))}async function on(){A&&(await A.disconnect(),A=null,await new Promise(r=>setTimeout(r,100))),await S.close(),await new Promise(r=>setTimeout(r,100)),await S.open({baudRate:115200}),v("Resetting device..."),await tn(S),v("Waiting for System booting...");const e=S.readable.getReader(),n=new TextDecoder;let t="";const o=Date.now();let i=!1,s=null;const c=[{pattern:/invalid header: 0x[0-9a-fA-F]+/i,message:"Invalid firmware header - incompatible image for this device"},{pattern:/flash read err/i,message:"Flash read error - firmware may be corrupted"},{pattern:/ets_main\.c/i,message:"Boot failure - firmware not recognized"},{pattern:/rst:0x10.*boot:0x[0-9a-f]+.*invalid/i,message:"Boot loop detected - firmware incompatible"}];for(;Date.now()-o<8e3;){const{value:r,done:a}=await e.read();if(a)break;if(r){t+=n.decode(r);for(const{pattern:l,message:d}of c)if(l.test(t)){s=d,console.log("[transitionToREPL] Boot error detected:",t);break}if(s)break;if(t.includes("System booting...")){i=!0,v("System booting detected","success"),e.releaseLock();const l=S.writable.getWriter();await l.write(new Uint8Array([3,3,3])),await new Promise(d=>setTimeout(d,30)),await l.write(new Uint8Array([3,3])),l.releaseLock(),v("Interrupting to enter REPL...");break}}}if(!i)try{e.releaseLock()}catch{}if(s)return v(s,"error"),{success:!1,error:s,bootOutput:t};if(!i){v("No boot signature detected","error");const r=S.writable.getWriter();return await r.write(new Uint8Array([3,3])),r.releaseLock(),{success:!1,error:"No boot signature from device - firmware may be incompatible",bootOutput:t}}await new Promise(r=>setTimeout(r,200)),v("Entering REPL mode...");try{const r=S.readable.getReader(),a=setTimeout(()=>r.cancel(),500);try{for(;;){const{value:l,done:d}=await r.read();if(d)break}}catch{}clearTimeout(a),r.releaseLock()}catch(r){console.log("[DRAIN] Error:",r)}return v("REPL ready"),{success:!0}}function mt({variant:e="",icon:n,title:t,subtitle:o,body:i,buttons:s}){return new Promise(c=>{const r=document.createElement("div");r.className="fw-modal-overlay active",r.innerHTML=`
      ...
      </div>`,document.body.appendChild(r),s.forEach(a=>{r.querySelector(`[data-id="${a.id}"]`).addEventListener("click",()=>{r.remove(),c(a.id)})})})}async function sn(e){await mt({variant:"danger",icon:'<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>',title:"Boot Failure Detected",subtitle:"Incompatible firmware image",body:`<p><strong>${e}</strong></p><p>The device could not boot. This typically happens when the wrong firmware variant is flashed.</p>`,buttons:[{id:"reflash",class:"fw-styled-modal-btn-primary",icon:'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" style="margin-right:0.5rem"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>',label:"Return to Bootloader"},{id:"close",class:"fw-styled-modal-btn-cancel",label:"Close"}]})==="reflash"&&(v("Returning to bootloader mode..."),v('Ready for re-flash. Select "Onboard New Device" to flash correct firmware.',"success")),m.view="scenarios",_()}async function U(e,n,t=15e3,o=!0){const i=e.writable.getWriter();try{const s=n.split(`
`).filter(g=>g.trim().length>0),c=Math.min(...s.map(g=>{const h=g.match(/^(\s*)/);return h?h[1].length:0})),r=s.map(g=>g.slice(c)).join(`
`);o&&(await i.write(new Uint8Array([1])),await new Promise(g=>setTimeout(g,100)));const a=new TextEncoder().encode(r),l=64;for(let g=0;g<a.length;g+=l){const h=a.slice(g,Math.min(g+l,a.length));await i.write(h),await new Promise(w=>setTimeout(w,10))}await new Promise(g=>setTimeout(g,50)),await i.write(new Uint8Array([4])),i.releaseLock();const d=e.readable.getReader();let p="";const u=new TextDecoder,f=Date.now();for(;Date.now()-f<t;){const{value:g,done:h}=await d.read();if(h||g&&(p+=u.decode(g),p.includes("OK")&&p.endsWith(">")))break}return d.releaseLock(),p}catch(s){try{i.releaseLock()}catch{}throw s}}const To={6790:{vendorName:"QinHeng Electronics",products:{29986:{name:"CH340",maxBaudrate:460800},29987:{name:"CH340",maxBaudrate:460800},21971:{name:"CH343",maxBaudrate:6e6},21972:{name:"CH9102",maxBaudrate:6e6}}},4292:{vendorName:"Silicon Labs",products:{6e4:{name:"CP2102(n)",maxBaudrate:3e6},60016:{name:"CP2105",maxBaudrate:2e6}}},1027:{vendorName:"FTDI",products:{24577:{name:"FT232R",maxBaudrate:3e6},24592:{name:"FT2232",maxBaudrate:3e6},24597:{name:"FT230X",maxBaudrate:3e6}}},12346:{vendorName:"Espressif Systems",products:{2:{name:"ESP32-S2 Native USB",maxBaudrate:2e6},4097:{name:"ESP32 Native USB",maxBaudrate:2e6},16386:{name:"ESP32 Native USB (CDC)",maxBaudrate:2e6}}}},Po={1:"Spansion/Infineon",11:"Samsung",28:"Eon/Puya",32:"Micron",104:"Atmel/Adesto",133:"Fudan",157:"ISSI",191:"Microchip/SST",194:"Macronix",200:"GigaDevice",239:"Winbond"},No={239:{16406:"W25Q32 (32 Mbit)",16407:"W25Q64 (64 Mbit)",16408:"W25Q128 (128 Mbit)",16409:"W25Q256 (256 Mbit)"},200:{16406:"GD25Q32 (32 Mbit)",16407:"GD25Q64 (64 Mbit)",16408:"GD25Q128 (128 Mbit)",16409:"GD25Q256 (256 Mbit)"},194:{16406:"MX25L3206 (32 Mbit)",16407:"MX25L6406 (64 Mbit)",16408:"MX25L12835 (128 Mbit)"}};function Io(e){try{const n=e.getInfo?.();if(!n||typeof n.usbVendorId!="number")return null;const t=n.usbVendorId,o=n.usbProductId,i=To[t];if(!i)return`Unknown (0x${t.toString(16).padStart(4,"0")})`;const s=i.products[o];return s?`${i.vendorName} - ${s.name} (0x${o.toString(16).toUpperCase()})`:`${i.vendorName} (0x${o?.toString(16).padStart(4,"0")||"????"})`}catch(n){return console.log("[getUsbBridgeInfo] Error:",n),null}}function Oo(e){if(!e||typeof e!="number")return null;const n=e&255,t=e>>8&255,o=e>>16&255,i=t<<8|o,s=Po[n],c=No[n]?.[i];return s&&c?`${s} ${c}`:s?`${s} (0x${i.toString(16).toUpperCase()})`:`0x${e.toString(16).padStart(6,"0").toUpperCase()}`}async function Fo(e){je||(je=(await R(()=>import("./tasmota-esptool.bundle-CejzY9o0.js"),[])).ESPLoader,console.log("[firmware-panel] ESPLoader module loaded"));const n={log:d=>console.log(d),debug:d=>console.debug(d),error:d=>console.error(d)},t=new je(e,n),o=Io(e);await t.initialize();const i=t.chipName||"Unknown";console.log("Connected to chip:",i);const s=t.macAddr(),c=Array.isArray(s)&&s.length>=6?s.slice(0,6).map(d=>d.toString(16).padStart(2,"0")).join(":"):"Unknown";let r="Unknown",a=null,l=115200;try{console.log("Running stub...");const d=await t.runStub();await d.detectFlashSize(),r=d.flashSize||"Unknown",console.log("Flash size detected:",r);try{const p=await d.flashId?.();p&&(a=Oo(p),console.log("Flash device:",a))}catch(p){console.log("Flash ID detection not available:",p)}l=d.transport?.baudrate||921600,A=d}catch(d){console.warn("Stub/Feature detection failed:",d),r="Detection Failed",A=t}return{chipName:i,flashSizeMB:r,macAddress:c,usbBridge:o,flashDevice:a,connectionBaud:l}}async function Do(){try{A&&(await A.disconnect(),A=null),S&&(await S.close(),S=null)}catch(e){console.log("Cleanup previous connection:",e)}try{nn(),v("Requesting serial port..."),S=await navigator.serial.requestPort({}),await S.open({baudRate:115200}),v("Port opened"),v("Detecting hardware...");const e=await Fo(S);Pe=e.chipName,Ne=e.macAddress,v(`Detected: ${Pe}`),v(`MAC: ${Ne}`),m.deviceInfo={chipName:Pe,mac:Ne,flashSize:e.flashSizeMB,usbBridge:e.usbBridge,flashDevice:e.flashDevice,connectionBaud:e.connectionBaud},ie=!0,m.view="scenarios",v("Device connected - select an action"),he&&(he.connectionMode="usb"),_()}catch(e){console.error("[firmware-panel]",e),v(`Error: ${e.message}`,"error");try{S&&await S.close()}catch{}S=null,A=null,_()}}async function Ao(){try{if(A&&(await A.disconnect(),A=null),S){try{await tn(S)}catch(e){console.log("[handleDisconnect] Reset error:",e)}await S.close(),S=null}}catch{}m.view="connect",m.deviceInfo=null,Pe="",Ne="",ie=!0,he&&(he.connectionMode=null),nn(),v("Disconnected"),_()}async function Ro(){try{if(A&&(await A.disconnect(),A=null),S){try{await tn(S)}catch(e){console.log("[resetAndClosePort] Reset error:",e)}await S.close(),S=null}}catch(e){console.log("[resetAndClosePort] Error:",e)}}function Ce(e){v(`Selected: ${e}`),m.view=e,e==="new-device"?Lo():e==="forgot-credentials"?zo():e==="change-wifi"?vt():e==="re-provision"&&jo(),_()}function De(){m.flashStep="select",m.flashComplete=!1,m.flashProgress=0,m.view="scenarios",_()}async function Lo(){try{v("Loading firmware options..."),m.flashStep="select",m.firmwareOptions=[],_();const e=await Eo();if(!e){v("No firmware releases found","error");return}m.currentRelease=e,v(`Found release: ${e.name}`);const n=m.deviceInfo?.chipName?.includes("ESP32-S3")?"ESP32-S3":m.deviceInfo?.chipName?.includes("ESP32-P4")?"ESP32-P4":m.deviceInfo?.chipName?.includes("ESP32-C3")?"ESP32-C3":m.deviceInfo?.chipName?.includes("ESP32")?"ESP32":null;if(!n){v("Unknown chip family - cannot select firmware","error");return}const t=ht(e,n);if(t.length===0){v(`No firmware available for ${n}`,"error");return}m.firmwareOptions=t;const o=m.deviceInfo?.flashSize,i=ko(e,n,o);m.selectedFirmware=i||t[0],v(`Found ${t.length} firmware option(s)`),v(`Selected: ${m.selectedFirmware.displayName||m.selectedFirmware.name}`),_()}catch(e){v(`Error: ${e.message}`,"error"),_()}}async function Mo(){if(!A){v("Error: No device connected","error");return}if(!m.selectedFirmware){v("Error: No firmware selected","error");return}if(!confirm(`⚠️ FLASH FIRMWARE ⚠️
...
Are you sure you want to continue?`)){v("Flash cancelled by user");return}try{m.flashStep="downloading",m.flashProgress=0,_(),v(`Downloading ${m.selectedFirmware.name}...`);const n=await _o(m.selectedFirmware.downloadUrl,t=>{m.flashProgress=t,t%20===0&&v(`Download: ${t}%`),_()});v(`Downloaded ${(n.byteLength/1024/1024).toFixed(1)} MB`),m.flashStep="flashing",m.flashProgress=0,_(),v("Syncing with device...");try{await A.sync()}catch{await A.initialize()}v("Flashing firmware...");try{await A.flashData(n,(t,o)=>{const i=Math.floor(t/o*100);m.flashProgress=i,i%10===0&&v(`Progress: ${i}%`),_()},0,!0)}catch(t){if((t?.message||String(t)).includes("Timed out")&&m.flashProgress>=95)v("Flash complete (device rebooted)");else throw t}v("✓ Flash complete!","success");try{await A.disconnect()}catch{}A=null,m.flashStep="complete",m.flashComplete=!0,m.terminalCollapsed=!0,_()}catch(n){console.error("[firmware-panel] Flash error:",n),v(`Flash failed: ${n.message}`,"error"),m.flashStep="select";try{S&&await S.close()}catch{}S=null,A=null,_()}}async function Bo(){v("Proceeding to WiFi setup..."),m.flashStep="select",m.flashComplete=!1,m.flashProgress=0,m.isNewDeviceFlow=!0,m.view="change-wifi";try{if(!S){v("Please reconnect device"),m.view="connect",_();return}vt()}catch(e){v(`Error: ${e.message}`,"error")}_()}async function zo(){try{v("Reading credentials from device...");const e=await on();if(!e.success){await sn(e.error);return}const t=(await U(S,`
import json
...
`)).match(/CREDS:(\{.*\})/);if(t){const o=JSON.parse(t[1]);m.credentials={hostname:o.h+".local",password:o.p,ssid:o.s},v(`Found: ${o.h}.local`,"success")}else throw new Error("Could not read settings - device may need firmware");_()}catch(e){v(`Error: ${e.message}`,"error"),_()}}async function vt(){nn();try{let r=function(a){return new Promise((l,d)=>{const p=document.createElement("div");p.className="fw-modal-overlay active",p.innerHTML=`
          <div class="fw-modal">
            <h3>
        ...
        `,document.body.appendChild(p);const u=h=>{const w=h.target.closest(".fw-modal-network-item");if(w){const E=parseInt(w.dataset.index);g(),l(E)}},f=()=>{g(),d(new Error("Setup cancelled"))},g=()=>{p.remove()};p.querySelector(".fw-network-modal-list").addEventListener("click",u),p.querySelector(".fw-modal-cancel").addEventListener("click",f)})};v("Connecting to REPL...");const e=await on();if(!e.success){await sn(e.error);return}v("Scanning for WiFi networks...");const t=(await U(S,`
import network
import json
...
`)).match(/JSON:(\[.*\])/);if(!t)throw new Error("Failed to parse network scan - no JSON found");let o;try{o=JSON.parse(t[1])}catch(a){throw new Error("Failed to parse network JSON: "+a.message)}if(o.length===0)throw new Error("No WiFi networks found");v(`Found ${o.length} networks`);let i=!1,s=null,c=null;for(;!i;){const a=await r(o),l=o[a],d=prompt(`Enter password for "${l.ssid}":`);if(d===null)continue;v(`Connecting to "${l.ssid}"...`);const u=(await U(S,`
import time
try:
    wlan.disconnect()
except:
...
`,15e3,!1)).match(/CONNECTED:(\d+\.\d+\.\d+\.\d+)/);if(u){s=u[1],i=!0,v(`Connected! IP: ${s}`),v("Saving settings...");const g=`pydirect-${m.deviceInfo?.mac?m.deviceInfo.mac.replace(/:/g,"").slice(-4).toLowerCase():"xxxx"}`;if(await U(S,`
from lib.sys import settings
...
settings.save()
print("SETTINGS_OK")
`,5e3,!1),v(`Settings saved (hostname: ${g})`,"success"),m.isNewDeviceFlow){m.isNewDeviceFlow=!1,m.savedHostname=g,v("Continuing to certificate generation..."),await Uo(g);return}m.view="scenarios",_();return}else if(v("Connection failed"),!confirm(`WiFi connection failed. Wrong password?

Click OK to try again, or Cancel to abort.`))throw new Error("Connection cancelled")}}catch(e){v(`Error: ${e.message}`,"error"),_()}}async function Uo(e){try{const n=e+".local";v("Generating HTTPS certificate..."),window.forge||await new Promise((s,c)=>{const r=document.createElement("script");r.src="https://cdn.jsdelivr.net/npm/node-forge@1.3.1/dist/forge.min.js",r.onload=s,r.onerror=()=>c(new Error("Failed to load forge")),document.head.appendChild(r)}),v(`Hostname: ${n}`);const{certPem:t,keyPem:o}=wt(n);v(`Certificate generated (${t.length} bytes)`),v("Installing certificate..."),await bt(S,t,o),v("Enabling setup mode..."),await U(S,`
from lib.sys import settings
settings.set("setup_mode", True)
settings.save()
print("SETUP_MODE_SET")
`,5e3,!1),v("Resetting device..."),await U(S,"import machine; machine.reset()",1e3,!1);try{await S.close()}catch{}S=null,v("Device is restarting and connecting to WiFi...","success");const i=`https://${n}/setup`;yt(n,i)}catch(n){v(`Error: ${n.message}`,"error"),_()}}async function jo(){try{v("Starting re-provisioning...");const e=await on();if(!e.success){await sn(e.error);return}v("Reading device settings...");const t=(await U(S,`
from lib.sys import settings
print("HOST:" + settings.get("device.hostname", "pydirect-xxxx"))
`)).match(/HOST:(.+)/),o=t?t[1].trim():"pydirect-new";v(`Generating new certificate for ${o}.local...`),window.forge||await new Promise((a,l)=>{const d=document.createElement("script");d.src="https://cdn.jsdelivr.net/npm/node-forge@1.3.1/dist/forge.min.js",d.onload=a,d.onerror=l,document.head.appendChild(d)});const i=o+".local",{certPem:s,keyPem:c}=wt(i);v("Installing new certificate..."),await bt(S,s,c),v("Enabling setup mode..."),await U(S,`
from lib.sys import settings
settings.set("setup_mode", True)
settings.save()
print("SETUP_MODE_SET")
`,5e3,!1),v("Resetting device..."),await U(S,"import machine; machine.reset()",1e3,!1);try{await S.close()}catch{}S=null,v("Device is restarting and connecting to WiFi...","success");const r=`https://${i}/setup`;yt(i,r)}catch(e){v(`Error: ${e.message}`,"error"),_()}}async function yt(e,n){const t=window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0||document.referrer.includes("android-app://"),o=await mt({icon:'<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 8v4"/><path d="M12 16h.01"/></svg>',title:"Accept Security Warning",subtitle:"Your device has new certificates",body:t?'<p>Your device is <strong>restarting</strong> and connecting to WiFi.</p><p>When you connect, click <strong>"Advanced"</strong> → <strong>"Proceed"</strong> to trust your device.</p>':'<p>Your device is <strong>restarting</strong> and connecting to WiFi.</p><p>When the browser opens, click <strong>"Advanced"</strong> → <strong>"Proceed"</strong> to trust your device.</p>',buttons:[{id:"connect",class:"fw-styled-modal-btn-primary",icon:'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" style="margin-right:0.5rem"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>',label:`Connect to ${e}`},{id:"cancel",class:"fw-styled-modal-btn-cancel",label:"Cancel"}]});m.view="scenarios",m.reblessComplete=!1,_(),o==="connect"&&(t?window.location.href=n:window.open(n,"_blank"))}function wt(e,n=10){const t=forge.pki.rsa.generateKeyPair(2048),o=forge.pki.createCertificate();o.publicKey=t.publicKey,o.serialNumber="01",o.validity.notBefore=new Date,o.validity.notAfter=new Date,o.validity.notAfter.setFullYear(o.validity.notBefore.getFullYear()+n);const i=[{name:"commonName",value:e}];return o.setSubject(i),o.setIssuer(i),o.setExtensions([{name:"subjectAltName",altNames:[{type:2,value:e}]}]),o.sign(t.privateKey,forge.md.sha256.create()),{certPem:forge.pki.certificateToPem(o),keyPem:forge.pki.privateKeyToPem(t.privateKey)}}async function bt(e,n,t){v("Creating /certs directory..."),await U(e,`
import os
try:
    os.mkdir('/certs')
except OSError:
    pass
print('DIR_OK')
`,3e3,!1),v("Writing certificate...");const o=btoa(n);await U(e,`
import binascii
with open('/certs/servercert.pem', 'wb') as f:
    f.write(binascii.a2b_base64('${o}'))
print('CERT_OK')
`,5e3,!1),v("Writing private key...");const i=btoa(t);await U(e,`
with open('/certs/prvtkey.pem', 'wb') as f:
    f.write(binascii.a2b_base64('${i}'))
print('KEY_OK')
`,5e3,!1),v("Certificates installed!")}function Wo(e,n){he=e;const t=m.view;return C`
    <div class="firmware-panel">
      ${t==="connect"?qo():""}
      ${t==="scenarios"?Go():""}
      ${t==="new-device"?Vo():""}
      ${t==="forgot-credentials"?Ko():""}
      ${t==="change-wifi"?Jo():""}
      ${t==="re-provision"?Xo():""}
      
      ${Yo()}
    </div>
  `}function Y(e="Connected",n="fw-status-success"){const t=m.deviceInfo;if(!t)return"";const o=Ho(t.chipName),i=t.connectionBaud?`${t.connectionBaud.toLocaleString()} bps`:"115,200 bps";return C`
    <div class="fw-device-info-header">
      <!-- Dark Header Section -->
      <div class="fw-device-chip-header">
        <div class="fw-device-chip-name">${t.chipName}</div>
        <div class="fw-device-chip-subline">
          <span class="fw-device-subline-item">
            ${y.renderIcon("refresh",{className:"fw-subline-icon",size:16})}
            v1.0
          </span>
          <span class="fw-device-subline-item">
            ${y.renderIcon("wifi",{className:"fw-subline-icon",size:16})}
            ${t.mac} (MAC)
          </span>
        </div>
      </div>
      ...
      <div class="fw-device-summary-card">
        <div class="fw-summary-section">
          <div class="fw-summary-label">
            ${y.renderIcon("cpu",{className:"fw-summary-icon",size:24})}
            FLASH & CLOCK
          </div>
          <div class="fw-summary-value">${t.flashSize||"Unknown"}</div>
          <div class="fw-summary-meta">Crystal 40 MHz</div>
          <div class="fw-summary-facts">
            ${t.flashDevice?C`
              <div class="fw-summary-fact">
                ${y.renderIcon("cpu",{className:"fw-fact-icon",size:14})}
                <span>Flash Device : ${t.flashDevice}</span>
              </div>
            `:""}
            ${t.usbBridge?C`
              <div class="fw-summary-fact">
                ${y.renderIcon("usb",{className:"fw-fact-icon",size:14})}
                <span>USB Bridge : ${t.usbBridge}</span>
              </div>
            `:""}
            <div class="fw-summary-fact">
              ${y.renderIcon("bolt",{className:"fw-fact-icon",size:14})}
              <span>Connection Baud : ${i}</span>
            </div>
          </div>
        </div>
        ...
        <div class="fw-summary-section">
          <div class="fw-summary-label">
            ${y.renderIcon("bolt",{className:"fw-summary-icon",size:24})}
            FEATURE SET
          </div>
          <div class="fw-summary-value">${o.length} capabilities</div>
          <div class="fw-summary-chips">
            ${o.map(s=>C`
              <div class="fw-feature-chip">
                <span class="fw-feature-label">${s}</span>
  ...
  `}function Ho(e){const n={"ESP32-P4":["High-Performance MCU","RISC-V Dual Core"],"ESP32-S3":["WiFi","BLE 5.0","USB OTG"],"ESP32-S2":["WiFi","USB OTG"],"ESP32-C3":["WiFi","BLE 5.0","RISC-V"],"ESP32-C6":["WiFi 6","BLE 5.0","Thread"],ESP32:["WiFi","Bluetooth Classic","BLE"]};for(const[t,o]of Object.entries(n))if(e?.includes(t))return o;return["Microcontroller"]}function qo(e,n){return C`
    <div class="fw-view active">
      ...
      <button class="fw-btn fw-btn-primary" onclick=${Do}>
        ${y.renderIcon("usb",{className:"fw-btn-icon",size:20})}
        ${b("firmware.connectDevice")}
      </button>
      
      <div class="fw-hint-box">
        ${y.renderIcon("bulb",{className:"fw-hint-icon"})}
        <span>${b("firmware.connectHint")}</span>
      </div>
    </div>
  `}function Go(e,n){const t=b(ie?"firmware.readyToFlash":"firmware.pyDirectDetected");return C`
    <div class="fw-view active">
      ...
      <div class="fw-scenario-grid">
        <div class="fw-scenario-card ${ie?"fw-scenario-highlighted":""}" 
          ...
          <div class="fw-scenario-icon">
            ${y.renderIcon("cpu",{className:"",size:28})}
          </div>
        ...
        <div class="fw-scenario-card ${ie?"":"fw-scenario-highlighted"}"
          ...
          <div class="fw-scenario-icon">
            ${y.renderIcon("key",{className:"",size:28})}
          </div>
        ...
        <div class="fw-scenario-card"
          ...
          <div class="fw-scenario-icon">
            ${y.renderIcon("wifi",{className:"",size:28})}
          </div>
        ...
        <div class="fw-scenario-card"
          ...
          <div class="fw-scenario-icon">
            ${y.renderIcon("refresh",{className:"",size:28})}
          </div>
  ...
  `}function Vo(e,n){const t=m.deviceInfo,o=m.flashStep,i=m.flashProgress,s=m.selectedFirmware;if(o==="complete")return C`
      <div class="fw-view active">
        ${Y(b("firmware.flashComplete"),"fw-status-success")}
        
        <div class="fw-device-card">
          <div class="fw-device-card-header">
            <h3>
              ${y.renderIcon("cpu",{className:"fw-header-icon"})}
              ${b("firmware.flashComplete")}
            </h3>
          </div>
          ...
          <div style="text-align: center; padding: 2rem 0;">
            ...
            <h2 style="font-size: 1.25rem; margin-bottom: 0.5rem;">${b("firmware.flashSuccess")}</h2>
            <p style="color: var(--text-secondary); font-size: 0.9rem; margin-bottom: 1rem;">
              ${b("firmware.flashSuccessHint")}
            </p>
          </div>
          
          <button class="fw-btn fw-btn-primary" onclick=${Bo}>
            ${y.renderIcon("wifi",{className:"fw-btn-icon",size:20})}
            ${b("firmware.configureWifi")}
          </button>
          <button class="fw-btn fw-btn-secondary" onclick=${()=>{m.view="scenarios",m.flashStep="select",m.flashComplete=!1,_()}}>
            ${b("firmware.skipForNow")}
          </button>
        </div>
      </div>
    `;if(o==="downloading"||o==="flashing"){const c=b(o==="downloading"?"firmware.downloading":"firmware.flashing"),r=o==="flashing"&&i>90?C`<p style="text-align: center; color: var(--text-muted); margin-top: 0.5rem; font-size: 0.8rem;">
          ${b("firmware.writingToFlash")}
        </p>`:null;return C`
      <div class="fw-view active">
    ...
    `}return C`
    <div class="fw-view active">
      <button class="fw-btn-back" onclick=${De}>
        ${b("firmware.back")}
      </button>
      
      ${Y(b("firmware.readyToFlash"),"fw-status-warning")}
      ...
      <div class="fw-device-card" style="margin-top: 1rem;">
        <div class="fw-device-card-header">
          <h3>
            ${y.renderIcon("bolt",{className:"fw-header-icon"})}
            ${b("firmware.selectFirmware")}
          </h3>
        </div>
        ...
        ${s?C`
          ${m.firmwareOptions.length>1?C`
            <div class="fw-form-group">
              <select class="fw-select" onchange=${c=>{const r=m.firmwareOptions.find(a=>a.productId===c.target.value);r&&(m.selectedFirmware=r,_())}}>
          ...
          <button class="fw-btn fw-btn-primary" onclick=${Mo} style="margin-top: 1rem;">
            ${y.renderIcon("bolt",{className:"fw-btn-icon",size:20})}
            ${b("firmware.flashButton")}
          </button>
        `:C`
          <div class="fw-loading">
            <span>${b("firmware.loadingFirmware")}</span>
          </div>
        `}
      </div>
    </div>
  `}function Ko(e,n){const t=m.credentials;return C`
    <div class="fw-view active">
      <button class="fw-btn-back" onclick=${De}>
        ${b("firmware.back")}
      </button>
      ...
      <div class="fw-device-card">
        <div class="fw-device-card-header">
          <h3>
            ${y.renderIcon("key",{className:"fw-header-icon"})}
  ...
  `}function Jo(e,n){return m.setupComplete?C`
      <div class="fw-view active">
        <div class="fw-device-card">
          <div class="fw-device-card-header">
            <h3>
              ${y.renderIcon("zap",{className:"fw-header-icon"})}
              Setup Complete!
            </h3>
          </div>
          ...
          <div class="fw-hint-box fw-hint-warning">
            <h4>
              ${y.renderIcon("alert-triangle",{className:"fw-hint-icon"})}
              ${b("firmware.browserSecurityTitle")}
            </h4>
            <p>${b("firmware.browserSecurityHint")}</p>
          </div>
          
          <button class="fw-btn fw-btn-primary" onclick=${()=>window.open(m.setupUrl,"_blank")}>
            ${y.renderIcon("external-link",{className:"fw-btn-icon",size:20})}
            ${b("firmware.openDeviceSetup")}
          </button>
          
          <button class="fw-btn fw-btn-secondary" style="margin-top: 0.5rem;" onclick=${()=>{m.setupComplete=!1,m.view="scenarios",_()}}>
            ${b("firmware.done")}
          </button>
        </div>
      </div>
    ...
    <div class="fw-view active">
      ...
      <div class="fw-device-card">
        <div class="fw-device-card-header">
          <h3>
            ${y.renderIcon("wifi",{className:"fw-header-icon"})}
            ${b("firmware.changeWifi")}
          </h3>
        </div>
  ...
  `}function Xo(e,n){const t=()=>{const i=`https://${m.reblessHostname}`;window.open(i,"_blank")},o=async()=>{await Ro(),m.reblessComplete=!1,m.reblessHostname=null,m.view="connect",_()};return m.reblessComplete?C`
      <div class="fw-view active">
        <div class="fw-device-card">
          <div class="fw-device-card-header">
            <h3>
              ${y.renderIcon("refresh",{className:"fw-header-icon"})}
          ...
          <div style="text-align: center; padding: 2rem 0;">
            ...
            <p style="color: var(--text-secondary); font-size: 0.9rem; margin-bottom: 1rem;">
              ${b("firmware.reProvisionSuccess")} <strong>${m.reblessHostname}</strong>
            </p>
          </div>
          
          <!-- Browser Security Warning -->
          <div class="fw-hint-box fw-hint-warning">
            ${y.renderIcon("alert-triangle",{className:"fw-hint-icon-warning"})}
            <div style="flex: 1;">
  ...
  `}function Yo(){const e=m.logs;return C`
    <div class="fw-terminal ${m.terminalCollapsed?"collapsed":""}">
      <div class="fw-terminal-header" onclick=${()=>{m.terminalCollapsed=!m.terminalCollapsed,_()}}>
        <span>${y.renderIcon("terminal",{className:"fw-terminal-icon",size:14})} ${b("firmware.statusLog")}</span>
        ${y.renderIcon(m.terminalCollapsed?"chevron-up":"chevron-down",{className:"fw-terminal-toggle"})}
      </div>
    ...
    <div class="panel-container">
      <div class="ai-agent-content">
        ...
        <div class="ai-agent-section">
          ...
          >
            ${Zo(t.provider,t.model,e.aiAgent.openRouterModels,e.aiAgent.isLoadingOpenRouterModels)}
          </select>
  ...
  `}function ns(e,n){let t="Connect to board",o=`${e.diskNavigationRoot}${e.diskNavigationPath}`;return e.isConnected&&(t=`${e.connectedPort}${e.boardNavigationPath}`),html`
    <div id="file-manager">
      <div id="board-files">
        ...
        <div class="landing-scenario-grid">
          <div class="landing-scenario-card" onclick=${()=>We("https://scriptostudio.com/registry/extensions-catalogue/")}>
            <div class="landing-scenario-icon">
              ${y.renderIcon("packages",{className:"landing-icon-large"})}
            </div>
          ...
          <div class="landing-scenario-card" onclick=${()=>We("https://scriptostudio.com/registry/catalogue/")}>
            <div class="landing-scenario-icon">
              ${y.renderIcon("script",{className:"landing-icon-large"})}
            </div>
          ...
          <div class="landing-scenario-card" onclick=${()=>We("https://scriptostudio.com/docs/")}>
            <div class="landing-scenario-icon">
              ${y.renderIcon("book",{className:"landing-icon-large"})}
            </div>
          ...
          <div class="landing-scenario-card ${e.needsOnboarding?"highlight-pulse":""}" onclick=${()=>n("navigate","system:firmware")}>
            <div class="landing-scenario-icon">
              ${y.renderIcon("cpu",{className:"landing-icon-large"})}
            </div>
  ...
  `}function We(e){window.open(e,"_blank","noopener,noreferrer")}function ts(e,n){e.sidebarIconRotated===void 0&&(e.sidebarIconRotated=!1);const t=e.connectionMode==="webrepl"?"#00FF7F":e.connectionMode==="usb"?"#FF9500":"var(--text-secondary)",o=C`
    <div class="sidebar-header">
      <div
        class="sidebar-header-logo connection-${e.connectionMode||"none"}"
        onclick=${()=>{e.connectionMode==="usb"?Ao():e.isConnected?n("disconnect"):n("connect")}}
      ...
      ${d?C`
        <div class="system-sidebar-submenu">
          ${s.map(x=>{const L=e.activeSystemPanel===x.id;return C`
              ...
              >
                ${y.renderIcon(x.icon,{className:"",size:16})}
                <span>${x.label}</span>
              </div>
            `})}
        </div>
  ...
  `,w=x=>{if(x.iconSvg)try{const z=new DOMParser().parseFromString(x.iconSvg,"image/svg+xml").querySelector("svg");if(z){const N=z.getAttribute("viewBox")||"0 0 24 24",D=Array.from(z.querySelectorAll("path"));return C`
            <svg 
            ...
            >
              ${D.map(q=>{const se=q.getAttribute("d")||"",Ae=q.getAttribute("fill")||"none",Re=q.getAttribute("stroke");return se==="M0 0h24v24H0z"||Re==="none"?C`<path d="${se}" stroke="none" fill="none" />`:C`<path d="${se}" stroke="currentColor" fill="${Ae}" />`})}
            </svg>
          `}}catch(T){console.warn("[System] Failed to parse extension icon SVG:",T)}const L=x.icon||"settings";return y.renderIcon(L,{className:"",size:20})},E=(e.installedExtensions||[]).map(x=>{const L=e.expandedExtensions[x.id],T=e.activeExtension===x.id,W=x.devices===!0;let z=null;if(W&&L)if(!e.loadedExtensions[x.id])console.warn("[System] Extension not loaded:",x.id);else{const N=e.loadedExtensions[x.id];if(!N.instance)try{const D=N.data.content,se=new Function("DeviceAPI","html","emit","state",`
              ${D}
            ...
            `)(DeviceAPI,C,n,e),Ae=new DeviceAPI(B),Re=new se(Ae,n,e,C);e.loadedExtensions[x.id].instance=Re}catch(D){console.error(`[System] Error instantiating extension ${x.id}:`,D)}if(N.instance&&typeof N.instance.getMenuItems=="function")try{const D=N.instance.getMenuItems();D&&Array.isArray(D)&&(x.menu=D)}catch(D){console.error(`[System] Error getting menu items for ${x.id}:`,D)}if(N.instance&&typeof N.instance.renderSidebarDevices=="function")try{z=N.instance.renderSidebarDevices()}catch(D){console.error(`[System] Error rendering sidebar devices for ${x.id}:`,D)}else console.warn(`[System] renderSidebarDevices not available for ${x.id}`)}if(L&&e.loadedExtensions[x.id]?.instance){const N=e.loadedExtensions[x.id];if(N.instance&&typeof N.instance.getMenuItems=="function")try{const D=N.instance.getMenuItems();D&&Array.isArray(D)&&(x.menu=D)}catch(D){console.error(`[System] Error getting menu items for ${x.id}:`,D)}}return C`
      <div class="system-sidebar-extension">
        <div 
        ...
        >
          ${w(x)}
          <span>${x.name}</span>
          ${y.renderIcon("chevron-down",{className:`expand-icon ${L?"expanded":""}`,size:16})}
        </div>
        
        ${L?C`
          <div class="system-sidebar-submenu">
            ${x.menu.map(N=>{const D=e.activeExtension===x.id&&e.activeExtensionPanel===N.id,q=N.disabled===!0;return C`
                <div 
...
${c.message}`)}})}console.log("[Stores] ES modules loaded");let He=null;async function ks(){return He||(He=(await R(()=>Promise.resolve().then(()=>Xt),void 0)).CodeMirrorEditor),He}const Dn=console.log,K=B,qe=V,_s=new ss;async function Ts(e,n){async function t(s){const{source:c,parentFolder:r,fileName:a,content:l=Fe,hasChanges:d=!1}=s,p=ci(),u=await ks(),f=e.cache(u,`editor_${p}`);return f.content=l,f.fileName=a,{id:p,source:c,parentFolder:r,fileName:a,editor:f,hasChanges:d}}async function o(s,c=null,r=null,a=null){s=="board"?e.boardNavigationPath:e.diskNavigationPath;const l=await t({fileName:c===null?Je():c,parentFolder:r,source:s,hasChanges:!0,content:a||Fe});let d=!1;return r!=null&&(s=="board"?d=await te(B,lt(e.boardNavigationRoot,l.parentFolder,l.fileName)):s=="disk"&&(d=await qe.fileExists(qe.getFullPath(e.diskNavigationRoot,l.parentFolder,l.fileName)))),e.openFiles.find(u=>u.parentFolder===l.parentFolder&&u.fileName===l.fileName&&u.source===l.source)||d?(await M(`File ${l.fileName} already exists on ${s}. Please choose another name.`),!1):(l.editor.onChange=function(){l.hasChanges=!0,n.emit("render")},e.openFiles.push(l),e.editingFile=l.id,!0)}await rs(e,n,o),cs(e,n),ds(e,n);const i=()=>{};us(e,n,K),ws(e,n,K,i,Oe),bs(e,n,K,qe,t,o),ps(e,n,K,H),Es(e,n,o),fs(e,n),document.addEventListener("connection-mode-change",s=>{const c=s.detail?.mode||"none";e.connectionMode=c,n.emit("render")}),document.addEventListener("firmware-panel-update",()=>{n.emit("render")}),n.on("navigate",s=>{n.emit("change-system-section",s)}),n.on("change-view",async s=>{s==="file-manager"&&(e.isConnected&&B&&B.isCommandRunning()&&(n.emit("stop"),await Ct(250)),e.filesLoadedOnce||(Dn("[File Manager] Loading files for first time..."),e.filesLoadedOnce=!0),e.isConnected?n.emit("refresh-files"):n.emit("refresh-disk-files")),e.systemSection!==s&&(e.selectedFiles=[],e.systemSection=s,e.activeNetworkPanel=null,e.activePeripheralsPanel=null,e.activeSystemPanel=null,e.activeExtension=null,e.activeExtensionPanel=null,s==="editor"&&e.isConnected&&setTimeout(()=>{Oe(e);const c=e.cache(H,"terminal");c&&c.term&&(n.emit("bind-terminal-input"),n.emit("terminal-focus"))},100),n.emit("render"))}),n.on("launch-app",async(s,c)=>{window.launchApp(s,c)}),n.on("change-system-section",s=>{if(Dn("change-system-section",s),e.systemSection=s,s.startsWith("network:")){const c=s.split(":")[1];e.activeNetworkPanel=c,e.activeSystemPanel=null,e.activePeripheralsPanel=null,e.activeExtension=null,e.activeExtensionPanel=null}else if(s.startsWith("peripherals:")){const c=s.split(":")[1];e.activePeripheralsPanel=c,e.activeNetworkPanel=null,e.activeSystemPanel=null,e.activeExtension=null,e.activeExtensionPanel=null}else if(s.startsWith("system:")){const c=s.split(":")[1];e.activeSystemPanel=c,e.activeNetworkPanel=null,e.activePeripheralsPanel=null,e.activeExtension=null,e.activeExtensionPanel=null}else e.activeNetworkPanel=null,e.activePeripheralsPanel=null,e.activeSystemPanel=null,e.activeExtension=null,e.activeExtensionPanel=null;(s==="ai-agent"||s==="system:ai-agent")&&e.aiAgent.settings.provider==="openrouter"&&e.aiAgent.settings.apiKey&&e.aiAgent.openRouterModels.length===0&&n.emit("ai-fetch-openrouter-models"),n.emit("render")}),hs(e,n,K),ms(e,n,K),gs(e,n),Ss(e,n,K),$s(e,n,_s,o),typeof On=="function"?On(e,n):console.warn("[Store] Debugger store not loaded"),n.on("change-locale",s=>{e.locale=s,localStorage.setItem("locale",s),window.i18n&&window.i18n.setLocale(s),n.emit("render")}),window.i18n?(window.i18n.setLocale(e.locale),console.log("[i18n] Locale initialized to:",e.locale)):console.warn("[i18n] i18n module not available")}const Ps=45,Ns=65,Is=320;typeof window<"u"&&(window.PANEL_CLOSED=Ps,window.PANEL_TOO_SMALL=Ns,window.PANEL_DEFAULT=Is);function Os(e,n){return e.isInitializing?C`
