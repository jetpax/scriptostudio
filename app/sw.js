...
const CACHE_NAME = 'scripto-studio-v15';
...
self.addEventListener('fetch', (event) => {
  ...
  // Never cache firmware binaries or firmware metadata — always fetch fresh
  if (url.pathname.endsWith('.bin') || url.pathname.endsWith('latest.json')) {
    return;
  }
